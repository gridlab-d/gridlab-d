    ...
    def _initialize(self):
        ...
        try:
            ...
            if self.gridlabd_path:
                ...
                # Note: set_install_root removed - GridLAB-D uses environment variables
            ...
            # Note: get_executable_path removed - GridLAB-D uses environment variables
            ...
            if self.debug_mode:
                # Note: get_install_root removed - GridLAB-D uses environment variables
                if self.gridlabd_path:

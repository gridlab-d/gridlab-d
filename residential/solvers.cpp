...
double ft(double t) { return a * exp(t * n) + b * exp(t * m) + c; }
double dfdt(double t) { return a * n * exp(t * n) + b * m * exp(t * m); }
double e2solve(double _a, double _n, double _b, double _m, double _c, double p,
               double *e) {
...
double e2solve(double a, double n, double b, double m, double c, double p,
               double *e) {
  // load the solver if not yet loaded

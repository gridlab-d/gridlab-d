...
public:
  ...
  double motor_power;   ///< installed dryer motor power [W] (default = random
                        ///< uniform between 150-350 W)
  double coil_power[1]; ///< installed heating coil power [W] (default = random
                        ///< uniform between 4500-6000 W, 0 for gas)
  ...
  double pulse_interval[10]; ///< length of time of each pulse section for a
                             ///< dryer operation
...
public:
  ...
  double update_state(double dt); ///< updates the load struct and returns the
                                  ///< time until expected state change
};

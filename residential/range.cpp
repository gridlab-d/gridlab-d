	...
	if (oclass==NULL)
	{
		...
		if (gl_publish_variable(oclass,
			...
			PT_enumeration,"state_cooktop", PADDR(state_cooktop),
				PT_KEYWORD,"CT_STOPPED",(enumeration)CT_STOPPED,
				PT_KEYWORD,"STAGE_6_ONLY",(enumeration)CT_STAGE_1_ONLY,
				PT_KEYWORD,"STAGE_7_ONLY",(enumeration)CT_STAGE_2_ONLY,
				PT_KEYWORD,"STAGE_8_ONLY",(enumeration)CT_STAGE_3_ONLY,
				PT_KEYWORD,"CT_STALLED",(enumeration)CT_STALLED,
				PT_KEYWORD,"CT_TRIPPED",(enumeration)CT_TRIPPED,

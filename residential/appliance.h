...
public:
  ...
  // Inline method to set the `power` property directly using an
  // `Eigen::MatrixXcd` object.
...
public:
  ...
  // Inline method to set the `impedance` property directly using an
  // `Eigen::MatrixXcd` object.
...
public:
  ...
  // Inline method to set the `current` property directly using an
  // `Eigen::MatrixXcd` object.
...
public:
  ...
  // Inline method to set the `duration` property directly using an
...
public:
  ...
  // Inline method to set the `transition` property directly using an
  // `Eigen::MatrixXd` object.
...
public:
  ...
  // Inline method to set the `heatgain` property directly using an
  // `Eigen::MatrixXd` object.

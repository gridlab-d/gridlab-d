...
public:
  ...
  enumeration
      heat_mode; ///< method of heating the food (gas or electric) [enum]
  ...
  double heat_fraction; ///< fraction of the plugload that is transferred as
                        ///< heat (default = 0.90)

  double cooktop_energy_used; ///< amount of energy used in current cycle
  double cycle_duration_cooktop;
  double cycle_time_cooktop;
  double cooktop_interval[3]; ///< length of time of each setting section for
                              ///< cooktop operation
  ...
  double cooktop_energy_needed; ///< total energy needed to cook or warm up food
                                ///< with cooktop
  ...
  double h; ///< boundary between hot and cold the food layers [ft from top of
            ///< the container]
  double
      Tlower; ///< temperature in lower zone of the oven (for 2-zone model) [F]
  double Tlower_old;
  double
      Tupper; ///< temperature in upper zone of the oven (for 2-zone model) [F]
  double Tupper_old;
  ...
  bool heat_needed; ///< need to maintain this bit of state because of Tstat
                    ///< deadband...
  double
      is_range_on; ///< Simple logic for determining state of range 1-on, 0-off
public:
  ...
  double
      oven_demand_old; ///< previous food demand, needed for temperature change
                       ///< (reflects heat loss from hot the food draw)
  ...
  double actual_load;
  double prev_load;
  gld::complex range_actual_power; ///< the actual power draw of the object
                                   ///< after accounting for voltage

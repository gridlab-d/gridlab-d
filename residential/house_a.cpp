...
TIMESTAMP house::sync_thermal(TIMESTAMP t1, double nHours)
{
	...
	if (nHours > ROUNDOFF)
	{
		double q1 = exp(s1 * nHours) * (Q1 + BB11 * Tsolar / s1 + BB12 * netHeatrate / s1) - BB11 * Tsolar / s1 - BB12 * netHeatrate / s1;
		double q2 = exp(s2 * nHours) * (Q2 - BB11 * Tsolar / s2 - BB12 * netHeatrate / s2) + BB11 * Tsolar / s2 + BB12 * netHeatrate / s2;

...
evcharger_det::evcharger_det(MODULE *module) : residential_enduse(module) {
  ...
  if (oclass == nullptr) {
    ...
    oclass = gl_register_class(module, "evcharger_det", sizeof(evcharger_det),
                               PC_BOTTOMUP | PC_POSTTOPDOWN);
    if (oclass == nullptr)
      throw "unable to register class evcharger_det";

    // publish the class properties
    if (gl_publish_variable(
            oclass, PT_INHERIT, "residential_enduse", PT_double,
            "desired_charge_rate[W]", PADDR(DesiredChargeRate), PT_DESCRIPTION,
            "Current desired charge rate of the vehicle", PT_double,
            "actual_charge_rate[W]", PADDR(ActualChargeRate), PT_DESCRIPTION,
            "Actual charge rate of the vehicle - may be ramp limited",
            PT_double, "realized_charge_rate[kW]", PADDR(RealizedChargeRate),
            PT_DESCRIPTION,
            "Implemented charge rate of the vehicle - grid-influence result of "
            "actual_charge_rate",

            PT_double, "variation_mean[s]", PADDR(variation_mean),
            PT_DESCRIPTION, "Mean of normal variation of schedule variation",
            PT_double, "variation_std_dev[s]", PADDR(variation_std_dev),
            PT_DESCRIPTION,
            "Standard deviation of normal variation of schedule times",

            PT_double, "variation_trip_mean[mile]", PADDR(variation_trip_mean),
            PT_DESCRIPTION,
            "Mean of normal variation of trip distance variation", PT_double,
            "variation_trip_std_dev[mile]", PADDR(variation_trip_std_dev),
            PT_DESCRIPTION,
            "Standard deviation of normal variation of trip distance",

            PT_double, "mileage_classification[mile]",
            PADDR(mileage_classification), PT_DESCRIPTION,
            "Mileage classification of electric vehicle", PT_bool,
            "work_charging_available", PADDR(Work_Charge_Available),
            PT_DESCRIPTION, "Charging available when at work",

            PT_char1024, "data_file", PADDR(NHTSDataFile), PT_DESCRIPTION,
            "Path to .CSV file with vehicle travel information", PT_int32,
            "vehicle_index", PADDR(VehicleLocation), PT_DESCRIPTION,
            "Index of vehicles in file this particular vehicle's data",

            PT_enumeration, "vehicle_location", PADDR(CarInformation.Location),
            PT_KEYWORD, "UNKNOWN", (enumeration)VL_UNKNOWN, PT_KEYWORD, "HOME",
            (enumeration)VL_HOME, PT_KEYWORD, "WORK", (enumeration)VL_WORK,
            PT_KEYWORD, "DRIVING_HOME", (enumeration)VL_WORK_TO_HOME,
            PT_KEYWORD, "DRIVING_WORK", (enumeration)VL_HOME_TO_WORK, PT_double,
            "travel_distance[mile]", PADDR(CarInformation.travel_distance),
            PT_DESCRIPTION,
            "Distance vehicle travels from home to home (round trip)",
            PT_double, "arrival_at_work", PADDR(CarInformation.WorkArrive),
            PT_DESCRIPTION, "Time vehicle arrives at work - HHMM", PT_double,
            "duration_at_work[s]", PADDR(CarInformation.WorkDuration),
            PT_DESCRIPTION, "Duration the vehicle remains at work", PT_double,
            "arrival_at_home", PADDR(CarInformation.HomeArrive), PT_DESCRIPTION,
            "Time vehicle arrives at home - HHMM", PT_double,
            "duration_at_home[s]", PADDR(CarInformation.HomeDuration),
            PT_DESCRIPTION, "Duration the vehicle remains at home", PT_double,
            "battery_capacity[kWh]", PADDR(CarInformation.battery_capacity),
            PT_DESCRIPTION, "Current capacity of the battery in kWh", PT_double,
            "battery_SOC[%]", PADDR(CarInformation.battery_SOC), PT_DESCRIPTION,
            "State of charge of battery", PT_double, "battery_size[kWh]",
            PADDR(CarInformation.battery_size), PT_DESCRIPTION,
            "Full capacity of battery", PT_double,
            "mileage_efficiency[mile/kWh]",
            PADDR(CarInformation.mileage_efficiency), PT_DESCRIPTION,
            "Efficiency of drive train in mile/kWh", PT_double,
            "maximum_charge_rate[W]", PADDR(CarInformation.MaxChargeRate),
            PT_DESCRIPTION, "Maximum output rate of charger in kW", PT_double,
            "charging_efficiency[unit]", PADDR(CarInformation.ChargeEfficiency),
            PT_DESCRIPTION, "Efficiency of charger (ratio) when charging",

            PT_double, "maximum_overload_current[unit]",
            PADDR(max_overload_currentPU), PT_DESCRIPTION,
            "Maximum overload current, in per-unit",

            PT_bool, "enable_J2894", PADDR(enable_J2894_checks), PT_DESCRIPTION,
            "Enable SAE J2894-suggested voltage and ramping suggestions",
            PT_bool, "charger_enabled", PADDR(ev_charger_enabled_state),
            PT_DESCRIPTION,
            "Flag to indicate if the charger is working, or disconnected due "
            "to SAE J2894/ANSI C84.1",

            PT_enumeration, "J2894_trip_method", PADDR(J2894_trip_method),
            PT_DESCRIPTION, "SAE J2894 threshold exceeded for the tripping",
            PT_KEYWORD, "NONE", (enumeration)J2894_NONE, PT_KEYWORD,
            "SURGE_OVER_VOLT", (enumeration)J2894_SURGE_OVER_VOLT, PT_KEYWORD,
            "HIGH_OVER_VOLT", (enumeration)J2894_HIGH_OVER_VOLT, PT_KEYWORD,
            "OVER_VOLT", (enumeration)J2894_OVER_VOLT, PT_KEYWORD, "UNDER_VOLT",
            (enumeration)J2894_UNDER_VOLT, PT_KEYWORD, "LOW_UNDER_VOLT",
            (enumeration)J2894_LOW_UNDER_VOLT, PT_KEYWORD, "EXTREME_UNDER_VOLT",
            (enumeration)J2894_EXTREME_UNDER_VOLT, PT_KEYWORD, "UNKNOWN",
            (enumeration)J2894_UNKNOWN,

            // J2894-related thresholds
            PT_double, "J2894_highest_voltage_surge_value[pu]",
            PADDR(J2894_voltage_high_threshold_values[0][0]), PT_DESCRIPTION,
            "J2894-suggested high voltage surge threshold magnitude", PT_double,
            "J2894_highest_voltage_surge_time[s]",
            PADDR(J2894_voltage_high_threshold_values[0][1]), PT_DESCRIPTION,
            "J2894-suggested high voltage surge threshold duration", PT_double,
            "J2894_high_voltage_persistent_value[pu]",
            PADDR(J2894_voltage_high_threshold_values[1][0]), PT_DESCRIPTION,
            "J2894-suggested higher-voltage momentary magnitude", PT_double,
            "J2894_high_voltage_persistent_time[s]",
            PADDR(J2894_voltage_high_threshold_values[1][1]), PT_DESCRIPTION,
            "J2894-suggsted higher-voltage momentary duration",

            PT_double, "J2894_lowest_voltage_surge_value[pu]",
            PADDR(J2894_voltage_low_threshold_values[0][0]), PT_DESCRIPTION,
            "J2894-suggested low voltage surge threshold magnitude", PT_double,
            "J2894_lowest_voltage_surge_time[s]",
            PADDR(J2894_voltage_low_threshold_values[0][1]), PT_DESCRIPTION,
            "J2894-suggested low voltage surge threshold duration", PT_double,
            "J2894_low_voltage_persistent_value[pu]",
            PADDR(J2894_voltage_low_threshold_values[1][0]), PT_DESCRIPTION,
            "J2894-suggested lower-voltage momentary magnitude", PT_double,
            "J2894_low_voltage_persistent_time[s]",
            PADDR(J2894_voltage_low_threshold_values[1][1]), PT_DESCRIPTION,
            "J2894-suggested lower-voltage momentary duration",

            PT_double, "J2894_ramp_rate_limit[A/s]", PADDR(J2894_ramp_limit),
            PT_DESCRIPTION,
            "J2894-suggested ramp rate limit for charger activation",

            PT_double, "J2894_outage_disconnect_interval[s]",
            PADDR(J2894_off_threshold), PT_DESCRIPTION,
            "J2894-suggested outage length, when criterion has been exceeded",

            nullptr) < 1)
      GL_THROW("unable to publish properties in %s", __FILE__);

    if (gl_publish_function(oclass, "interupdate_res_object",
                            (FUNCTIONADDR)interupdate_evcharger_det) == nullptr)
...
int evcharger_det::create() {
  ...
  load.heatgain_fraction = 0.0; // Assumed to be "in the garage" or outside - so
                                // not contributing to internal heat gains
  ...
  CarInformation.WorkDuration =
      41400.0; // Assumed at work for 11.5 hours as well
  CarInformation.WorkHomeDuration = 1800.0; // Half hour commute home

  prev_time_dbl = 0.0;

  max_overload_currentPU =
      1.2; // By default, assume can only do 1.2 pu current output
  max_overload_charge_current =
      max_overload_currentPU * CarInformation.MaxChargeRate / 120.0 /
      1000.0; // Arbitrarily based off 120 - gets fixed below.

  off_nominal_time =
      false; // Assumes minimum timesteps aren't screwing things up, by default

  deltamode_inclusive = false; // By default, no deltamode participation

  enable_J2894_checks =
      false; // By default, don't check for J2894-recommended operating regions
  ...
  J2894_voltage_high_threshold_values[0][1] =
      0.5 / default_grid_frequency; // Half cycle
  ...
  J2894_off_threshold =
      ...
      gl_random_normal(
          RNGSTATE, 60.0,
          15.0); // 2 minutes + pseudo-random interval - randomizer is arbitrary
  ...
  J2894_voltage_high_state[0] = J2894_voltage_high_state[1] =
      false; // Not in any states
...
int evcharger_det::init(OBJECT *parent) {
  ...
  if (parent != nullptr) {
    if ((parent->flags & OF_INIT) != OF_INIT) {
      char objname[256];
      gl_verbose("evcharger_det::init(): deferring initialization on %s",
  ...
  double temp_hours_curr, temp_hours_curr_two, temp_hours_A, temp_hours_B,
      temp_hours_C, temp_hours_D;
  double temp_sec_curr, temp_sec_curr_two, temp_sec_A, temp_sec_B, temp_sec_C,
      temp_sec_D;
  double temp_amps;
  FILE *FPTemp;
  ...
  // See if it worked
  if ((temp_property->is_valid() != true) ||
      (temp_property->is_integer() != true)) {
    GL_THROW(
        "evcharger_det:%s - Failed to map global minimum timestep variable",
        hdr->name ? hdr->name : "unnamed");
    /*  TROUBLESHOOT
    While attempting to map the minimum_timestep global variable, an error was
    encounter Please try again, insuring the diesel_dg is parented to a
    deltamode powerflow object.  If the error persists, please submit your code
  ...
  if (glob_min_timestep > 1) // Now check us
  {
    ...
    gl_verbose("evcharger_det:%s - minimum_timestep set - problems may emerge",
               hdr->name);
    /*  TROUBLESHOOT
    The evcharger detected that the forced minimum timestep feature is enabled.
    This may cause issues with the evcharger schedule, especially if
    arrival/departure times are shorter than a minimum timestep value.
    */
  }
  ...
  if (CarInformation.MaxChargeRate > 1700) {
    if (load.config != EUC_IS220) {
      gl_warning("evcharger_det:%s - The max charge rate is over 1.7 kW (Level "
                 "1), but the load is still 110-V connected.",
                 hdr->name ? hdr->name : "unnamed");
      /*  TROUBLESHOOT
      The evcharger_det maximum_charge_rate implies a level 2 or higher charge
      rate, but it still set up to be connected as a normal level 1 110/120 VAC
      device. This may cause issues with circuit breakers tripping.  If this is
      undesired, be sure to specify the proper configuration property.
      */
    }
  }
  ...
  temp_amps = floor(
      ((CarInformation.MaxChargeRate * 1.1) / expected_voltage_base) + 0.5);

  // See if it is bigger
  if (temp_amps > load.breaker_amps) {
    gl_warning("evcharger_det:%s - the breaker rating may be too low for this "
               "maximum charge rate.",
               hdr->name ? hdr->name : "unnamed");
    /*  TROUBLESHOOT
    The evcharger_det maximum_charge_rate and configuration calculated a maximum
    breaker current that may be above the current setting. This may cause the
    breaker to trip and affect simulation results.  If this is undesired, set
    the breaker_amps property to a higher value.
    */
  }
  ...
  {
    GL_THROW("evcharger_det:%d %s - maximum_overload_current must be positive "
             "and non-zero!",
             hdr->id, (hdr->name ? hdr->name : "Unnamed"));
    /*  TROUBLESHOOT
    The value for maximum_overload_current must be positive - it cannot be
    negative or zero.
    */
  }

  // Populate the "max current" value, based on the "amps" above - eventual
  // rates are in kW, so reflect here
  max_overload_charge_current = max_overload_currentPU *
                                CarInformation.MaxChargeRate /
                                expected_voltage_base / 1000.0;
  ...
  if (NHTSDataFile[0] != '\0') // At least has something in it
  {
    ...
    if (VehicleLocation == 0) {
      ...
      /*  TROUBLESHOOT
      The value for vehicle_index was not set, so a read of the NHTS file was
      not even attempted. A set of default values will be used instead.
      */
        ...
        */
        ...
        if (temp_char == '\n') {
          ...
          if (curr_comma_count == 3) {
            ...
            while ((temp_char > 0) && (curr_idx < 32)) {
              ...
              } else // Not a comma, store it
              {
                ...
                if (curr_idx > 31) {
                  ...
                  /*  TROUBLESHOOT
                  The reading buffer for parsing the NHTS data file was
                  exceeded.  Please check your data file and try again.  If your
                  entries are over 32 characters long, this will fail.
                  */
                }
              }
            ...
            CarInformation.HomeDuration =
                home_durr * 60.0; // In minutes, make seconds
            CarInformation.WorkArrive = work_arrive;
            CarInformation.WorkDuration =
                work_durr * 60.0; // In minutes, make seconds
            CarInformation.travel_distance = temp_miles;
          } else {
            GL_THROW(
                "Invalid entry in NHTS file - may have exceeded file length!");
            /*  TROUBLESHOOT
            An invalid index value in the NHTS data file was attempted.  This
            could occur if an index larger than the maximum number of entries
            was attempted.  Please ensure a valid range was specified, or the
            NHTS-data file is correct.
            */
          }
        } // End CR - valid entry
        else {
  ...
  temp_hours_curr_two =
      (CarInformation.HomeArrive - temp_hours_curr * 100) / 60.0;
  temp_hours_A = temp_hours_curr + temp_hours_curr_two; // Home Arrive
  temp_hours_B =
      temp_hours_A + CarInformation.HomeDuration / 3600.0; // Home Depart
  ...
  temp_hours_curr_two =
      (CarInformation.WorkArrive - temp_hours_curr * 100) / 60.0;
  temp_hours_C = temp_hours_curr + temp_hours_curr_two; // Work Arrive
  temp_hours_D =
      temp_hours_C + CarInformation.WorkDuration / 3600.0; // Work Depart
  ...
  temp_hours_curr = ((double)(temp_date.hour)) +
                    (((double)(temp_date.minute)) / 60.0) +
                    (((double)(temp_date.second)) / 3600.0);
  temp_sec_curr = ((double)(temp_date.hour)) * 3600.0 +
                  ((double)(temp_date.minute)) * 60.0 +
                  ((double)(temp_date.second));
  ...
  if (temp_sec_A < temp_sec_B) // HArrive < HDepart
  {
    ...
    {
      if (temp_sec_A <
          temp_sec_C) // HArrive < WArrive - driving initially, but home
      {
        // AH DH AW DW;
        if ((temp_sec_curr < temp_sec_A) ||
            (temp_sec_curr >= temp_sec_D)) // Departed work, but not at home yet
        {
          // Set location
          ...
          if (temp_sec_curr < temp_sec_A) {
            CarInformation.next_state_change =
                temp_time_dbl + (temp_sec_A - temp_sec_curr);
          } else {
            CarInformation.next_state_change =
                temp_time_dbl + (temp_sec_A + 86400.0 - temp_sec_curr);
          }
        } else if ((temp_sec_curr >= temp_sec_A) &&
                   (temp_sec_curr < temp_sec_B)) // At home
        {
          // Set location
          CarInformation.Location = VL_HOME;
          ...
          // Figure out time to next transition
          CarInformation.next_state_change =
              temp_time_dbl + (temp_sec_B - temp_sec_curr);
        } else if ((temp_sec_curr >= temp_sec_B) &&
                   (temp_sec_curr <
                    temp_sec_C)) // Departed home, but not at work
        {
          // Set location
          ...
          // Figure out time to next transition
          CarInformation.next_state_change =
              temp_time_dbl + (temp_sec_C - temp_sec_curr);
        } else // Must be at work
        {
          ...
          // Figure out time to next transition
          CarInformation.next_state_change =
              temp_time_dbl + (temp_sec_D - temp_sec_curr);
        }
      } else // WArrive < HArrive - driving initially, but to work
      {
        // AW DW AH DH;
        if ((temp_sec_curr < temp_sec_C) ||
            (temp_sec_curr >= temp_sec_B)) // Departed home, but not at work yet
        {
          // Set location
          CarInformation.Location = VL_HOME_TO_WORK;
          ...
          if (temp_sec_curr < temp_sec_C) {
            ...
            CarInformation.next_state_change =
                temp_time_dbl + (temp_sec_C + 86400.0 - temp_sec_curr);
          }
        } else if ((temp_sec_curr >= temp_sec_C) &&
                   (temp_sec_curr < temp_sec_D)) // At work
        {
          // Set location
          CarInformation.Location = VL_WORK;
          ...
          CarInformation.next_state_change =
              temp_time_dbl + (temp_sec_D - temp_sec_curr);
        } else if ((temp_sec_curr >= temp_sec_D) &&
                   (temp_sec_curr <
                    temp_sec_A)) // Departed work, but not at home
        {
          // Set location
          CarInformation.Location = VL_WORK_TO_HOME;
    ...
    } else // WDepart < WArrive - night shift
    {
      ...
      if ((temp_sec_curr < temp_sec_D) ||
          (temp_sec_curr >= temp_sec_C)) // At work
      {
        // Set location
        CarInformation.Location = VL_WORK;
        ...
        if (temp_sec_curr < temp_sec_D) {
          ...
          CarInformation.next_state_change =
              temp_time_dbl + (temp_sec_D + 86400.0 - temp_sec_curr);
        }
      } else if ((temp_sec_curr >= temp_sec_D) &&
                 (temp_sec_curr < temp_sec_A)) // Driving to home
      {
        // Set location
        CarInformation.Location = VL_WORK_TO_HOME;
  ...
  } else // Leftover case - at home initially
  {
    ...
    if ((temp_sec_curr < temp_sec_B) ||
        (temp_sec_curr >= temp_sec_A)) // At home
    {
      // Set location
      CarInformation.Location = VL_HOME;
      ...
      if (temp_sec_curr < temp_sec_B) {
        ...
        CarInformation.next_state_change =
            temp_time_dbl + (temp_sec_B + 86400.0 - temp_sec_curr);
      }
    } else if ((temp_sec_curr >= temp_sec_B) &&
               (temp_sec_curr <
                temp_sec_C)) // Departed home, but not arrived at work
    {
      // Set location
      CarInformation.Location = VL_HOME_TO_WORK;
  ...
  if (CarInformation.battery_size <= 0.0) {
    if ((mileage_classification != 0.0) &&
        (CarInformation.mileage_efficiency != 0.0)) {
      CarInformation.battery_size =
          mileage_classification / CarInformation.mileage_efficiency;
    } else {
      GL_THROW("Battery size is not specified, nor are the mileage "
               "classification or efficiency!");
      /*  TROUBLESHOOT
      The battery size, mileage classification, and efficiency are all
      undefined.  At least two of these need to be defined to properly
    ...
    if (mileage_classification != 0.0) {
      CarInformation.mileage_efficiency =
          mileage_classification / CarInformation.battery_size;
    } else // Mileage classification is zero
    {
      if (CarInformation.mileage_efficiency != 0.0) {
        mileage_classification =
            CarInformation.battery_size * CarInformation.mileage_efficiency;
      } else {
        GL_THROW("Mileage efficiency not specified, more information needed!");
        /*  TROUBLESHOOT
        A battery size was specified, but not a mileage classification or
        efficiency value.  One of these values is necessary to properly
        initialize the object.
        */
      }
    }
  ...
  // Determine state of charge - assume starts at 100% SOC at home initially, so
  // adjust accordingly
  if ((CarInformation.battery_capacity < 0.0) &&
      (CarInformation.battery_SOC >= 0.0)) {
    // Populate current capacity based on SOC
    CarInformation.battery_capacity =
        CarInformation.battery_size * CarInformation.battery_SOC / 100.0;
  }

  // Check vice-versa
  if ((CarInformation.battery_SOC < 0.0) &&
      (CarInformation.battery_capacity >= 0.0)) {
    // Populate SOC
    CarInformation.battery_SOC =
        CarInformation.battery_capacity / CarInformation.battery_size * 100.0;
  }
  ...
  if ((CarInformation.battery_SOC < 0.0) ||
    ...
    if (CarInformation.Location == VL_HOME) {
      ...
      CarInformation.battery_SOC =
          (1.0 - ((CarInformation.next_state_change - temp_time_dbl) /
                  CarInformation.HomeDuration)) *
          100.0;
      ...
      if ((CarInformation.battery_SOC > 100.0) ||
        ...
        gl_warning("Battery SOC calculation messed up and somehow went outsize "
                   "0 - 100 range!");
        /*  TROUBLESHOOT
        The initial battery SOC somehow ended up outside a 0 - 100% range.  It
        has been forced to 50%.
        */
      }
      ...
      CarInformation.battery_capacity =
          CarInformation.battery_size * CarInformation.battery_SOC / 100.0;
    } else if ((CarInformation.Location == VL_HOME_TO_WORK) ||
               (CarInformation.Location ==
                VL_WORK)) // If at work or going there, deduct a trip
    {
      // Assume started full - deduct our trip
      CarInformation.battery_capacity =
          CarInformation.battery_size - CarInformation.travel_distance / 2.0 /
                                            CarInformation.mileage_efficiency;

      // Make sure didn't go too low
      if ((CarInformation.battery_capacity < 0.0) ||
          (CarInformation.battery_capacity > CarInformation.battery_size)) {
        ...
        /*  TROUBLESHOOT
        While attepting to initialize the battery, it encountered a negative or
        overloaded SOC condition.  It has been arbitrarily set to 50%.
        */
      }
    ...
    } else // Must be work to home - deduct full trip
    {
      ...
      CarInformation.battery_capacity =
          CarInformation.battery_size -
          CarInformation.travel_distance / CarInformation.mileage_efficiency;
  ...
  // Check efficiency
  if ((CarInformation.ChargeEfficiency < 0) ||
      (CarInformation.ChargeEfficiency > 1.0)) {
    GL_THROW("Charger efficiency is outside of practical bounds!");
    /*  TROUBLESHOOT
    The charger can only be specified between 0% (0.0) and 100% (1.0)
    efficiency. Please limit the input to this range.
    */
  }

  //"Cheating" function for compatibility with older models -- enables all
  //residential models to be deltamode-ready
  ...
  if (deltamode_inclusive) {
    ...
    if (enable_subsecond_models != true) {
      gl_warning("evcharger_det:%s indicates it wants to run deltamode, but "
                 "the module-level flag is not set!",
                 hdr->name ? hdr->name : "unnamed");
      /*  TROUBLESHOOT
      The evcharger_det object has the deltamode_inclusive flag set, but not the
      module-level enable_subsecond_models flag.  The evcharger_det will not
  ...
  {
    if (enable_subsecond_models == true) {
      gl_warning("evcharger_det:%d %s - Deltamode is enabled for the module, "
                 "but not this house!",
                 hdr->id, (hdr->name ? hdr->name : "Unnamed"));
      /*  TROUBLESHOOT
      The evcharger_det is not flagged for deltamode operations, yet deltamode
      simulations are enabled for the overall system.  When deltamode triggers,
      this evcharger_det may no longer contribute to the system, until
...
int evcharger_det::isa(char *classname) {
  return (strcmp(classname, "evcharger_det") == 0 ||
...
TIMESTAMP evcharger_det::sync(TIMESTAMP t0, TIMESTAMP t1) {
  ...
  // CHeck J2894 (if appropriate) - see if we synced here because we were
  // getting ready to fail
  if (enable_J2894_checks == true) {
    // See if we're affected by anything - deltamode scheduling done in postsync
    t_J2894_ret_dbl = check_J2894_values(tdiff_dbl, glob_min_timestep_dbl,
                                         &min_timestep_floored);
  ...
  if (off_nominal_time == true) {
    ...
    if (tret < t2) // tret is less than the next "expected" timestep
      tret = t2;   // Unfortunately, GridLAB-D is "special" and doesn't know how
                   // to handle this with min timesteps.  We have to fix it.
  }
...
TIMESTAMP evcharger_det::postsync(TIMESTAMP t0, TIMESTAMP t1) {
  ...
  if ((enable_J2894_checks == true) && (CarInformation.Location == VL_HOME)) {
    ...
    ret_value =
        check_J2894_values(0.0, glob_min_timestep_dbl, &min_timestep_floored);

    if (ret_value < 0.0) // Infinite
    {
      return TS_NEVER;
    } else if (min_timestep_floored ==
               true) // New operating point is too high/low, or time is too long
                     // - trip it now - capture zero too
    {
      if (deltamode_inclusive == true) {
        // Schedule deltamode for now!
        schedule_deltamode_start(t1);
      }
      // Default else - it may be coming back, just let it happen next time, or
      // we handled it inside
...
double evcharger_det::sync_ev_function(double curr_time_dbl) {
  ...
  if (prev_time_dbl != curr_time_dbl) {
    ...
    case VL_HOME:
      // See if we are still at home - assume any J2894 check is bypassed -
      // since it is in past
      if (curr_time_dbl >= CarInformation.next_state_change) // Nope
      {
        ...
        if (load.voltage_factor > 0.0) {
          actual_power_value = load.constant_power + (load.constant_current +
        ...
        // Update battery information first - just in case the transition
        // occurred in the middle of a timestep
        temp_double = tdiff / 3600.0 * RealizedChargeRate *
                      CarInformation.ChargeEfficiency; // Convert to kWh
        ...
        {
          CarInformation.battery_capacity = 0.0;
        } else if (CarInformation.battery_capacity >
                   CarInformation.battery_size) // Over 100%!?!
        {
          CarInformation.battery_capacity =
              CarInformation.battery_size; // Set to 100%
        }

        // Discharge the battery according to half our distance - +/- variation,
        // if desired
        if ((variation_trip_std_dev > 0.0) ||
            (variation_trip_mean != 0.0)) // Some variation
        {
          // Get the variation
          temp_double = gl_random_normal(RNGSTATE, variation_trip_mean,
          ...
          CarInformation.battery_capacity =
              CarInformation.battery_capacity -
              temp_double / CarInformation.mileage_efficiency;
        } else // Nope
        {
          // Calculate and remove the energy consumed
          CarInformation.battery_capacity =
              CarInformation.battery_capacity -
              CarInformation.travel_distance / 2.0 /
                  CarInformation.mileage_efficiency;
        }
        ...
        if (CarInformation.battery_capacity < 0.0) {
          ...
          CarInformation.battery_capacity = 0.0;
                   ...
                   CarInformation
                       .battery_size) // Pointless check, but let's make sure
                                      // we'd did go above 100% somehow
        {
          CarInformation.battery_capacity = CarInformation.battery_size; // 100%
        }

        // Normal, update SOC
        CarInformation.battery_SOC = CarInformation.battery_capacity /
                                     CarInformation.battery_size * 100.0;

        // Update our state change time
        if ((variation_std_dev > 0.0) ||
            (variation_mean != 0.0)) // Some shiftiness?
        {
          // Get the variation
          temp_double =
              gl_random_normal(RNGSTATE, variation_mean, variation_std_dev) +
              CarInformation.HomeWorkDuration;
        ...
        } else // Nope
        {
          ...
          CarInformation.next_state_change =
              curr_time_dbl + CarInformation.HomeWorkDuration;
        }
        ...
        // Zero all tracking accumulators and make sure we're enabled, just in
        // case
        J2894_off_accumulator = 0.0;
        J2894_voltage_high_accumulators[0] =
            J2894_voltage_high_accumulators[1] = 0.0;
        J2894_voltage_low_accumulators[0] = J2894_voltage_low_accumulators[1] =
            0.0;
      ...
      } else // Yes
      {
        ...
        DesiredChargeRate =
            CarInformation.MaxChargeRate * charge_out_percent / 100.0;
        ...
        if ((enable_J2894_checks == true) && (J2894_ramp_limit != 0.0)) {
          ...
          if (ev_charger_enabled_state == true) {
            ...
            ramp_temp = (DesiredChargeRate - ActualChargeRate) / temp_voltage /
                        ramp_time;
    ...
    case VL_HOME_TO_WORK:
      ...
      if (curr_time_dbl >= CarInformation.next_state_change) // Nope
      {
        ...
        // If charging is available at work, make that adjustment here
        // (independent of house load, so who cares)
        if (Work_Charge_Available == true) {
          ...
          if (CarInformation.battery_capacity < 0.0) // Less than zero
          {
            CarInformation.battery_capacity = 0.0; // Set to 0
                     ...
                     CarInformation.battery_size) // Somehow got over 100%
          {
            CarInformation.battery_capacity =
                CarInformation.battery_size; // Set to 100%
          }
        ...
        } else // Nope
        {
          ...
          CarInformation.next_state_change =
              curr_time_dbl + CarInformation.WorkDuration;
        }
    ...
    case VL_WORK:
      ...
      if (curr_time_dbl >= CarInformation.next_state_change) // Nope
      {
            ...
            (variation_mean != 0.0)) // Some shiftiness?
        {
          ...
          temp_double =
              gl_random_normal(RNGSTATE, variation_mean, variation_std_dev) +
              CarInformation.WorkHomeDuration;
        ...
        } else // Nope
        {
          // Add in how long it takes us to drive
          CarInformation.next_state_change =
              curr_time_dbl + CarInformation.WorkHomeDuration;
        }
      } else // Yes
      {
    ...
    case VL_WORK_TO_HOME:
      ...
      if (curr_time_dbl >= CarInformation.next_state_change) // Nope
      {
        ...
        } else // Nope
        {
          ...
          CarInformation.next_state_change =
              curr_time_dbl + CarInformation.HomeDuration;
        }
      } else // Yep, reaffirm our location
      {
        CarInformation.Location = VL_WORK_TO_HOME;
    ...
    default:
      ...
      /*  TROUBLESHOOT
      The vehicle somehow is in an unknown location.  Please try again.  If the
      error persists, please submit your GLM and a bug report via the Trac
      website.
      */
    }
  ...
  {
    temp_complex.SetImag(-1.0 * temp_complex.Re() / load.power_factor *
                         sin(acos(fabs(load.power_factor))));
  } else // 0 or inductive
  {
    temp_complex.SetImag(temp_complex.Re() / load.power_factor *
                         sin(acos(fabs(load.power_factor))));
  }
  ...
  temp_current_value =
      ~(temp_complex /
        gld::complex((expected_voltage_base * load.voltage_factor), 0.0));

  // Basing it off the power, since close enough
  if (temp_current_value.Mag() > max_overload_charge_current) {
    temp_current_calc.SetPolar(max_overload_charge_current,
                               temp_current_value.Arg());
  ...
  } else if (J2894_is_ramp_constrained ==
             true) // Ramp constrained, but not in deltamode
  {
...
// floored_trip flag means it got rounded down - basically to indicate if we
// should do deltamode instead (if relevant)
double evcharger_det::check_J2894_values(double diff_time, double tstep_value,
                                         bool *floored_trip) {
  ...
  *floored_trip = false;
  ...
  if ((deltamode_inclusive == true) &&
      (deltatimestep_running <
       0.0)) // See if we are delta capable, but not in deltamode
  {
  ...
  if (ev_charger_enabled_state == true) {
    ...
    if (load.voltage_factor > 1.1) {
      ...
      if (load.voltage_factor >
          J2894_voltage_high_threshold_values[0][0]) // Above even the first
                                                     // one, just trip
      {
      ...
      // Top tier
      if ((load.voltage_factor > J2894_voltage_high_threshold_values[1][0]) &&
          (load.voltage_factor <= J2894_voltage_high_threshold_values[0][0])) {
        J2894_voltage_high_accumulators[0] += diff_time;
        J2894_voltage_high_state[0] = true;
        J2894_high_time_to_change_vals[0] =
            J2894_voltage_high_threshold_values[0][1] -
            J2894_voltage_high_accumulators[0];
      } else {
      ...
      if ((load.voltage_factor > 1.1) &&
          (load.voltage_factor <= J2894_voltage_high_threshold_values[1][0])) {
        J2894_voltage_high_accumulators[1] += diff_time;
        J2894_voltage_high_state[1] = true;
        J2894_high_time_to_change_vals[1] =
            J2894_voltage_high_threshold_values[1][1] -
            J2894_voltage_high_accumulators[1];
      } else {
      ...
      // Check the high to see if we've violated something (or will before the
      // next step)
      if ((J2894_voltage_high_accumulators[0] >=
           J2894_voltage_high_threshold_values[0][1]) ||
          (J2894_high_time_to_change_vals[0] < tstep_value)) {
        // See if it was a minimum timestep trip
        if ((J2894_high_time_to_change_vals[0] < tstep_value) &&
            (J2894_high_time_to_change_vals[0] > 0.0) &&
            (deltamode_exception == true)) {
          // Flag it
          *floored_trip = true;
      ...
      if ((J2894_voltage_high_accumulators[1] >=
           J2894_voltage_high_threshold_values[1][1]) ||
          (J2894_high_time_to_change_vals[1] < tstep_value)) {
        // See if it was a minimum timestep trip
        if ((J2894_high_time_to_change_vals[1] < tstep_value) &&
            (J2894_high_time_to_change_vals[1] > 0.0) &&
            (deltamode_exception == true)) {
          // Flag it
          *floored_trip = true;
      ...
      // If we made it this far, we're in a violation, but ticking time - see
      // how long we have left Loop - only two for now, but meh
      for (idx = 0; idx < 2; idx++) {
    ...
    {
      if (load.voltage_factor <
          J2894_voltage_low_threshold_values[0][0]) // Outside lower limit -
                                                    // trip (though this is
                                                    // zero, by default J2894)
      {
      ...
      if ((load.voltage_factor >= J2894_voltage_low_threshold_values[0][0]) &&
          (load.voltage_factor < J2894_voltage_low_threshold_values[1][0])) {
        J2894_voltage_low_accumulators[0] += diff_time;
        J2894_voltage_low_state[0] = true;
        J2894_low_time_to_change_vals[0] =
            J2894_voltage_low_threshold_values[0][1] -
            J2894_voltage_low_accumulators[0];
      } else {
      ...
      if ((load.voltage_factor >= J2894_voltage_low_threshold_values[1][0]) &&
          (load.voltage_factor < 0.9)) {
        J2894_voltage_low_accumulators[1] += diff_time;
        J2894_voltage_low_state[1] = true;
        J2894_low_time_to_change_vals[1] =
            J2894_voltage_low_threshold_values[1][1] -
            J2894_voltage_low_accumulators[1];
      } else {
      ...
      J2894_voltage_high_accumulators[0] = J2894_voltage_high_accumulators[1] =
          0.0;
      J2894_voltage_high_state[0] = J2894_voltage_high_state[1] = false;

      // Check the low to see if we've violated something, or will in the next
      // time
      if ((J2894_voltage_low_accumulators[0] >=
           J2894_voltage_low_threshold_values[0][1]) ||
          (J2894_low_time_to_change_vals[0] < tstep_value)) {
        // See if it was a minimum timestep trip
        if ((J2894_low_time_to_change_vals[0] < tstep_value) &&
            (J2894_low_time_to_change_vals[0] > 0.0) &&
            (deltamode_exception == true)) {
          // Flag it
          *floored_trip = true;
      ...
      if ((J2894_voltage_low_accumulators[1] >=
           J2894_voltage_low_threshold_values[1][1]) ||
          (J2894_low_time_to_change_vals[1] < tstep_value)) {
        // See if it was a minimum timestep trip
        if ((J2894_low_time_to_change_vals[1] < tstep_value) &&
            (J2894_low_time_to_change_vals[1] > 0.0) &&
            (deltamode_exception == true)) {
          // Flag the flooring
          *floored_trip = true;
    ...
    if ((J2894_off_accumulator >= J2894_off_threshold) ||
        (J2894_off_time_to_change < tstep_value)) {
      // See how we're exiting - are we between values?
      if ((J2894_off_time_to_change < tstep_value) &&
          (J2894_off_time_to_change > 0.0) && (deltamode_exception == true)) {
        // Flag the trip
        *floored_trip = true;
...
SIMULATIONMODE
evcharger_det::inter_deltaupdate(unsigned int64 delta_time, unsigned long dt,
  ...
  if ((enable_J2894_checks == true) && (CarInformation.Location == VL_HOME)) {
    ...
    // Call the update - we'll let it go this far, if it tripped (easier to
    // update)
    ev_ret_time = sync_ev_function(dbl_deltatime);

    if ((ret_value > 1.0) ||
        (ret_value < 0.0)) // Time-out is further or never, see where we're at
    {
    ...
    } else // Must be between (bigger than a timestep, but less than 1) - keep
           // going
    {
      return SM_DELTA;
    }
...
static TIMESTAMP sync_evcharger_det_impl(OBJECT *obj, TIMESTAMP t0,
                                         PASSCONFIG pass) {
  TIMESTAMP t1;
...
#ifndef __APPLE__
extern "C" MODULE_API TIMESTAMP sync_evcharger_det(OBJECT *obj, TIMESTAMP t0,
                                                   PASSCONFIG pass) {
...
interupdate_evcharger_det(OBJECT *obj, unsigned int64 delta_time,
  ...
  try {
    ...
    gl_error("interupdate_evcharger_det(obj=%d;%s): %s", obj->id,

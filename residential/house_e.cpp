...
int house_e::init(OBJECT *parent)
{
	...
	if (air_thermal_mass==0) air_thermal_mass = 20*air_heat_capacity*air_mass;			// thermal mass of air [BTU/F]  //*5 multiplier is to reflect that the air mass includes surface effects from the mass as well.  

...
public:
  ...
  static double
      power_factor[_MAXTYPES]; ///< Lighting power factors (the ordinals must
                               ///< match the \p type enumeration)
  ...
  gld::complex
      lights_actual_power; ///< actual light power demand as function of voltage

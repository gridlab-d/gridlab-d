...
meter::meter(MODULE *mod) : node(mod)
{
	...
	if (oclass==nullptr)
	{
		...
		if (gl_publish_variable(oclass,
			PT_INHERIT, "node",
			PT_double, "measured_real_energy[Wh]", PADDR(measured_real_energy),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered real energy consumption, cummalitive",
			...
			PT_double, "measured_reactive_energy[VAh]",PADDR(measured_reactive_energy),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered reactive energy consumption, cummalitive",
			...
			PT_complex, "measured_power[VA]", PADDR(measured_power),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered complex power",
			PT_complex, "measured_power_A[VA]", PADDR(indiv_measured_power[0]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered complex power on phase A",
			PT_complex, "measured_power_B[VA]", PADDR(indiv_measured_power[1]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered complex power on phase B",
			PT_complex, "measured_power_C[VA]", PADDR(indiv_measured_power[2]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered complex power on phase C",
			PT_double, "measured_demand[W]", PADDR(measured_demand),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"greatest metered real power during simulation",
			...
			PT_complex, "measured_voltage_A[V]", PADDR(measured_voltage[0]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"measured line-to-neutral voltage on phase A",
			PT_complex, "measured_voltage_B[V]", PADDR(measured_voltage[1]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"measured line-to-neutral voltage on phase B",
			PT_complex, "measured_voltage_C[V]", PADDR(measured_voltage[2]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"measured line-to-neutral voltage on phase C",
			PT_complex, "measured_voltage_AB[V]", PADDR(measured_voltageD[0]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"measured line-to-line voltage on phase AB",
			PT_complex, "measured_voltage_BC[V]", PADDR(measured_voltageD[1]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"measured line-to-line voltage on phase BC",
			PT_complex, "measured_voltage_CA[V]", PADDR(measured_voltageD[2]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"measured line-to-line voltage on phase CA",

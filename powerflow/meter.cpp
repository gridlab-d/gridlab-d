...
meter::meter(MODULE *mod) : node(mod)
{
    ...
    if (oclass == nullptr)
    {
        ...
        if (gl_publish_variable(
                ...
                PT_bool, "customer_interrupted_secondary", PADDR(meter_interrupted_secondary), PT_DESCRIPTION, "Reliability flag - goes active if the customer is in a 'secondary interrupted' state - i.e., momentary",
                ...
                PT_double, "last_measured_real_power", PADDR(last_measured_real_power), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last active value of measured_power",
                PT_double, "last_measured_real_power_3ph_A", PADDR(last_measured_real_power_3ph[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last active value of measured_power for phase A",
                PT_double, "last_measured_real_power_3ph_B", PADDR(last_measured_real_power_3ph[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last active value of measured_power for phase B",
                PT_double, "last_measured_real_power_3ph_C", PADDR(last_measured_real_power_3ph[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last active value of measured_power for phase C",
                PT_double, "last_measured_reactive_power", PADDR(last_measured_reactive_power), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last reactive value of measured_power",
                PT_double, "last_measured_reactive_power_3ph_A", PADDR(last_measured_reactive_power_3ph[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last reactive value of measured_power for phase A",
                PT_double, "last_measured_reactive_power_3ph_B", PADDR(last_measured_reactive_power_3ph[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last reactive value of measured_power for phase B",
                PT_double, "last_measured_reactive_power_3ph_C", PADDR(last_measured_reactive_power_3ph[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last reactive value of measured_power for phase C",
                PT_timestamp, "last_t", PADDR(last_t), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last synchronized time",
                PT_double, "hourly_acc", PADDR(hourly_acc), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: hourly energy accumulated",
                PT_int32, "last_bill_month", PADDR(last_bill_month), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last month that was billed",
                PT_double, "last_price", PADDR(last_price), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last energy price",
                PT_double, "last_price_base", PADDR(last_price_base), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last energy price before the first tie",
                PT_double, "last_tier_price_1", PADDR(last_tier_price[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last energy tier price 1",
                PT_double, "last_tier_price_2", PADDR(last_tier_price[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last energy tier price 2",
                PT_double, "last_tier_price_3", PADDR(last_tier_price[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last energy tier price 3",
                PT_double, "previous_energy_total", PADDR(previous_energy_total), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: energy total for previous update",
                PT_double, "last_measured_real_energy", PADDR(last_measured_real_energy), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR:",
                PT_double, "last_measured_reactive_energy", PADDR(last_measured_reactive_energy), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR:",
                PT_complex, "last_measured_max_voltage_mag_A", PADDR(last_measured_max_voltage_mag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured max voltage - phase A",
                PT_complex, "last_measured_max_voltage_mag_B", PADDR(last_measured_max_voltage_mag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured max voltage - phase B",
                PT_complex, "last_measured_max_voltage_mag_C", PADDR(last_measured_max_voltage_mag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured max voltage - phase C",
                PT_complex, "last_measured_max_voltageD_mag_AB", PADDR(last_measured_max_voltageD_mag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured max voltage - phase AB",
                PT_complex, "last_measured_max_voltageD_mag_BC", PADDR(last_measured_max_voltageD_mag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured max voltage - phase BC",
                PT_complex, "last_measured_max_voltageD_mag_CA", PADDR(last_measured_max_voltageD_mag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured max voltage - phase CA",
                PT_complex, "last_measured_min_voltage_mag_A", PADDR(last_measured_min_voltage_mag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured min voltage - phase A",
                PT_complex, "last_measured_min_voltage_mag_B", PADDR(last_measured_min_voltage_mag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured min voltage - phase B",
                PT_complex, "last_measured_min_voltage_mag_C", PADDR(last_measured_min_voltage_mag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured min voltage - phase C",
                PT_complex, "last_measured_min_voltageD_mag_A", PADDR(last_measured_min_voltageD_mag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured min voltage - phase AB",
                PT_complex, "last_measured_min_voltageD_mag_B", PADDR(last_measured_min_voltageD_mag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured min voltage - phase BC",
                PT_complex, "last_measured_min_voltageD_mag_C", PADDR(last_measured_min_voltageD_mag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous measured min voltage - phase CA",
                PT_complex, "last_measured_voltage_A", PADDR(last_measured_voltage[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured voltage - phase A",
                PT_complex, "last_measured_voltage_B", PADDR(last_measured_voltage[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured voltage - phase B",
                PT_complex, "last_measured_voltage_C", PADDR(last_measured_voltage[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured voltage - phase C",
                PT_complex, "last_measured_voltageD_AB", PADDR(last_measured_voltageD[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured voltage - phase AB",
                PT_complex, "last_measured_voltageD_BC", PADDR(last_measured_voltageD[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured voltage - phase BC",
                PT_complex, "last_measured_voltageD_CA", PADDR(last_measured_voltageD[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured voltage - phase CA",
                PT_double, "last_measured_avg_voltage_mag_A", PADDR(last_measured_avg_voltage_mag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average magnitude - phase A",
                PT_double, "last_measured_avg_voltage_mag_B", PADDR(last_measured_avg_voltage_mag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average magnitude - phase B",
                PT_double, "last_measured_avg_voltage_mag_C", PADDR(last_measured_avg_voltage_mag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average magnitude - phase C",
                PT_double, "last_measured_avg_voltageD_mag_AB", PADDR(last_measured_avg_voltageD_mag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average magnitude - phase AB",
                PT_double, "last_measured_avg_voltageD_mag_BC", PADDR(last_measured_avg_voltageD_mag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average magnitude - phase BC",
                PT_double, "last_measured_avg_voltageD_mag_CA", PADDR(last_measured_avg_voltageD_mag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average magnitude - phase CA",
                PT_double, "last_measured_max_real_power", PADDR(last_measured_max_real_power), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured max active power",
                PT_double, "last_measured_min_real_power", PADDR(last_measured_min_real_power), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured min active power",
                PT_double, "last_measured_max_reactive_power", PADDR(last_measured_max_reactive_power), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured max reactive power",
                PT_double, "last_measured_min_reactive_power", PADDR(last_measured_min_reactive_power), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured min reactive power",
                PT_double, "last_measured_avg_real_power", PADDR(last_measured_avg_real_power), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average active power",
                PT_double, "last_measured_avg_reactive_power", PADDR(last_measured_avg_reactive_power), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average reactive power",
                PT_double, "last_measured_max_real_power_3ph_A", PADDR(last_measured_max_real_power_3ph[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured active power maximum - phase A",
                PT_double, "last_measured_max_real_power_3ph_B", PADDR(last_measured_max_real_power_3ph[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured active power maximum - phase B",
                PT_double, "last_measured_max_real_power_3ph_C", PADDR(last_measured_max_real_power_3ph[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured active power maximum - phase C",
                PT_double, "last_measured_min_real_power_3ph_A", PADDR(last_measured_min_real_power_3ph[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured active power minimum - phase A",
                PT_double, "last_measured_min_real_power_3ph_B", PADDR(last_measured_min_real_power_3ph[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured active power minimum - phase B",
                PT_double, "last_measured_min_real_power_3ph_C", PADDR(last_measured_min_real_power_3ph[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured active power minimum - phase C",
                PT_double, "last_measured_max_reactive_power_3ph_A", PADDR(last_measured_max_reactive_power_3ph[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured reactive power maximum - phase A",
                PT_double, "last_measured_max_reactive_power_3ph_B", PADDR(last_measured_max_reactive_power_3ph[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured reactive power maximum - phase B",
                PT_double, "last_measured_max_reactive_power_3ph_C", PADDR(last_measured_max_reactive_power_3ph[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured reactive power maximum - phase C",
                PT_double, "last_measured_min_reactive_power_3ph_A", PADDR(last_measured_min_reactive_power_3ph[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured reactive power minimum - phase A",
                PT_double, "last_measured_min_reactive_power_3ph_B", PADDR(last_measured_min_reactive_power_3ph[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured reactive power minimum - phase B",
                PT_double, "last_measured_min_reactive_power_3ph_C", PADDR(last_measured_min_reactive_power_3ph[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured reactive power minimum - phase C",
                PT_double, "last_measured_avg_real_power_3ph_A", PADDR(last_measured_avg_real_power_3ph[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average active power - phase A",
                PT_double, "last_measured_avg_real_power_3ph_B", PADDR(last_measured_avg_real_power_3ph[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average active power - phase B",
                PT_double, "last_measured_avg_real_power_3ph_C", PADDR(last_measured_avg_real_power_3ph[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average active power - phase C",
                PT_double, "last_measured_avg_reactive_power_3ph_A", PADDR(last_measured_avg_reactive_power_3ph[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average reactive power - phase A",
                PT_double, "last_measured_avg_reactive_power_3ph_B", PADDR(last_measured_avg_reactive_power_3ph[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average reactive power - phase B",
                PT_double, "last_measured_avg_reactive_power_3ph_C", PADDR(last_measured_avg_reactive_power_3ph[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: last measured average reactive power - phase C",
                PT_int32, "voltage_avg_count", PADDR(voltage_avg_count), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: voltage average count",

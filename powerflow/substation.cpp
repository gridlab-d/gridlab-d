...
static TIMESTAMP sync_substation_impl(OBJECT *obj, TIMESTAMP t0, PASSCONFIG pass)
{
	try
	{
...
#ifndef __APPLE__
extern "C" MODULE_API TIMESTAMP sync_substation(OBJECT *obj, TIMESTAMP t0, PASSCONFIG pass)
{

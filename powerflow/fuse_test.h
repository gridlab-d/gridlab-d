...
class fuse_tests : public powerflow_test_helper {
  void test_three_phase_ganged_switch(bool status, set phases) {
    ...
    const complex bs_V2_in[3] = {complex(2442.6, -109.21),
                                 ...
                                 complex(-1137.7, 2156)};
    const complex bs_I2_in[3] = {complex(64.32, -49.78), complex(-57.1, -21.81),
                                 complex(10.38, 61.85)};
    ...
    const complex fs_I2_in[3] = {complex(64.32, -49.78), complex(-57.1, -21.81),
                                 complex(10.38, 61.85)};
    ...
    test_powerflow_link(test_fuse, VALIDATE_TOLERANCE, PHASE_ABC, PHASE_ABC,
                        bs_V2_in, bs_I2_in, bs_I1_out, fs_V1_in, fs_I2_in,
                        fs_V2_out);
  }

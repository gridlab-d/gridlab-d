...
static TIMESTAMP sync_regulator_configuration_impl(OBJECT *obj, TIMESTAMP t1, PASSCONFIG pass)
{
	return TS_NEVER;
}

#ifndef __APPLE__
extern "C" MODULE_API TIMESTAMP sync_regulator_configuration(OBJECT *obj, TIMESTAMP t1, PASSCONFIG pass)
{

...
link_object::link_object(MODULE *mod) : powerflow_object(mod)
{
	...
	if (oclass==NULL)
	{
		...
		if(gl_publish_variable(oclass,
			...
			PT_double, "power_out_imag[VAr]", PADDR(power_out.Im()),PT_DESCRIPTION,"power flow out (w.r.t to node), imaginary",
			...
			PT_double, "power_out_A_real[W]", PADDR(indiv_power_out[0].Re()),PT_DESCRIPTION,"power flow out (w.r.t to node), phase A real",
			PT_double, "power_out_A_imag[VAr]", PADDR(indiv_power_out[0].Im()),PT_DESCRIPTION,"power flow out (w.r.t to node), phase A imaginary",
			PT_complex, "power_out_B[VA]", PADDR(indiv_power_out[1]),PT_DESCRIPTION,"power flow out (w.r.t to node), phase B",
			PT_double, "power_out_B_real[W]", PADDR(indiv_power_out[1].Re()),PT_DESCRIPTION,"power flow out (w.r.t to node), phase B real",
			PT_double, "power_out_B_imag[VAr]", PADDR(indiv_power_out[1].Im()),PT_DESCRIPTION,"power flow out (w.r.t to node), phase B imaginary",
			PT_complex, "power_out_C[VA]", PADDR(indiv_power_out[2]),PT_DESCRIPTION,"power flow out (w.r.t to node), phase C",
			PT_double, "power_out_C_real[W]", PADDR(indiv_power_out[2].Re()),PT_DESCRIPTION,"power flow out (w.r.t to node), phase C real",
			PT_double, "power_out_C_imag[VAr]", PADDR(indiv_power_out[2].Im()),PT_DESCRIPTION,"power flow out (w.r.t to node), phase C imaginary",

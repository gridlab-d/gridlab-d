...
#define GMR(ph) (has_phase(PHASE_##ph) && config->phase##ph##_conductor ? object_data<overhead_line_conductor>(config->phase##ph##_conductor)->geometric_mean_radius : 0.0)
#define RES(ph) (has_phase(PHASE_##ph) && config->phase##ph##_conductor ? object_data<overhead_line_conductor>(config->phase##ph##_conductor)->resistance : 0.0)
...
#define DIAM(ph) (has_phase(PHASE_##ph) && config->phase##ph##_conductor ? object_data<overhead_line_conductor>(config->phase##ph##_conductor)->cable_diameter : 0.0)

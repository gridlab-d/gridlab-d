...
public:
  ...
  void test_triplex_line() {
    ...
    OBJECTDATA(node1, triplex_node)->voltageA =
        OBJECTDATA(node2, triplex_node)->voltageA = complex(115.44, -0.26192);
    OBJECTDATA(node2, triplex_node)->currentA = complex(159.91, -79.788);
    OBJECTDATA(node1, triplex_node)->voltageB =
        OBJECTDATA(node2, triplex_node)->voltageB = complex(122.45, -2.5421);
    OBJECTDATA(node2, triplex_node)->currentB = complex(-199.4, 106.36);
    OBJECTDATA(node1, triplex_node)->voltageC =
        OBJECTDATA(node2, triplex_node)->voltageC = complex(0, 0);
    ...
    double rI_1 = OBJECTDATA(node1, triplex_node)
                      ->currentA.Re(); // Real part of the current at node 1
    double iI_1 =
        OBJECTDATA(node1, triplex_node)

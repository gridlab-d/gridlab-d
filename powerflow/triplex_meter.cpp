...
triplex_meter::triplex_meter(MODULE *mod) : triplex_node(mod)
{
    ...
    if (oclass == nullptr)
    {
		...
		if (gl_publish_variable(oclass,
			...
			PT_double, "measured_real_energy[Wh]", PADDR(measured_real_energy),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered real energy consumption",
			PT_double, "measured_real_energy_delta[Wh]", PADDR(measured_real_energy_delta),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"delta in metered real energy consumption from last specified measured_energy_delta_timestep",
			PT_double, "measured_reactive_energy[VAh]",PADDR(measured_reactive_energy),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered reactive energy consumption",
			PT_double, "measured_reactive_energy_delta[VAh]",PADDR(measured_reactive_energy_delta),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"delta in metered reactive energy consumption from last specified measured_energy_delta_timestep",
			...
			PT_complex, "measured_power[VA]", PADDR(measured_power),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered power",
			PT_complex, "indiv_measured_power_1[VA]", PADDR(indiv_measured_power[0]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered power, phase 1",
			PT_complex, "indiv_measured_power_2[VA]", PADDR(indiv_measured_power[1]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered power, phase 2",
			PT_complex, "indiv_measured_power_N[VA]", PADDR(indiv_measured_power[2]),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered power, phase N",
			PT_double, "measured_demand[W]", PADDR(measured_demand),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered demand (peak of power)",
			PT_double, "measured_real_power[W]", PADDR(measured_real_power),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered real power",
			PT_double, "measured_reactive_power[VAr]", PADDR(measured_reactive_power),PT_ACCESS,PA_REFERENCE,PT_DESCRIPTION,"metered reactive power",

...
class transformer_tests : public test_helper {
  ...
  void test_delta_delta_transformer() {
    ...
    OBJECTDATA(node1, node)->voltageA = OBJECTDATA(node2, load)->voltageA =
        2251.5;
    ...
    OBJECTDATA(node1, node)->voltageB = OBJECTDATA(node2, load)->voltageB =
        -1248;
    ...
    OBJECTDATA(node1, node)->voltageC = OBJECTDATA(node2, load)->voltageC =
        -1001.7;
    ...
    OBJECTDATA(trans_config, transformer_configuration)->V_primary =
        12.47 * 1000;
    ...
    OBJECTDATA(trans_config, transformer_configuration)->connect_type =
        transformer_configuration::DELTA_DELTA; // delta-delta
    ...
    validate_re =
        1 - (rV_2 <= node2_phA_V_test->Re() ? rV_2 / node2_phA_V_test->Re()
                                            : node2_phA_V_test->Re() / rV_2);
    validate_im =
        1 - (iV_2 <= node2_phA_V_test->Im() ? iV_2 / node2_phA_V_test->Im()
                                            : node2_phA_V_test->Im() / iV_2);
    CPPUNIT_ASSERT(validate_re < VALIDATE_THRESHOLD);
    CPPUNIT_ASSERT(validate_im < VALIDATE_THRESHOLD);
    ...
    validate_re =
        1 - (rV_2 <= node2_phB_V_test->Re() ? rV_2 / node2_phB_V_test->Re()
                                            : node2_phB_V_test->Re() / rV_2);
    validate_im =
        1 - (iV_2 <= node2_phB_V_test->Im() ? iV_2 / node2_phB_V_test->Im()
                                            : node2_phB_V_test->Im() / iV_2);
    CPPUNIT_ASSERT(validate_re < VALIDATE_THRESHOLD);
    CPPUNIT_ASSERT(validate_im < VALIDATE_THRESHOLD);
    ...
    validate_re =
        1 - (rV_2 <= node2_phC_V_test->Re() ? rV_2 / node2_phC_V_test->Re()
                                            : node2_phC_V_test->Re() / rV_2);
    validate_im =
        1 - (iV_2 <= node2_phC_V_test->Im() ? iV_2 / node2_phC_V_test->Im()
                                            : node2_phC_V_test->Im() / iV_2);
    CPPUNIT_ASSERT(validate_re < VALIDATE_THRESHOLD);
    CPPUNIT_ASSERT(validate_im < VALIDATE_THRESHOLD);
  }
  ...
  void test_delta_Gwye_transformer() {
    ...
    //		OBJECTDATA(trans_config,transformer_configuration)->R_pu =
    //0.0074;
    OBJECTDATA(trans_config, transformer_configuration)
        ->impedance.SetReal(0.0074);
    //		OBJECTDATA(trans_config,transformer_configuration)->X_pu =
    //0.0847;
    OBJECTDATA(trans_config, transformer_configuration)
        ->impedance.SetImag(0.0847);
    OBJECTDATA(trans_config, transformer_configuration)->connect_type =
        transformer_configuration::DELTA_GWYE;
    OBJECTDATA(tformer, transformer)->configuration = trans_config;
  ...
  void test_wye_wye_transformer() {
    ...
    // OBJECTDATA(trans_config,transformer_configuration)->R_pu = .01;
    OBJECTDATA(trans_config, transformer_configuration)
        ->impedance.SetReal(0.01);
    // OBJECTDATA(trans_config,transformer_configuration)->X_pu = .06;
    OBJECTDATA(trans_config, transformer_configuration)
        ->impedance.SetImag(0.06);
    OBJECTDATA(trans_config, transformer_configuration)->connect_type =
        transformer_configuration::WYE_WYE;
    OBJECTDATA(tformer, transformer)->configuration = trans_config;
  ...
  void test_center_tapped_transformer_Aphase() {
    ...
    validate_re = 1 - (rV_2 <= node2_phC_V_test->Re() ? rV_2 /
    node2_phC_V_test->Re() : node2_phC_V_test->Re() /rV_2); validate_im = 1 -
    (iV_2 <= node2_phC_V_test->Im() ? iV_2 / node2_phC_V_test->Im() :
    node2_phC_V_test->Im() /iV_2); CPPUNIT_ASSERT(validate_re <
    VALIDATE_THRESHOLD); CPPUNIT_ASSERT(validate_im < VALIDATE_THRESHOLD);*/
  }
  /*

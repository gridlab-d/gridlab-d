...
public:
  ...
  void test_underground_line_a_cn() {
    ...
    // OBJECTDATA(ohl1,underground_line)->phase = OBJECTDATA(node1,node)->phase
    // = OBJECTDATA(node2,load)->phase = PHASEA;
    ...
    OBJECTDATA(ls, line_spacing)->distance_AtoN =
        0.0; // no extra neutral
    ...
    OBJECTDATA(olc_n,underground_line_conductor)->geometric_mean_radius =
    .00446; OBJECTDATA(olc_n,underground_line_conductor)->resistance = 1.12;
    */
  ...
  void test_underground_line_b_cn() {
    ...
    cl = get_class_by_name("line_spacing");
    OBJECT *ls = gl_create_object(cl);
    OBJECTDATA(ls, line_spacing)->distance_BtoN =
        0.0; // no extra neutral
             //(OBJECTDATA(ulc_a,underground_line_conductor)->outer_diameter -
             //										  OBJECTDATA(ulc_a,underground_line_conductor)->neutral_diameter)/24.0;
    ...
    */
    ...
    // Check the bottom-up pass values
    double rI_1 = OBJECTDATA(node1, node)
                      ->currentB.Re(); // Real part of the current at node 1
    double iI_1 =
        OBJECTDATA(node1, node)
            ->currentB.Im(); // Imaginary part of the current at node 1

    // Get the percentage of the difference between the calculated value and the
    // test value
    double validate_re =
        1 - (rI_1 <= node1_phB_I_test->Re() ? rI_1 / node1_phB_I_test->Re()
                                            : node1_phB_I_test->Re() / rI_1);
    double validate_im =
        1 - (iI_1 <= node1_phB_I_test->Im() ? iI_1 / node1_phB_I_test->Im()
                                            : node1_phB_I_test->Im() / iI_1);
  ...
  void test_underground_line_c_cn() {
    ...
    cl = get_class_by_name("line_spacing");
    OBJECT *ls = gl_create_object(cl);
    OBJECTDATA(ls, line_spacing)->distance_CtoN =
        0.0; // no extra neutral
             //(OBJECTDATA(ulc_a,underground_line_conductor)->outer_diameter -
             //										  OBJECTDATA(ulc_a,underground_line_conductor)->neutral_diameter)/24.0;
    ...
    */
    ...
    // Check the bottom-up pass values
    double rI_1 = OBJECTDATA(node1, node)
                      ->currentC.Re(); // Real part of the current at node 1
    double iI_1 =
        OBJECTDATA(node1, node)
            ->currentC.Im(); // Imaginary part of the current at node 1

    // Get the percentage of the difference between the calculated value and the
    // test value
    double validate_re =
        1 - (rI_1 <= node1_phC_I_test->Re() ? rI_1 / node1_phC_I_test->Re()
                                            : node1_phC_I_test->Re() / rI_1);
    double validate_im =
        1 - (iI_1 <= node1_phC_I_test->Im() ? iI_1 / node1_phC_I_test->Im()
                                            : node1_phC_I_test->Im() / iI_1);

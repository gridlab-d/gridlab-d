...
protected:
  static void
  test_powerflow_link(class link_object *test_link, double tolerance,
                      gld::set phases1, gld::set phases2,
                      const complex bs_V2_in[3], const complex bs_I2_in[3],
                      const complex bs_I1_out[3], const complex fs_V1_in[3],
                      const complex fs_I2_in[3], const complex fs_V2_out[3]) {

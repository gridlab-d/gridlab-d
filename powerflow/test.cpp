 ...
 * 	Include Directories property and adding the location of the cppunit
 include
 ...
 * 		-# Expand the linker subtree, and under Additional Dependancies,
 add
 * 		cppunitd.lib (for debug configuration) or cppunit.lib (for
 release
 * 		configuration).
 * 		-# Select the general child of the linker subtree, and add the
 location
 * 		to the cppunit library files to the Additional Library
 Directories item
 ...
 *
 * @param callbacks struct of functions pointing back to accessor functions in
 * the core.
 * @param argc a count of the number of arguments that were passed in on the
 * command line.
 * @param argv pointer to an array of characters which contains the arguments
 * passed in on the command line
 * @return either 0 or 1 depending on the outcome of the tests.  1 is returned
 * upon successful completion, and 0 indicates a test failure.
 */

...
triplex_node::triplex_node(MODULE *mod) : node(mod)
{
    if (oclass == nullptr)
    {
        ...
        if (gl_publish_variable(oclass,
                                ...
                                PT_complex, "last_voltage_1", PADDR(last_voltage[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous voltage value for phase 1",
                                PT_complex, "last_voltage_2", PADDR(last_voltage[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous voltage value for phase 2",
                                PT_complex, "last_voltage_N", PADDR(last_voltage[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous voltage value for phase N",
                                PT_complex, "last_child_power_power_1", PADDR(last_child_power[0][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for power of phase 1",
                                PT_complex, "last_child_power_power_2", PADDR(last_child_power[0][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for power of phase 2",
                                PT_complex, "last_child_power_power_N", PADDR(last_child_power[0][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for power of phase N",
                                PT_complex, "last_child_power_shunt_1", PADDR(last_child_power[1][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for shunt of phase 1",
                                PT_complex, "last_child_power_shunt_2", PADDR(last_child_power[1][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for shunt of phase 2",
                                PT_complex, "last_child_power_shunt_N", PADDR(last_child_power[1][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for shunt of phase N",
                                PT_complex, "last_child_power_current_1", PADDR(last_child_power[2][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for current of phase 1",
                                PT_complex, "last_child_power_current_2", PADDR(last_child_power[2][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for current of phase 2",
                                PT_complex, "last_child_power_current_N", PADDR(last_child_power[2][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for current of phase N",
                                PT_complex, "last_child_power_pre_rotate_current_1", PADDR(last_child_power[3][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for pre-rotated current of phase 1",
                                PT_complex, "last_child_power_pre_rotate_current_2", PADDR(last_child_power[3][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for pre-rotated current of phase 2",
                                PT_complex, "last_child_power_pre_rotate_current_N", PADDR(last_child_power[3][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for pre-rotated current of phase N",
                                ...
                                PT_complex, "shunt_change_check_1", PADDR(shunt_change_check[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase 1",
                                PT_complex, "shunt_change_check_2", PADDR(shunt_change_check[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase 2",
                                PT_complex, "shunt_change_check_N", PADDR(shunt_change_check[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase N",
...
#ifdef __APPLE__
    parent = obj->parent; // AppleClang seems to have an issue with the
#endif

...
protected:
	void load_matrix_based_configuration(gld::complex Zabc_mat[4][4], gld::complex Yabc_mat[4][4]);
	void recalc_line_matricies(gld::complex Zabc_mat[4][4], gld::complex Yabc_mat[4][4]);
};

...
capacitor::capacitor(MODULE *mod):node(mod)
{
	if(oclass == NULL)
	{
		...
		if(gl_publish_variable(oclass,
			...
			PT_double, "voltage_deadband[V]", PADDR(voltage_deadband), PT_DESCRIPTION,"The deadband between voltage_set__high and voltage_set_low",
			...
			PT_double, "VAr_deadband[VAr]", PADDR(VAr_deadband), PT_DESCRIPTION,"The deadband between VAr_set__high and VAr_set_low",
			...
			PT_double, "voltage_deadband_center[A]", PADDR(current_center), PT_DESCRIPTION,"The current deadband center",
			PT_double, "voltage_deadband[A]", PADDR(current_deadband), PT_DESCRIPTION,"The deadband between current_set__high and current_set_low",

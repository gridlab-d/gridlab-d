...
public:
  ...
  typedef enum { INDIVIDUAL = 1, BANK = 2 } control_level_enum;

  typedef enum { A = 1, B } Type_enum;
  ...
  double ldc_R_V[3];  // Line Drop Compensation R setting of regulator control
                      // (in volts)
  double ldc_X_V[3];  // Line Drop Compensation X setting of regulator control
                      // (in volts)

// $Id: regulator.cpp 1182 2008-12-22 22:08:36Z dchassin $
...
regulator::regulator(MODULE *mod) : link(mod)
{
	if (oclass==NULL)
	{
		...
		oclass = gl_register_class(mod,"regulator",sizeof(regulator),PC_BOTTOMUP|PC_POSTTOPDOWN|PC_UNSAFE_OVERRIDE_OMIT);
		if (oclass==NULL)

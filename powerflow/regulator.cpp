...
regulator::regulator(MODULE *mod) : link_object(mod)
{
    if (oclass == nullptr)
    {
        ...
        if (gl_publish_variable(oclass,
                                ...
                                PT_int16, "initial_tap_A", PADDR(initial_tap_A), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for initial_tap_A",
                                PT_int16, "initial_tap_B", PADDR(initial_tap_B), PT_ACCESS, PA_HIDDEN, PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for initial_tap_B",
                                PT_int16, "initial_tap_C", PADDR(initial_tap_C), PT_ACCESS, PA_HIDDEN, PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for initial_tap_C",
                                PT_int16, "prev_tap_0", PADDR(prev_tap[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for prev_tap",
                                PT_int16, "prev_tap_1", PADDR(prev_tap[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for prev_tap",
                                PT_int16, "prev_tap_2", PADDR(prev_tap[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for prev_tap",
                                PT_int16, "tap_A_changed", PADDR(tap_A_changed), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for tap_A_changed",
                                PT_int16, "tap_B_changed", PADDR(tap_B_changed), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for tap_B_changed",
                                PT_int16, "tap_C_changed", PADDR(tap_C_changed), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for tap_C_changed",
                                PT_double, "prev_time", PADDR(prev_time), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for prev_time",
                                PT_int16, "prev_tap_A", PADDR(prev_tap_A), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for prev_tap_A",
                                PT_int16, "prev_tap_B", PADDR(prev_tap_B), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for prev_tap_B",
                                PT_int16, "prev_tap_C", PADDR(prev_tap_C), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for prev_tap_C",
                                PT_double, "mech_t_next_0", PADDR(mech_t_next[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for mech_t_next",
                                PT_double, "mech_t_next_1", PADDR(mech_t_next[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for mech_t_next",
                                PT_double, "mech_t_next_2", PADDR(mech_t_next[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for mech_t_next",
                                PT_double, "dwell_t_next_0", PADDR(dwell_t_next[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for dwell_t_next",
                                PT_double, "dwell_t_next_1", PADDR(dwell_t_next[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for dwell_t_next",
                                PT_double, "dwell_t_next_2", PADDR(dwell_t_next[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for dwell_t_next",
                                PT_double, "next_time", PADDR(next_time), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for next_time",
                                PT_int16, "mech_flag_0", PADDR(mech_flag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for mech_flag",
                                PT_int16, "mech_flag_1", PADDR(mech_flag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for mech_flag",
                                PT_int16, "mech_flag_2", PADDR(mech_flag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for mech_flag",
                                PT_int16, "dwell_flag_0", PADDR(dwell_flag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for dwell_flag",
                                PT_int16, "dwell_flag_1", PADDR(dwell_flag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for dwell_flag",
                                PT_int16, "dwell_flag_2", PADDR(dwell_flag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for dwell_flag",
                                PT_int16, "first_run_flag_0", PADDR(first_run_flag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for first_run_flag",
                                PT_int16, "first_run_flag_1", PADDR(first_run_flag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for first_run_flag",
                                PT_int16, "first_run_flag_2", PADDR(first_run_flag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for first_run_flag",
                                PT_bool, "toggle_reverse_flow_0", PADDR(toggle_reverse_flow[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for toggle_reverse_flow",
                                PT_bool, "toggle_reverse_flow_1", PADDR(toggle_reverse_flow[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for toggle_reverse_flow",
                                PT_bool, "toggle_reverse_flow_2", PADDR(toggle_reverse_flow[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for toggle_reverse_flow",
                                PT_bool, "toggle_reverse_flow_banked", PADDR(toggle_reverse_flow_banked), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for toggle_reverse_flow_banked",
                                PT_int16, "reverse_flow_tap_0", PADDR(reverse_flow_tap[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for reverse_flow_tap",
                                PT_int16, "reverse_flow_tap_1", PADDR(reverse_flow_tap[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for reverse_flow_tap",
                                PT_int16, "reverse_flow_tap_2", PADDR(reverse_flow_tap[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for reverse_flow_tap",
                                PT_bool, "offnominal_time", PADDR(offnominal_time), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for offnominal_time",
                                PT_bool, "iteration_flag", PADDR(iteration_flag), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for iteration_flag",
                                PT_bool, "new_reverse_flow_action_0", PADDR(new_reverse_flow_action[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for new_reverse_flow_action",
                                PT_bool, "new_reverse_flow_action_1", PADDR(new_reverse_flow_action[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for new_reverse_flow_action",
                                PT_bool, "new_reverse_flow_action_2", PADDR(new_reverse_flow_action[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for new_reverse_flow_action",
                                nullptr) < 1)
...
TIMESTAMP regulator::presync(TIMESTAMP t0)
{
    ...
    if ((first_run_flag[0] < 1) || (first_run_flag[1] < 1) || (first_run_flag[2] < 1))
        return t1;
...
void regulator::set_flow_directions(void)
{
    int i;
    static uint64 shift[] = {0, 4, 8};
    static int phase[] = {PHASE_A, PHASE_B, PHASE_C};
    flow_direction = FD_UNKNOWN; // clear the flows
    if (!has_phase(PHASE_S))
    {
        for (i = 0; i < 3; i++)
        {
            if (has_phase(phase[i]))
            {
                double power_out_real = indiv_power_out[i].Re();
                double power_out_imag = indiv_power_out[i].Im();
                if (abs(power_out_real) > abs(power_out_imag))
                {
                    if (power_out_real > 1e-6)
                    {
                        flow_direction |= ((uint64)FD_A_NORMAL << shift[i]);
                    }
                    else if (power_out_real < -1e-6)
                    {
                        flow_direction |= ((uint64)FD_A_REVERSE << shift[i]);
                    }
                    else
                    {
                        flow_direction |= ((uint64)FD_A_NONE << shift[i]);
                    }
                }
                else if (abs(power_out_imag) > abs(power_out_real))
                {
                    if (power_out_imag > 1e-6)
                    {
                        flow_direction |= ((uint64)FD_A_NORMAL << shift[i]);
                    }
                    else if (power_out_imag < -1e-6)
                    {
                        flow_direction |= ((uint64)FD_A_REVERSE << shift[i]);
                    }
                    else
    ...
    if (iteration_flag)
    {
        ...
        if (pConfig->Control != pConfig->MANUAL)
        {
            ...
            if (pConfig->reverse_flow_control == pConfig->LOCK_NEUTRAL)
            {
                if (pConfig->control_level == pConfig->INDIVIDUAL)
                {
                    if ((flow_direction & FD_A_MASK) == FD_A_REVERSE && !toggle_reverse_flow[0])
                    { // Phase A power in reverse
                    ...
                    if ((flow_direction & FD_B_MASK) == FD_B_REVERSE && !toggle_reverse_flow[1])
                    { // Phase A power in reverse
                    ...
                    if ((flow_direction & FD_C_MASK) == FD_C_REVERSE && !toggle_reverse_flow[2])
                    { // Phase A power in reverse
                ...
                {
                    if (((flow_direction & FD_A_MASK) == FD_A_REVERSE || (flow_direction & FD_B_MASK) == FD_B_REVERSE || (flow_direction & FD_C_MASK) == FD_C_REVERSE) && !toggle_reverse_flow_banked)
                    { // Phase A power in reverse
                    ...
                    else if (((flow_direction & FD_A_MASK) != FD_A_REVERSE && (flow_direction & FD_B_MASK) != FD_B_REVERSE && (flow_direction & FD_C_MASK) != FD_C_REVERSE) && toggle_reverse_flow_banked)
                    { // Phase A power in reverse

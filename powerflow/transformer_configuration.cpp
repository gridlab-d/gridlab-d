    ...
    : powerflow_library(mod)
{
    if (oclass == nullptr)
    {
        ...
        if (gl_publish_variable(oclass,
                                ...
                                PT_KEYWORD, "UNKNOWN", powerflow_const::UNKNOWN,
                                ...
                                PT_double, "resistance[pu]", PADDR(impedance.Re()), PT_DESCRIPTION, "Series impedance, pu, real",
                                PT_double, "reactance[pu]", PADDR(impedance.Im()), PT_DESCRIPTION, "Series impedance, pu, imag",
                                PT_complex, "impedance[pu]", PADDR(impedance), PT_DESCRIPTION, "Series impedance, pu",
                                PT_double, "resistance1[pu]", PADDR(impedance1.Re()), PT_DESCRIPTION, "Secondary series impedance (only used when you want to define each individual winding seperately, pu, real",
                                PT_double, "reactance1[pu]", PADDR(impedance1.Im()), PT_DESCRIPTION, "Secondary series impedance (only used when you want to define each individual winding seperately, pu, imag",
                                PT_complex, "impedance1[pu]", PADDR(impedance1), PT_DESCRIPTION, "Secondary series impedance (only used when you want to define each individual winding seperately, pu",
                                PT_double, "resistance2[pu]", PADDR(impedance2.Re()), PT_DESCRIPTION, "Secondary series impedance (only used when you want to define each individual winding seperately, pu, real",
                                PT_double, "reactance2[pu]", PADDR(impedance2.Im()), PT_DESCRIPTION, "Secondary series impedance (only used when you want to define each individual winding seperately, pu, imag",
                                PT_complex, "impedance2[pu]", PADDR(impedance2), PT_DESCRIPTION, "Secondary series impedance (only used when you want to define each individual winding seperately, pu",
                                PT_double, "shunt_resistance[pu]", PADDR(shunt_impedance.Re()), PT_DESCRIPTION, "Shunt impedance on primary side, pu, real",
                                PT_double, "shunt_reactance[pu]", PADDR(shunt_impedance.Im()), PT_DESCRIPTION, "Shunt impedance on primary side, pu, imag",
                                PT_complex, "shunt_impedance[pu]", PADDR(shunt_impedance), PT_DESCRIPTION, "Shunt impedance on primary side, pu",

...
EXPORT CLASS *init(CALLBACKS *fntable, MODULE *module, int argc, char *argv[]) {
    ...
    /* exported globals */
    gl_global_create(const_cast<char *>("powerflow::show_matrix_values"), PT_bool, &show_matrix_values, NULL);
    gl_global_create(const_cast<char *>("powerflow::primary_voltage_ratio"), PT_double, &primary_voltage_ratio, NULL);
    gl_global_create(const_cast<char *>("powerflow::nominal_frequency"), PT_double, &nominal_frequency, NULL);
    gl_global_create(const_cast<char *>("powerflow::require_voltage_control"), PT_bool, &require_voltage_control, NULL);
    gl_global_create(const_cast<char *>("powerflow::geographic_degree"), PT_double, &geographic_degree, NULL);
    gl_global_create(const_cast<char *>("powerflow::fault_impedance"), PT_complex, &fault_Z, NULL);
    gl_global_create(const_cast<char *>("powerflow::ground_impedance"), PT_complex, &ground_Z, NULL);
    gl_global_create(const_cast<char *>("powerflow::warning_underfrequency"), PT_double, &warning_underfrequency, NULL);
    gl_global_create(const_cast<char *>("powerflow::warning_overfrequency"), PT_double, &warning_overfrequency, NULL);
    gl_global_create(const_cast<char *>("powerflow::warning_undervoltage"), PT_double, &warning_undervoltage, NULL);
    gl_global_create(const_cast<char *>("powerflow::warning_overvoltage"), PT_double, &warning_overvoltage, NULL);
    gl_global_create(const_cast<char *>("powerflow::warning_voltageangle"), PT_double, &warning_voltageangle, NULL);
    gl_global_create(const_cast<char *>("powerflow::maximum_voltage_error"), PT_double, &default_maximum_voltage_error,
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::solver_method"), PT_enumeration, &solver_method,
                     PT_KEYWORD, "FBS", SM_FBS,
                     PT_KEYWORD, "GS", SM_GS,
                     PT_KEYWORD, "NR", SM_NR,
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::NR_matrix_file"), PT_char256, &MDFileName, NULL);
    gl_global_create(const_cast<char *>("powerflow::NR_matrix_output_interval"), PT_enumeration, &NRMatDumpMethod,
                     PT_KEYWORD, "NEVER", MD_NONE,
                     PT_KEYWORD, "ONCE", MD_ONCE,
                     PT_KEYWORD, "PER_CALL", MD_PERCALL,
                     PT_KEYWORD, "ALL", MD_ALL,
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::NR_matrix_output_references"), PT_bool, &NRMatReferences, NULL);
    gl_global_create(const_cast<char *>("powerflow::NR_island_failure_handled"), PT_bool, &NR_island_fail_method,
                     PT_DESCRIPTION, "Indicates if an island fails if it should be removed from service", NULL);
    gl_global_create(const_cast<char *>("powerflow::line_capacitance"), PT_bool, &use_line_cap, NULL);
    gl_global_create(const_cast<char *>("powerflow::line_limits"), PT_bool, &use_link_limits, NULL);
    gl_global_create(const_cast<char *>("powerflow::lu_solver"), PT_char256, &LUSolverName, NULL);
    gl_global_create(const_cast<char *>("powerflow::NR_iteration_limit"), PT_int64, &NR_iteration_limit, NULL);
    gl_global_create(const_cast<char *>("powerflow::NR_deltamode_iteration_limit"), PT_int64, &NR_delta_iteration_limit,
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::NR_superLU_procs"), PT_int32, &NR_superLU_procs, NULL);
    gl_global_create(const_cast<char *>("powerflow::default_maximum_voltage_error"), PT_double,
                     &default_maximum_voltage_error, NULL);
    gl_global_create(const_cast<char *>("powerflow::default_maximum_power_error"), PT_double,
                     &default_maximum_power_error, NULL);
    gl_global_create(const_cast<char *>("powerflow::NR_admit_change"), PT_bool, &NR_admit_change, NULL);
    gl_global_create(const_cast<char *>("powerflow::enable_subsecond_models"), PT_bool, &enable_subsecond_models,
                     PT_DESCRIPTION, "Enable deltamode capabilities within the powerflow module", NULL);
    gl_global_create(const_cast<char *>("powerflow::all_powerflow_delta"), PT_bool, &all_powerflow_delta,
                     PT_DESCRIPTION, "Forces all powerflow objects that are capable to participate in deltamode", NULL);
    gl_global_create(const_cast<char *>("powerflow::deltamode_timestep"), PT_double, &deltamode_timestep_publish,
                     PT_UNITS, "ns", PT_DESCRIPTION, "Desired minimum timestep for deltamode-related simulations",
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::current_frequency"), PT_double, &current_frequency, PT_UNITS, "Hz",
                     PT_DESCRIPTION, "Current system-level frequency of the powerflow system", NULL);
    gl_global_create(const_cast<char *>("powerflow::master_frequency_update"), PT_bool, &master_frequency_update,
                     PT_DESCRIPTION, "Tracking variable to see if an object has become the system frequency updater",
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::enable_frequency_dependence"), PT_bool,
                     &enable_frequency_dependence, PT_DESCRIPTION,
                     "Flag to enable frequency-based variations in impedance values of lines and loads", NULL);
    gl_global_create(const_cast<char *>("powerflow::default_resistance"), PT_double, &default_resistance, NULL);
    gl_global_create(const_cast<char *>("powerflow::enable_inrush"), PT_bool, &enable_inrush_calculations,
                     PT_DESCRIPTION, "Flag to enable in-rush calculations for lines and transformers in deltamode",
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::inrush_integration"), PT_enumeration,
                     ...
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::all_frequency_measure_default"), PT_enumeration,
                     &all_powerflow_freq_measure_method,
                     PT_KEYWORD, "NONE", FMM_NONE,
                     PT_KEYWORD, "SIMPLE", FMM_SIMPLE,
                     PT_KEYWORD, "PLL", FMM_PLL,
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::low_voltage_impedance_level"), PT_double,
                     ...
                     NULL);
    gl_global_create(const_cast<char *>("powerflow::enable_mesh_fault_current"), PT_bool, &enable_mesh_fault_current,
                     PT_DESCRIPTION, "Flag to enable mesh-based fault current calculations", NULL);
    gl_global_create(const_cast<char *>("powerflow::market_price_name"), PT_char1024, &market_price_name,
                     PT_DESCRIPTION, "Market current price published variable name", NULL);
...
EXPORT SIMULATIONMODE interupdate(MODULE *module, TIMESTAMP t0, unsigned int64 delta_time, unsigned long dt,
    ...
    if (enable_subsecond_models == true) {
        ...
        while (simple_iter_test < NR_delta_iteration_limit)    //Simple iteration capability
        {
            ...
            for (curr_object_number = 0; curr_object_number < pwr_object_count; curr_object_number++) {
                ...
                if ((delta_objects[curr_object_number]->in_svc_double <= gl_globaldeltaclock) &&
                    (delta_objects[curr_object_number]->out_svc_double >= gl_globaldeltaclock)) {
                    if (delta_functions[curr_object_number] != NULL) {
                        //Try/catch for any GL_THROWs that may be called
                        try {
                            //Call the actual function
                            function_status = ((SIMULATIONMODE (*)(OBJECT *, unsigned int64, unsigned long,
                                                                   unsigned int,
                                                                   bool)) (*delta_functions[curr_object_number]))(
                                    delta_objects[curr_object_number], delta_time, dt, iteration_count_val, false);
                        }
                ...
                if (function_status == SM_ERROR) {
                    gl_error("Powerflow object:%s - deltamode function returned an error!",
            ...
            try {
                ...
                pf_result = solver_nr(NR_bus_count, NR_busdata, NR_branch_count, NR_branchdata, &NR_powerflow,
                                      powerflow_type, NULL, &bad_computation);
#else
            ...
            if (bad_computation == true) {
                ...
                */
                error_state = true;
                break;
            } else if ((pf_result < 0) && (simple_iter_test ==
                                           limit_minus_one))    //Failure to converge - this is a failure in dynamic mode for now
            {
            ...
            for (curr_object_number = 0; curr_object_number < pwr_object_count; curr_object_number++) {
                    ...
                    if (delta_functions[curr_object_number] != NULL) {
                        ...
                        try {
                            ...
                            function_status = ((SIMULATIONMODE (*)(OBJECT *, unsigned int64, unsigned long,
                                                                   unsigned int,
                                                                   bool)) (*delta_functions[curr_object_number]))(
                                    delta_objects[curr_object_number], delta_time, dt, iteration_count_val, true);
                        }
                        catch (const char *msg) {
                ...
                if (function_status == SM_DELTA) {
                    gl_verbose("Powerflow object:%d - %s - requested deltamode to continue",
                               delta_objects[curr_object_number]->id,
                               (delta_objects[curr_object_number]->name ? delta_objects[curr_object_number]->name
                                                                        : "Unnamed"));

                    event_driven = false;
                } else if (function_status == SM_DELTA_ITER) {
                    gl_verbose("Powerflow object:%d - %s - requested a deltamode reiteration",
                               delta_objects[curr_object_number]->id,
                               (delta_objects[curr_object_number]->name ? delta_objects[curr_object_number]->name
                                                                        : "Unnamed"));
                    ...
                    gl_error("Powerflow object:%d - %s - deltamode function returned an error!",
                             delta_objects[curr_object_number]->id,
                             (delta_objects[curr_object_number]->name ? delta_objects[curr_object_number]->name
                                                                      : "Unnamed"));
                    /*  TROUBLESHOOT
                ...
                {
                    gl_verbose("Powerflow object:%d - %s - requested exit to event-driven mode",
                               delta_objects[curr_object_number]->id,
                               (delta_objects[curr_object_number]->name ? delta_objects[curr_object_number]->name
                                                                        : "Unnamed"));
                }
        ...
        for (curr_object_number = 0; curr_object_number < pwr_object_count; curr_object_number++) {
            ...
            if (post_delta_functions[curr_object_number] != NULL) {
                ...
                if ((delta_objects[curr_object_number]->in_svc_double <= gl_globaldeltaclock) &&
                    ...
                    try {
                        //Call the actual function
                        function_status = ((STATUS (*)(OBJECT *)) (*post_delta_functions[curr_object_number]))(
...
EXPORT int check() {
    ...
    while (obj = gl_find_next(list, obj)) {
        if (gl_object_isa(obj, "node")) {
            ...
            if (from == NULL) {
                gl_error("link %s (%s:%d) from object is not specified", pLink->get_name(), pLink->oclass->name,
                         pLink->get_id());
                ++errcount;
            } else if (!gl_object_isa(from, "node")) {
                gl_error("link %s (%s:%d) from object is not a node", pLink->get_name(), pLink->oclass->name,
                         pLink->get_id());
                ++errcount;
            ...
            if (to == NULL) {
                gl_error("link %s (%s:%d) to object is not specified", pLink->get_name(), pLink->oclass->name,
                         pLink->get_id());
                ++errcount;
            } else if (!gl_object_isa(to, "node")) {
                gl_error("link %s (%s:%d) to object is not a node", pLink->get_name(), pLink->oclass->name,
                         pLink->get_id());
                ++errcount;

...
void register_object(MODULE *module)
{
  ...
  T *obj = new T(module);
  allocated_objects.push_back(
      std::make_pair(static_cast<gld_object *>(obj), typeid(T).name()));

  // std::cout << "Registered object of type: " << typeid(T).name() << ", at: "
  // << obj << std::endl;
}
...
EXPORT CLASS *init(CALLBACKS *fntable, MODULE *module, int argc, char *argv[])
{
  ...
  /* exported globals */
  gl_global_create("powerflow::show_matrix_values", PT_bool,
                   &show_matrix_values, nullptr);
  gl_global_create("powerflow::primary_voltage_ratio", PT_double,
                   &primary_voltage_ratio, nullptr);
  gl_global_create("powerflow::nominal_frequency", PT_double,
  ...
  gl_global_create("powerflow::ground_impedance", PT_complex, &ground_Z,
                   nullptr);
  gl_global_create("powerflow::warning_underfrequency", PT_double,
                   &warning_underfrequency, nullptr);
  gl_global_create("powerflow::warning_overfrequency", PT_double,
                   &warning_overfrequency, nullptr);
  gl_global_create("powerflow::warning_undervoltage", PT_double,
                   &warning_undervoltage, nullptr);
  gl_global_create("powerflow::warning_overvoltage", PT_double,
                   &warning_overvoltage, nullptr);
  gl_global_create("powerflow::warning_voltageangle", PT_double,
                   &warning_voltageangle, nullptr);
  gl_global_create("powerflow::maximum_voltage_error", PT_double,
                   &default_maximum_voltage_error, nullptr);
  gl_global_create("powerflow::solver_method", PT_enumeration, &solver_method,
                   PT_KEYWORD, "FBS", SM_FBS, PT_KEYWORD, "GS", SM_GS,
                   PT_KEYWORD, "NR", SM_NR, nullptr);
  gl_global_create(
      "powerflow::NR_solver_algorithm", PT_enumeration, &NR_solver_algorithm,
      PT_DESCRIPTION, "Underlying algorithm for NR powerflow - TCIM or FPI",
      PT_KEYWORD, "TCIM", NRM_TCIM, PT_KEYWORD, "FPI", NRM_FPI, nullptr);
  gl_global_create("powerflow::NR_matrix_file", PT_char256, &MDFileName,
                   nullptr);
  gl_global_create("powerflow::NR_matrix_output_interval", PT_enumeration,
                   &NRMatDumpMethod, PT_KEYWORD, "NEVER", MD_NONE, PT_KEYWORD,
                   "ONCE", MD_ONCE, PT_KEYWORD, "PER_CALL", MD_PERCALL,
                   PT_KEYWORD, "ALL", MD_ALL, PT_KEYWORD, "FINAL", MD_FINAL,
                   nullptr);
  gl_global_create("powerflow::NR_matrix_output_references", PT_bool,
                   &NRMatReferences, nullptr);
  gl_global_create("powerflow::NR_matrix_output_rhs", PT_bool, &NRMatRHSDump,
                   PT_DESCRIPTION,
                   "Flag to indicate if the RHS (delta-current-injections) "
                   "should be output to the matrix dump",
                   nullptr);
  gl_global_create(
      "powerflow::NR_island_failure_handled", PT_bool, &NR_island_fail_method,
      PT_DESCRIPTION,
      "Indicates if an island fails if it should be removed from service",
      nullptr);
  gl_global_create("powerflow::line_capacitance", PT_bool, &use_line_cap,
                   nullptr);
  gl_global_create("powerflow::line_limits", PT_bool, &use_link_limits,
                   nullptr);
  gl_global_create("powerflow::lu_solver", PT_char256, &LUSolverName, nullptr);
  gl_global_create("powerflow::NR_iteration_limit", PT_int64,
                   &NR_iteration_limit, nullptr);
  gl_global_create("powerflow::NR_deltamode_iteration_limit", PT_int64,
                   &NR_delta_iteration_limit, nullptr);
  gl_global_create("powerflow::NR_superLU_procs", PT_int32, &NR_superLU_procs,
                   nullptr);
  gl_global_create("powerflow::default_maximum_voltage_error", PT_double,
                   &default_maximum_voltage_error, nullptr);
  gl_global_create("powerflow::default_maximum_power_error", PT_double,
                   &default_maximum_power_error, nullptr);
  gl_global_create("powerflow::NR_admit_change", PT_bool, &NR_admit_change,
                   nullptr);
  gl_global_create("powerflow::enable_subsecond_models", PT_bool,
                   &enable_subsecond_models, PT_DESCRIPTION,
                   "Enable deltamode capabilities within the powerflow module",
                   nullptr);
  gl_global_create("powerflow::all_powerflow_delta", PT_bool,
                   &all_powerflow_delta, PT_DESCRIPTION,
                   "Forces all powerflow objects that are capable to "
                   "participate in deltamode",
                   nullptr);
  gl_global_create("powerflow::deltamode_timestep", PT_double,
                   &deltamode_timestep_publish, PT_UNITS, "ns", PT_DESCRIPTION,
                   "Desired minimum timestep for deltamode-related simulations",
                   nullptr);
  gl_global_create("powerflow::delta_initialize_iterations", PT_int32,
                   &delta_initialize_iterations, PT_DESCRIPTION,
                   "Extra iterations to perform on initial powerflow (when "
                   "deltamode enabled) to help with initialization",
                   nullptr);
  gl_global_create("powerflow::current_frequency", PT_double,
                   &current_frequency, PT_UNITS, "Hz", PT_DESCRIPTION,
                   "Current system-level frequency of the powerflow system",
                   nullptr);
  gl_global_create("powerflow::master_frequency_update", PT_bool,
                   &master_frequency_update, PT_DESCRIPTION,
                   "Tracking variable to see if an object has become the "
                   "system frequency updater",
                   nullptr);
  gl_global_create("powerflow::enable_frequency_dependence", PT_bool,
                   &enable_frequency_dependence, PT_DESCRIPTION,
                   "Flag to enable frequency-based variations in impedance "
                   "values of lines and loads",
                   nullptr);
  gl_global_create("powerflow::default_resistance", PT_double,
                   &default_resistance, nullptr);
  gl_global_create("powerflow::enable_inrush", PT_bool,
                   &enable_inrush_calculations, PT_DESCRIPTION,
                   "Flag to enable in-rush calculations for lines and "
                   "transformers in deltamode",
                   nullptr);
  gl_global_create(
      "powerflow::inrush_integration", PT_enumeration,
      &default_inrush_integration_method, PT_DESCRIPTION,
      "Determine the integration method utilized in in-rush calculations",
      PT_KEYWORD, "NONE", IRM_NONE, PT_KEYWORD, "TRAPEZOIDAL", IRM_TRAPEZOIDAL,
      PT_KEYWORD, "BACKWARD_EULER", IRM_BACKEULER, nullptr);
  gl_global_create("powerflow::all_frequency_measure_default", PT_enumeration,
                   &all_powerflow_freq_measure_method, PT_KEYWORD, "NONE",
                   FMM_NONE, PT_KEYWORD, "SIMPLE", FMM_SIMPLE, PT_KEYWORD,
                   "PLL", FMM_PLL, nullptr);
  gl_global_create("powerflow::low_voltage_impedance_level", PT_double,
                   &impedance_conversion_low_pu, PT_DESCRIPTION,
                   "Lower limit of voltage (in per-unit) at which all load "
                   "types are converted to impedance for in-rush calculations",
                   nullptr);
  gl_global_create("powerflow::enable_impedance_conversion", PT_bool,
                   &enable_impedance_conversion, PT_DESCRIPTION,
                   "Flag to enable conversion of loads to impedance-based when "
                   "voltage limit exceeded - non-in-rush capability",
                   nullptr);
  gl_global_create("powerflow::enable_mesh_fault_current", PT_bool,
                   &enable_mesh_fault_current, PT_DESCRIPTION,
                   "Flag to enable mesh-based fault current calculations",
                   nullptr);
  gl_global_create("powerflow::market_price_name", PT_char1024,
                   &market_price_name, PT_DESCRIPTION,
                   "Market current price published variable name", nullptr);
...
void schedule_deltamode_start(TIMESTAMP tstart)
{
  ...
  else
  {
    ...
    /*  TROUBLESHOOT
    The schedule_deltamode_start function was called by an object when
    powerflow's overall enabled_subsecond_models flag was not set.  The
    module-level flag indicates that no devices should use deltamode, but one
    made the call to a deltamode function.  Please check the DELTAMODE flag on
    all objects.  If deltamode is desired, please set the module-level
    enable_subsecond_models flag and try again.
    */
  }
}
                               ...
                               unsigned int64 dt)
{
  if (enable_subsecond_models)
  {
    if (deltamode_timestep_publish <= 0.0)
    {
      ...
      /*  TROUBLESHOOT
      The value for deltamode_timestep, as specified as the module level in
      powerflow, must be a positive, non-zero number. Please use such a number
      and try again.
      */
...
// Ideally, all deltamode objects coordinate through their module call, not
// their individual "update" call Returns SIMULATIONMODE - SM_DELTA,
                                  ...
                                  unsigned int iteration_count_val)
{
  ...
  if (enable_subsecond_models)
  {
    ...
    while (simple_iter_test <
           NR_delta_iteration_limit) // Simple iteration capability
    {
      ...
      if (bad_computation)
      {
        ...
        dynamic powerflow. This is an indication that the method will not solve
        the system and may have a singularity or other ill-favored condition in
        the system matrices.
        */
        error_state = true;
        break;
                                  ...
                                  // in dynamic mode for now
      {
        ...
        /*  TROUBLESHOOT
        Newton-Raphson failed to converge the dynamic powerflow in the number of
        iterations specified in NR_iteration_limit.  It will try again (if the
        global iteration limit has not been reached).
        */
        ...
        else if (function_status == SM_ERROR)
        {
          gl_error("Powerflow object:%d - %s - deltamode function returned an "
                   ...
                   (delta_objects[curr_object_number]->name
                        ...
                        : "Unnamed"));
          /*  TROUBLESHOOT
          While performing a deltamode update, one object returned an error
          code.  Check to see if the object itself provided more details and try
...
EXPORT STATUS postupdate(MODULE *module, TIMESTAMP t0, unsigned int64 dt)
{
  ...
  if (enable_subsecond_models)
  {
    ...
    // See how far we progressed - cast just in case (code pulled from core - so
    // should align)
    ...
    // Store the "pre-incremented" seconds advance time - used to set object
    // clocks so being the previous second is better for deltamode->supersecond
    // transitions
      ...
      if (post_delta_functions[curr_object_number] != nullptr)
      {
        ...
        if (function_status == FAILED)
        {
          gl_error("Powerflow object:%s - failed post-deltamode update",
                   delta_objects[curr_object_number]->name);
          /*  TROUBLESHOOT
          While calling the individual object post-deltamode calculations, an
          error occurred.  Please try again. If the error persists, please
          submit your code and a bug report via the issues system.
          */
          return FAILED;
        }
...
EXPORT int check()
{
  ...
  link_object **linklist = nullptr, **linkqueue = nullptr;
  ...
  while (obj = gl_find_next(list, obj))
  {
    ...
    else if (gl_object_isa(obj, "link"))
    {
      ...
      /*			if(tNode->get_phases(PHASE_A) ==
         fNode->get_phases(PHASE_A)){ gl_error("link:%i: to, from nodes have
         mismatched A phase (%i vs %i)", obj->id, tNode->get_phases(PHASE_A),
         fNode->get_phases(PHASE_A));
                                      ++errcount;
                              }
                              if(tNode->get_phases(PHASE_B) ==
         fNode->get_phases(PHASE_B)){ gl_error("link:%i: to, from nodes have
         mismatched B phase (%i vs %i)", obj->id, tNode->get_phases(PHASE_B),
         fNode->get_phases(PHASE_B));
                                      ++errcount;
                              }
                              if(tNode->get_phases(PHASE_C) ==
         fNode->get_phases(PHASE_C)){ gl_error("link:%i: to, from nodes have
         mismatched C phase (%i vs %i)", obj->id, tNode->get_phases(PHASE_C),
         fNode->get_phases(PHASE_C));
                                      ++errcount;
                              }
                              if(tNode->get_phases(PHASE_D) ==
         fNode->get_phases(PHASE_D)){ gl_error("link:%i: to, from nodes have
         mismatched D phase (%i vs %i)", obj->id, tNode->get_phases(PHASE_D),
         fNode->get_phases(PHASE_D));
                                      ++errcount;
                              }
                              if(tNode->get_phases(PHASE_N) ==
         fNode->get_phases(PHASE_N)){ gl_error("link:%i: to, from nodes have
         mismatched N phase (%i vs %i)", obj->id, tNode->get_phases(PHASE_N),
         fNode->get_phases(PHASE_N));
                                      ++errcount;
                              }*/
    }
  }
  ...
  // return 0;
  return 1; // Nothing really checked in here, so just let it pass.  Not sure

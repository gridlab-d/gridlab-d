...
node::node(MODULE *mod) : powerflow_object(mod)
{
    if (oclass == nullptr)
    {
        ...
        if (gl_publish_variable(oclass,
                                ...
                                PT_complex, "last_voltage_A", PADDR(last_voltage[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous voltage value for phase A",
                                PT_complex, "last_voltage_B", PADDR(last_voltage[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous voltage value for phase B",
                                PT_complex, "last_voltage_C", PADDR(last_voltage[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous voltage value for phase C",
                                PT_complex, "last_child_power_power_A", PADDR(last_child_power[0][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for power of phase A",
                                PT_complex, "last_child_power_power_B", PADDR(last_child_power[0][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for power of phase B",
                                PT_complex, "last_child_power_power_C", PADDR(last_child_power[0][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for power of phase C",
                                PT_complex, "last_child_power_shunt_A", PADDR(last_child_power[1][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for shunt of phase A",
                                PT_complex, "last_child_power_shunt_B", PADDR(last_child_power[1][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for shunt of phase B",
                                PT_complex, "last_child_power_shunt_C", PADDR(last_child_power[1][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for shunt of phase C",
                                PT_complex, "last_child_power_current_A", PADDR(last_child_power[2][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for current of phase A",
                                PT_complex, "last_child_power_current_B", PADDR(last_child_power[2][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for current of phase B",
                                PT_complex, "last_child_power_current_C", PADDR(last_child_power[2][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for current of phase C",
                                PT_complex, "last_child_power_pre_rotate_current_A", PADDR(last_child_power[3][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for pre-rotated current of phase A",
                                PT_complex, "last_child_power_pre_rotate_current_B", PADDR(last_child_power[3][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for pre-rotated current of phase B",
                                PT_complex, "last_child_power_pre_rotate_current_C", PADDR(last_child_power[3][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous load value for pre-rotated current of phase C",
                                PT_complex, "last_child_power_power_dy_AB", PADDR(last_child_power_dy[0][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for power of phase AB",
                                PT_complex, "last_child_power_power_dy_BC", PADDR(last_child_power_dy[0][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value for delta-wye for power of phase BC",
                                PT_complex, "last_child_power_power_dy_CA", PADDR(last_child_power_dy[0][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for power of phase CA",
                                PT_complex, "last_child_power_power_dy_AN", PADDR(last_child_power_dy[0][3]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for power of phase AN",
                                PT_complex, "last_child_power_power_dy_BN", PADDR(last_child_power_dy[0][4]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value for delta-wye for power of phase BN",
                                PT_complex, "last_child_power_power_dy_CN", PADDR(last_child_power_dy[0][5]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for power of phase CN",
                                PT_complex, "last_child_power_shunt_dy_AB", PADDR(last_child_power_dy[1][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for shunt of phase AB",
                                PT_complex, "last_child_power_shunt_dy_BC", PADDR(last_child_power_dy[1][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for shunt of phase BC",
                                PT_complex, "last_child_power_shunt_dy_CA", PADDR(last_child_power_dy[1][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for shunt of phase CA",
                                PT_complex, "last_child_power_shunt_dy_AN", PADDR(last_child_power_dy[1][3]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for shunt of phase AN",
                                PT_complex, "last_child_power_shunt_dy_BN", PADDR(last_child_power_dy[1][4]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for shunt of phase BN",
                                PT_complex, "last_child_power_shunt_dy_CN", PADDR(last_child_power_dy[1][5]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for shunt of phase CN",
                                PT_complex, "last_child_power_current_dy_AB", PADDR(last_child_power_dy[2][0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for current of phase AB",
                                PT_complex, "last_child_power_current_dy_BC", PADDR(last_child_power_dy[2][1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for current of phase BC",
                                PT_complex, "last_child_power_current_dy_CA", PADDR(last_child_power_dy[2][2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for current of phase CA",
                                PT_complex, "last_child_power_current_dy_AN", PADDR(last_child_power_dy[2][3]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for current of phase AN",
                                PT_complex, "last_child_power_current_dy_BN", PADDR(last_child_power_dy[2][4]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for current of phase BN",
                                PT_complex, "last_child_power_current_dy_CN", PADDR(last_child_power_dy[2][5]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for current of phase CN",
                                PT_complex, "last_child_current12", PADDR(last_child_current12), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: Previous child load value delta-wye for current of phase 12",
                                PT_complex, "shunt_change_check_A", PADDR(shunt_change_check[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase A",
                                PT_complex, "shunt_change_check_B", PADDR(shunt_change_check[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase B",
                                PT_complex, "shunt_change_check_C", PADDR(shunt_change_check[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase C",
                                PT_complex, "shunt_change_check_AB", PADDR(shunt_change_check_dy[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase AB",
                                PT_complex, "shunt_change_check_BC", PADDR(shunt_change_check_dy[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase BC",
                                PT_complex, "shunt_change_check_CA", PADDR(shunt_change_check_dy[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase CA",
                                PT_complex, "shunt_change_check_AN", PADDR(shunt_change_check_dy[3]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase AN",
                                PT_complex, "shunt_change_check_BN", PADDR(shunt_change_check_dy[4]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase BN",
                                PT_complex, "shunt_change_check_CN", PADDR(shunt_change_check_dy[5]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: shunt tracking variable for phase CN",
                                PT_bool, "first_freq_init", PADDR(first_freq_init), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: GFA frequnecy tracking variable",
                                PT_double, "freq_violation_time_total", PADDR(freq_violation_time_total), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: GFA frequency violation time tracking variable",
                                PT_double, "volt_violation_time_total", PADDR(volt_violation_time_total), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: GFA voltage violation time tracking variable",
                                PT_double, "out_of_violation_time_total", PADDR(out_of_violation_time_total), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: GFA no violation time tracking variable",
                                PT_timestamp, "last_disconnect", PADDR(last_disconnect), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: timestamp of last disconnect",
                                PT_complex, "current12", PADDR(current12), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: triplex phase 12 current",
...
#define STYLE(X)                                                                                                                                                                 \
    stream("<Style id=\"" #X "_g\"><IconStyle><Icon><href>http://%s:%u/rt/" #X "_g.png</href></Icon></IconStyle></Style>\n", (const char *)host.get_string(), port.get_int32()); \
        ...
        else if (has_phase(PHASE_S)) // Split phase node
        {
            ...
            else
            {
                ...
                temp_current_inj[2] = ((voltage1.IsZero() || (power1.IsZero() && shunt1.IsZero())) ||
                                       (voltage2.IsZero() || (power2.IsZero() && shunt2.IsZero())))
                                          ? currentN
                                          : -((temp_current_inj[0] - temp_current[2]) + (temp_current_inj[1] - temp_current[2]));
            }
        }
        else // Wye connection
        {

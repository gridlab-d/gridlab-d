...
node::node(MODULE *mod) : powerflow_object(mod) {
    if (oclass == NULL) {
        ...
        oclass = gl_register_class(mod, const_cast<char *>("node"), sizeof(node),
        ...
        if (gl_publish_variable(oclass,
                                ...
                                PT_enumeration, "bustype", PADDR(bustype), PT_DESCRIPTION,
                                ...
                                PT_set, "busflags", PADDR(busflags), PT_DESCRIPTION,
                                ...
                                PT_object, "reference_bus", PADDR(reference_bus), PT_DESCRIPTION,
                                "reference bus from which frequency is defined",
                                PT_double, "maximum_voltage_error[V]", PADDR(maximum_voltage_error), PT_DESCRIPTION,
                                ...
                                PT_complex, "voltage_B[V]", PADDR(voltage[1]), PT_DESCRIPTION,
                                "bus voltage, Phase B to ground",
                                PT_complex, "voltage_C[V]", PADDR(voltage[2]), PT_DESCRIPTION,
                                "bus voltage, Phase C to ground",
                                PT_complex, "voltage_AB[V]", PADDR(voltaged[0]), PT_DESCRIPTION,
                                "line voltages, Phase AB",
                                PT_complex, "voltage_BC[V]", PADDR(voltaged[1]), PT_DESCRIPTION,
                                "line voltages, Phase BC",
                                PT_complex, "voltage_CA[V]", PADDR(voltaged[2]), PT_DESCRIPTION,
                                "line voltages, Phase CA",
                                PT_complex, "current_A[A]", PADDR(current[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus current injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "current_B[A]", PADDR(current[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus current injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "current_C[A]", PADDR(current[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus current injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "power_A[VA]", PADDR(power[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus power injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "power_B[VA]", PADDR(power[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus power injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "power_C[VA]", PADDR(power[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus power injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "shunt_A[S]", PADDR(shunt[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus shunt admittance, this an accumulator only, not a output or input variable",
                                PT_complex, "shunt_B[S]", PADDR(shunt[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus shunt admittance, this an accumulator only, not a output or input variable",
                                PT_complex, "shunt_C[S]", PADDR(shunt[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus shunt admittance, this an accumulator only, not a output or input variable",

                                PT_complex, "prerotated_current_A[A]", PADDR(pre_rotated_current[0]), PT_ACCESS,
                                ...
                                PT_complex, "prerotated_current_B[A]", PADDR(pre_rotated_current[1]), PT_ACCESS,
                                PA_HIDDEN, PT_DESCRIPTION,
                                "deltamode-functionality - bus current injection (in = positive), but will not be rotated by powerflow for off-nominal frequency, this an accumulator only, not a output or input variable",
                                PT_complex, "prerotated_current_C[A]", PADDR(pre_rotated_current[2]), PT_ACCESS,
                                PA_HIDDEN, PT_DESCRIPTION,
                                "deltamode-functionality - bus current injection (in = positive), but will not be rotated by powerflow for off-nominal frequency, this an accumulator only, not a output or input variable",

                                PT_complex, "deltamode_generator_current_A[A]", PADDR(deltamode_dynamic_current[0]),
                                PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "deltamode-functionality - bus current injection (in = positive), direct generator injection (so may be overwritten internally), this an accumulator only, not a output or input variable",
                                PT_complex, "deltamode_generator_current_B[A]", PADDR(deltamode_dynamic_current[1]),
                                PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "deltamode-functionality - bus current injection (in = positive), direct generator injection (so may be overwritten internally), this an accumulator only, not a output or input variable",
                                PT_complex, "deltamode_generator_current_C[A]", PADDR(deltamode_dynamic_current[2]),
                                PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "deltamode-functionality - bus current injection (in = positive), direct generator injection (so may be overwritten internally), this an accumulator only, not a output or input variable",

                                PT_complex, "deltamode_PGenTotal", PADDR(deltamode_PGenTotal), PT_ACCESS, PA_HIDDEN,
                                PT_DESCRIPTION,
                                "deltamode-functionality - power value for a diesel generator -- accumulator only, not an output or input",

                                PT_complex_array, "deltamode_full_Y_matrix", PADDR(full_Y_matrix), PT_ACCESS, PA_HIDDEN,
                                PT_DESCRIPTION,
                                "deltamode-functionality full_Y matrix exposes so generator objects can interact for Norton equivalents",
                                PT_complex_array, "deltamode_full_Y_all_matrix", PADDR(full_Y_all_matrix), PT_ACCESS,
                                PA_HIDDEN, PT_DESCRIPTION,
                                "deltamode-functionality full_Y_all matrix exposes so generator objects can interact for Norton equivalents",

                                PT_complex, "current_inj_A[A]", PADDR(current_inj[0]), PT_ACCESS, PA_HIDDEN,
                                PT_DESCRIPTION,
                                "bus current injection (in = positive), but will not be rotated by powerflow for off-nominal frequency, this an accumulator only, not a output or input variable",
                                PT_complex, "current_inj_B[A]", PADDR(current_inj[1]), PT_ACCESS, PA_HIDDEN,
                                PT_DESCRIPTION,
                                "bus current injection (in = positive), but will not be rotated by powerflow for off-nominal frequency, this an accumulator only, not a output or input variable",
                                PT_complex, "current_inj_C[A]", PADDR(current_inj[2]), PT_ACCESS, PA_HIDDEN,
                                PT_DESCRIPTION,
                                "bus current injection (in = positive), but will not be rotated by powerflow for off-nominal frequency, this an accumulator only, not a output or input variable",

                                PT_complex, "current_AB[A]", PADDR(current_dy[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus current delta-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "current_BC[A]", PADDR(current_dy[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus current delta-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "current_CA[A]", PADDR(current_dy[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus current delta-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "current_AN[A]", PADDR(current_dy[3]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus current wye-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "current_BN[A]", PADDR(current_dy[4]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus current wye-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "current_CN[A]", PADDR(current_dy[5]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus current wye-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "power_AB[VA]", PADDR(power_dy[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus power delta-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "power_BC[VA]", PADDR(power_dy[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus power delta-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "power_CA[VA]", PADDR(power_dy[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus power delta-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "power_AN[VA]", PADDR(power_dy[3]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus power wye-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "power_BN[VA]", PADDR(power_dy[4]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus power wye-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "power_CN[VA]", PADDR(power_dy[5]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus power wye-connected injection (in = positive), this an accumulator only, not a output or input variable",
                                PT_complex, "shunt_AB[S]", PADDR(power_dy[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus shunt delta-connected admittance, this an accumulator only, not a output or input variable",
                                PT_complex, "shunt_BC[S]", PADDR(power_dy[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus shunt delta-connected admittance, this an accumulator only, not a output or input variable",
                                PT_complex, "shunt_CA[S]", PADDR(power_dy[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus shunt delta-connected admittance, this an accumulator only, not a output or input variable",
                                PT_complex, "shunt_AN[S]", PADDR(power_dy[3]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus shunt wye-connected admittance, this an accumulator only, not a output or input variable",
                                PT_complex, "shunt_BN[S]", PADDR(power_dy[4]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus shunt wye-connected admittance, this an accumulator only, not a output or input variable",
                                PT_complex, "shunt_CN[S]", PADDR(power_dy[5]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION,
                                "bus shunt wye-connected admittance, this an accumulator only, not a output or input variable",

                                PT_double, "mean_repair_time[s]", PADDR(mean_repair_time), PT_DESCRIPTION,
                                "Time after a fault clears for the object to be back in service",

                //Properties for frequency measurement
                                PT_enumeration, "frequency_measure_type", PADDR(fmeas_type), PT_DESCRIPTION,
                                "Frequency measurement dynamics-capable implementation",
                                PT_KEYWORD, "NONE", (enumeration) FM_NONE, PT_DESCRIPTION, "No frequency measurement",
                                PT_KEYWORD, "SIMPLE", (enumeration) FM_SIMPLE, PT_DESCRIPTION,
                                ...
                                PT_double, "pll_Ki[pu]", PADDR(freq_pll_Ki), PT_DESCRIPTION,
                                "Integration gain of PLL frequency measurement",

                //Frequency measurement output variables
                                PT_double, "measured_angle_A[rad]", PADDR(curr_freq_state.anglemeas[0]), PT_DESCRIPTION,
                                "bus angle measurement, phase A",
                                PT_double, "measured_frequency_A[Hz]", PADDR(curr_freq_state.fmeas[0]), PT_DESCRIPTION,
                                "frequency measurement, phase A",
                                PT_double, "measured_angle_B[rad]", PADDR(curr_freq_state.anglemeas[1]), PT_DESCRIPTION,
                                "bus angle measurement, phase B",
                                PT_double, "measured_frequency_B[Hz]", PADDR(curr_freq_state.fmeas[1]), PT_DESCRIPTION,
                                "frequency measurement, phase B",
                                PT_double, "measured_angle_C[rad]", PADDR(curr_freq_state.anglemeas[2]), PT_DESCRIPTION,
                                "bus angle measurement, phase C",
                                PT_double, "measured_frequency_C[Hz]", PADDR(curr_freq_state.fmeas[2]), PT_DESCRIPTION,
                                "frequency measurement, phase C",
                                PT_double, "measured_frequency[Hz]", PADDR(curr_freq_state.average_freq),
                                PT_DESCRIPTION, "frequency measurement - average of present phases",

                                PT_enumeration, "service_status", PADDR(service_status), PT_DESCRIPTION,
                                ...
                                PT_double, "service_status_double", PADDR(service_status_dbl), PT_DESCRIPTION,
                                "In and out of service flag - type double - will indiscriminately override service_status - useful for schedules",
                                PT_double, "previous_uptime[min]", PADDR(previous_uptime), PT_DESCRIPTION,
                                "Previous time between disconnects of node in minutes",
                                PT_double, "current_uptime[min]", PADDR(current_uptime), PT_DESCRIPTION,
                                "Current time since last disconnect of node in minutes",
                                PT_bool, "Norton_dynamic", PADDR(dynamic_norton), PT_DESCRIPTION,
                                "Flag to indicate a Norton-equivalent connection -- used for generators and deltamode",
                                PT_bool, "generator_dynamic", PADDR(dynamic_generator), PT_DESCRIPTION,
                                "Flag to indicate a voltage-sourcing or swing-type generator is present -- used for generators and deltamode",

                                PT_bool, "reset_disabled_island_state", PADDR(reset_island_state), PT_ACCESS, PA_HIDDEN,
                                PT_DESCRIPTION,
                                "Deltamode/multi-island flag -- used to reset disabled status (and reform an island)",

                //GFA - stuff
                                PT_bool, "GFA_enable", PADDR(GFA_enable), PT_DESCRIPTION,
                                "Disable/Enable Grid Friendly Appliance(TM)-type functionality",
                                PT_double, "GFA_freq_low_trip[Hz]", PADDR(GFA_freq_low_trip), PT_DESCRIPTION,
                                "Low frequency trip point for Grid Friendly Appliance(TM)-type functionality",
                                PT_double, "GFA_freq_high_trip[Hz]", PADDR(GFA_freq_high_trip), PT_DESCRIPTION,
                                "High frequency trip point for Grid Friendly Appliance(TM)-type functionality",
                                PT_double, "GFA_volt_low_trip[pu]", PADDR(GFA_voltage_low_trip), PT_DESCRIPTION,
                                "Low voltage trip point for Grid Friendly Appliance(TM)-type functionality",
                                PT_double, "GFA_volt_high_trip[pu]", PADDR(GFA_voltage_high_trip), PT_DESCRIPTION,
                                "High voltage trip point for Grid Friendly Appliance(TM)-type functionality",
                                PT_double, "GFA_reconnect_time[s]", PADDR(GFA_reconnect_time), PT_DESCRIPTION,
                                ...
                                PT_enumeration, "GFA_trip_method", PADDR(GFA_trip_method), PT_DESCRIPTION,
                                "Reason for GFA trip - what caused the GFA to activate",
                                ...
                                "GFA trip for under-frequency",
                                PT_KEYWORD, "OVER_FREQUENCY", (enumeration) GFA_OF, PT_DESCRIPTION,
                                "GFA trip for over-frequency",
                                PT_KEYWORD, "UNDER_VOLTAGE", (enumeration) GFA_UV, PT_DESCRIPTION,
                                "GFA trip for under-voltage",
                                PT_KEYWORD, "OVER_VOLTAGE", (enumeration) GFA_OV, PT_DESCRIPTION,
                                "GFA trip for over-voltage",

                                PT_object, "topological_parent", PADDR(TopologicalParent), PT_DESCRIPTION,
                                "topological parent as per GLM configuration",
                                NULL) < 1)
            GL_THROW(const_cast<char *>("unable to publish properties in %s"), __FILE__);

        if (gl_publish_function(oclass, const_cast<char *>("interupdate_pwr_object"),
                                (FUNCTIONADDR) interupdate_node) == nullptr)
            GL_THROW(const_cast<char *>("Unable to publish node deltamode function"));
        if (gl_publish_function(oclass, const_cast<char *>("pwr_object_swing_swapper"),
                                (FUNCTIONADDR) swap_node_swing_status) == nullptr)
            GL_THROW(const_cast<char *>("Unable to publish node swing-swapping function"));
        if (gl_publish_function(oclass, const_cast<char *>("pwr_current_injection_update_map"),
                                (FUNCTIONADDR) node_map_current_update_function) == nullptr)
            GL_THROW(const_cast<char *>("Unable to publish node current injection update mapping function"));
        if (gl_publish_function(oclass, const_cast<char *>("attach_vfd_to_pwr_object"),
                                (FUNCTIONADDR) attach_vfd_to_node) == nullptr)
            GL_THROW(const_cast<char *>("Unable to publish node VFD attachment function"));
        if (gl_publish_function(oclass, const_cast<char *>("pwr_object_reset_disabled_status"),
                                (FUNCTIONADDR) node_reset_disabled_status) == nullptr)
...
int node::init(OBJECT *parent) {
    ...
    if (has_phase(PHASE_S)) {
        ...
        if (!(gl_object_isa(obj, const_cast<char *>("triplex_node"), const_cast<char *>("powerflow")) ||
              gl_object_isa(obj, const_cast<char *>("triplex_meter"), const_cast<char *>("powerflow")) ||
              gl_object_isa(obj, const_cast<char *>("triplex_load"), const_cast<char *>("powerflow")) ||
              gl_object_isa(obj, const_cast<char *>("motor"), const_cast<char *>("powerflow")))) {
            GL_THROW(const_cast<char *>("Object:%d - %s -- has a phase S, but is not triplex!"), obj->id,
    ...
    if (solver_method == SM_NR) {
        ...
        {                        //(this will break anything intentionally done this way - e.g. switch between two nodes)
            ...
            if (!(gl_object_isa(obj->parent, const_cast<char *>("load"), const_cast<char *>("powerflow")) |
                  gl_object_isa(obj->parent, const_cast<char *>("node"), const_cast<char *>("powerflow")) |
                  gl_object_isa(obj->parent, const_cast<char *>("meter"), const_cast<char *>("powerflow")) |
                  gl_object_isa(obj->parent, const_cast<char *>("substation"), const_cast<char *>("powerflow"))))
            ...
            if ((parNode->phases != phases) && (p_phase_to_check != c_phase_to_check)) {
                ...
                {
                    GL_THROW(const_cast<char *>("NR: Parent and child node phases for nodes %s and %s do not match!"),
                ...
                {    //Essentially a replication of the no-phase section with more check
                    if ((parNode->SubNode == CHILD) | (parNode->SubNode == DIFF_CHILD) |
                        ((obj->parent->parent != NR_swing_bus) &&
                         (obj->parent->parent != NULL)))    //Our parent is another child
                    {
                    ...
                    } else    //Our parent is unchilded (or has the swing bus as a parent)
                    {
                        ...
                        if (((phases & PHASE_D) == PHASE_D) || ((parNode->phases & PHASE_D) == PHASE_D)) {
                            ...
                            {
                                parNode->Extra_Data = (gld::complex *) gl_malloc(9 * sizeof(gld::complex));
                                if (parNode->Extra_Data == NULL) {
                                    GL_THROW(
                                            const_cast<char *>("NR: Memory allocation failure for differently connected load."));
                                    /*  TROUBLESHOOT
                        ...
                        } else    //None are delta, so handle partial phasing a little better
                        {
                            ...
                            last_child_power_dy[0][0] = last_child_power_dy[0][1] = last_child_power_dy[0][2] = gld::complex(
                                    0.0, 0.0);
                            last_child_power_dy[1][0] = last_child_power_dy[1][1] = last_child_power_dy[1][2] = gld::complex(
                                    0.0, 0.0);
                            last_child_power_dy[2][0] = last_child_power_dy[2][1] = last_child_power_dy[2][2] = gld::complex(
                                    0.0, 0.0);
                            last_child_power_dy[3][0] = last_child_power_dy[3][1] = last_child_power_dy[3][2] = gld::complex(
                                    0.0, 0.0);
                            last_child_power_dy[4][0] = last_child_power_dy[4][1] = last_child_power_dy[4][2] = gld::complex(
                                    0.0, 0.0);
                            last_child_power_dy[5][0] = last_child_power_dy[5][1] = last_child_power_dy[5][2] = gld::complex(
                                    0.0, 0.0);
                        }
                    }
            ...
            if (nominal_voltage != parNode->nominal_voltage) {
                gl_warning(
                        "Node:%s does not have the same nominal voltage as its parent - copying voltage from parent.",
                        (obj->name ? obj->name : "unnamed"));
                /*  TROUBLESHOOT
            ...
            } else    //Something is there, see if we can find it
            {
                ...
                if (gl_findfile(ext_lib_file_name, NULL, 0 | 4, extpath, sizeof(extpath)) != NULL)    //Link up
                {
                    ...
                    if (LUSolverFcns.dllLink == NULL) {
                        gl_warning("Failure to load solver_%s as a library, defaulting to superLU",
                    ...
                    } else    //Found it right
                    {
                        ...
                        if (LUSolverFcns.ext_init == NULL) {
                            gl_warning("LU_init of external solver solver_%s not found, defaulting to superLU",
                                       LUSolverName.get_string());
                            /*  TROUBLESHOOT
                        ...
                        if (LUSolverFcns.ext_alloc == NULL) {
                            gl_warning("LU_alloc of external solver solver_%s not found, defaulting to superLU",
                                       LUSolverName.get_string());
                            /*  TROUBLESHOOT
							While attempting to link the LU_init routine of an external LU matrix solver library, the routine
							failed to be found.  Check the external library and try again.  At this failure, powerflow will revert
                        ...
                        if (LUSolverFcns.ext_solve == NULL) {
                            gl_warning("LU_solve of external solver solver_%s not found, defaulting to superLU",
                                       LUSolverName.get_string());
                            /*  TROUBLESHOOT
							While attempting to link the LU_init routine of an external LU matrix solver library, the routine
							failed to be found.  Check the external library and try again.  At this failure, powerflow will revert
                        ...
                        if (LUSolverFcns.ext_destroy == NULL) {
                            gl_warning("LU_destroy of external solver solver_%s not found, defaulting to superLU",
                                       LUSolverName.get_string());
                            /*  TROUBLESHOOT
							While attempting to link the LU_init routine of an external LU matrix solver library, the routine
							failed to be found.  Check the external library and try again.  At this failure, powerflow will revert
                ...
                {
                    gl_warning("The external solver solver_%s could not be found, defaulting to superLU",
                               LUSolverName.get_string());
                    /*  TROUBLESHOOT
    ...
    } else if (solver_method == SM_FBS)    //Forward back sweep
    {
        ...
        if (obj->parent != NULL) {
            if ((gl_object_isa(obj->parent, const_cast<char *>("load"), const_cast<char *>("powerflow")) |
                 gl_object_isa(obj->parent, const_cast<char *>("node"), const_cast<char *>("powerflow")) |
                 gl_object_isa(obj->parent, const_cast<char *>("meter"), const_cast<char *>("powerflow")) |
                 gl_object_isa(obj->parent, const_cast<char *>("substation"),
                               const_cast<char *>("powerflow"))))    //Parent is another node
            {
                node *parNode = OBJECTDATA(obj->parent, node);
                ...
                if ((p_phase_to_check & c_phase_to_check) != c_phase_to_check)    //Our parent is lacking, fail
                {
                    GL_THROW(const_cast<char *>("Parent and child node phases are incompatible for nodes %s and %s."),
                             obj->parent->name, obj->name);
                    /*  TROUBLESHOOT
    ...
    if (nominal_voltage == 0 && parent) {
        ...
        if (gl_object_isa(parent, const_cast<char *>("transformer"))) {
            ...
            if (transformer_config == NULL) {
                GL_THROW(const_cast<char *>("Error mapping secondary voltage property from transformer:%d %s"),
    ...
    if (has_phase(PHASE_D) & voltageAB == 0) {    // compute 3phase voltage differences
    ...
    if ((obj->flags & OF_DELTAMODE) == OF_DELTAMODE) {
        ...
        if (TopologicalParent != NULL) {
            if ((TopologicalParent->flags & OF_DELTAMODE) != OF_DELTAMODE) {
                gl_warning(
                        "Object %s (node:%d) is flagged for deltamode, but it's parent is not.  This may lead to incorrect answers!",
...
TIMESTAMP node::presync(TIMESTAMP t0) {
    ...
    if (prev_NTime != t0) {
        ...
        } else //Must be out of service
        {
            if (last_disconnect != prev_NTime)    //Just disconnected
            {
                temp_time_value = t0 - last_disconnect;
                previous_uptime =
                        ((double) (temp_time_value)) / 60.0;    //Put into minutes - automatically shift into prev
            }
    ...
    if (prev_NTime == 0)    //Should only be the very first run
    {
        ...
        if (((phase_to_check & busphasesIn) != phase_to_check) && (busphasesIn != 0) &&
        ...
        if (enable_subsecond_models == true) {
            if (solver_method != SM_NR) {
                GL_THROW(
                        const_cast<char *>("deltamode simulations only support powerflow in Newton-Raphson (NR) mode at this time"));
                /*  TROUBLESHOOT
    ...
    if (solver_method == SM_NR) {
        if (prev_NTime == 0)    //First run, if we are a child, make sure no one linked us before we knew that
        {
            ...
            if (((SubNode == CHILD) || (SubNode == DIFF_CHILD)) && (NR_connected_links[0] > 0)) {
                GL_THROW("NR: node:%d - %s - extra links acquired outside of init routine", obj->id,
                         (obj->name ? obj->name : "Unnamed"));
                /*  TROUBLESHOOT
        ...
        if (NR_busdata == NULL ||
            NR_branchdata == NULL)    //First time any NR in (this should be the swing bus doing this)
        {
            ...
            if (enable_subsecond_models == true)    //If enabled in powerflow, swing bus rules them all
            {
                ...
                if ((pwr_object_current == -1) || (delta_objects == NULL)) {
                    ...
                    if (delta_objects == NULL) {
                        GL_THROW(
                                const_cast<char *>("Failed to allocate deltamode objects array for powerflow module!"));
                        /*  TROUBLESHOOT
                    ...
                    if (delta_functions == NULL) {
                        GL_THROW(
                                const_cast<char *>("Failed to allocate deltamode objects function array for powerflow module!"));
                        /*  TROUBLESHOOT
						While attempting to create a reference array for powerflow module deltamode-enabled
						objects, an error was encountered.  Please try again.  If the error persists, please
						submit your code and a bug report via the trac website.
        ...
        if ((deltamode_inclusive == true) && (enable_subsecond_models == true) && (prev_NTime == 0)) {
            ...
            if (pwr_object_current >= pwr_object_count) {
                GL_THROW(
                        const_cast<char *>("Too many objects tried to populate deltamode objects array in the powerflow module!"));
                /*  TROUBLESHOOT
            ...
            post_delta_functions[temp_pwr_object_current] = (FUNCTIONADDR) (gl_get_function(obj,
                                                                                            "postupdate_pwr_object"));
            ...
            if (((SubNode == CHILD) || (SubNode == DIFF_CHILD)) &&
                ((dynamic_norton == true) || (dynamic_generator == true))) {
                //Map our parent
                ...
                if (dynamic_norton == true) {
                    ...
                    if (full_Y_matrix.is_valid(0, 0) == true) {
                        ...
                        if ((full_Y_matrix.get_rows() == 3) && (full_Y_matrix.get_cols() == 3)) {
                            ...
                            if (full_Y == NULL) {
                                GL_THROW(
                                        const_cast<char *>("Node:%s failed to allocate space for the a deltamode variable"),
                                        (obj->name ? obj->name : "Unnamed"));
                                /*  TROUBLESHOOT
                            ...
                            temp_complex_property = new gld_property(SubNodeParent,
                                                                     const_cast<char *>("deltamode_full_Y_matrix"));

                            //Check it
                            if ((temp_complex_property->is_valid() != true) ||
                                (temp_complex_property->is_complex_array() != true)) {
                                GL_THROW(
                                        const_cast<char *>("Node:%d - %s - parent deltamode matrix property is not valid!"),
                            ...
                            } else    //Already populated, make sure it is the right size!
                            {
                                if ((temp_complex_array.get_rows() != 3) && (temp_complex_array.get_cols() != 3)) {
                                    GL_THROW(
                                            const_cast<char *>("node:%s exposed Norton-equivalent matrix is the wrong size!"),
                                            obj->name ? obj->name : "unnamed");
                                    /*  TROUBLESHOOT
                            ...
                            GL_THROW(const_cast<char *>("Node:%d - %s - Invalid deltamode matrix size!"), obj->id,
                                     (obj->name ? obj->name : "Unnamed"));
                            /*  TROUBLESHOOT
                    ...
                    if (full_Y_all_matrix.is_valid(0, 0) == true) {
                        ...
                        if ((full_Y_all_matrix.get_rows() != 3) && (full_Y_all_matrix.get_cols() != 3)) {
                            GL_THROW(const_cast<char *>("node:%s exposed Norton-equivalent matrix is the wrong size!"),
                                     obj->name ? obj->name : "unnamed");
                            //Defined above
                        }
                    ...
                    for (temp_idx_x = 0; temp_idx_x < 3; temp_idx_x++) {
                        for (temp_idx_y = 0; temp_idx_y < 3; temp_idx_y++) {
                            full_Y_all_matrix.set_at(temp_idx_x, temp_idx_y, gld::complex(0.0, 0.0));
                        }
                    }
...
void node::NR_node_sync_fxn(OBJECT *obj) {
    ...
    if (NR_node_reference != -1) {
        ...
        if (SubNode == CHILD) {
            ...
            if (gl_object_isa(SubNodeParent, const_cast<char *>("load"),
                              const_cast<char *>("powerflow")))    //Load gets cleared at every presync, so reaggregate :(
            {
                ...
                //All done, unlock
                UNLOCK_OBJECT(SubNodeParent);
            } else if (gl_object_isa(SubNodeParent, const_cast<char *>("node"),
                                     const_cast<char *>("powerflow")))    //"parented" node - update values - This has to go to the bottom
        ...
        if (VFD_attached == true) {
            ...
            if (fxn_ret_value == FAILED) {
                GL_THROW(const_cast<char *>("node:%d - %s -- Failed VFD updating function"), obj->id,
                         (obj->name ? obj->name : "Unnamed"));
                /*  TROUBLESHOOT
        ...
        case SM_FBS: {
            if (phases & PHASE_S) {    // Split phase
                ...
                if (house_present) {
                    ...
                    temp_curr_val[0] = nom_res_curr[0] /
                                       (~adjusted_curr[0]);        //Just denominator conjugated to keep math right (rest was conjugated in house)
			...
			{
#endif
                gld::complex d1 = (voltage1.IsZero() || (power1.IsZero() && shunt1.IsZero())) ? (current1 + temp_curr_val[0])
                                                                                         : (current1 +
                                                                                            ~(power1 / voltage1) +
                                                                                            voltage1 * shunt1 +
                                                                                            temp_curr_val[0]);
                gld::complex d2 = ((voltage1 + voltage2).IsZero() || (power12.IsZero() && shunt12.IsZero())) ? (current12 +
                                                                                                           temp_curr_val[2])
                                                                                                        : (current12 +
                                                                                                           ~(power12 /
                                                                                                             (voltage1 +
			...
			{
#endif
                d1 = (voltage2.IsZero() || (power2.IsZero() && shunt2.IsZero())) ? (-current2 - temp_curr_val[1]) : (
                        -current2 - ~(power2 / voltage2) - voltage2 * shunt2 - temp_curr_val[1]);
                d2 = ((voltage1 + voltage2).IsZero() || (power12.IsZero() && shunt12.IsZero())) ? (-current12 -
                                                                                                   temp_curr_val[2]) : (
                             -current12 - ~(power12 / (voltage1 + voltage2)) - (voltage1 + voltage2) * shunt12 -
                             temp_curr_val[2]);
			...
			else
			{
                ...
                if (obj->parent != nullptr &&
                    gl_object_isa(obj->parent, const_cast<char *>("triplex_line"), const_cast<char *>("powerflow"))) {
                                                                                                                                        ...
                                                                                                                                        for (char kphase=0;kphase<3;kphase++)
			{
                ...
                temp_current_val[0] = (voltage[0].IsZero() || (power[0].IsZero() && shunt[0].IsZero())) ? current[0] :
                                      current[0] + ~(power[0] / voltage[0]) + voltage[0] * shunt[0];
                temp_current_val[1] = (voltage[1].IsZero() || (power[1].IsZero() && shunt[1].IsZero())) ? current[1] :
                                      current[1] + ~(power[1] / voltage[1]) + voltage[1] * shunt[1];
                temp_current_val[2] = (voltage[2].IsZero() || (power[2].IsZero() && shunt[2].IsZero())) ? current[2] :
            ...
            if (!(has_phase(PHASE_S))) {
                ...
                dy_curr_accum[0] += (voltageA.IsZero() || (power_dy[3].IsZero() && shunt_dy[3].IsZero()))
                                    ? current_dy[3] : current_dy[3] + ~(power_dy[3] / voltageA) +
                                                      voltageA * shunt_dy[3];
                dy_curr_accum[1] += (voltageB.IsZero() || (power_dy[4].IsZero() && shunt_dy[4].IsZero()))
                                    ? current_dy[4] : current_dy[4] + ~(power_dy[4] / voltageB) +
                                                      voltageB * shunt_dy[4];
                dy_curr_accum[2] += (voltageC.IsZero() || (power_dy[5].IsZero() && shunt_dy[5].IsZero()))
                                    ? current_dy[5] : current_dy[5] + ~(power_dy[5] / voltageC) +
                                                      voltageC * shunt_dy[5];
	...
	if (is_contact_any())
	{
		...
		if (is_contact(PHASE_C|PHASE_N) || is_contact(PHASE_C|GROUND))
            ...
            if (obj->parent != NULL &&
                ...
                if (((pNode->phases & phases) & (!(PHASE_D | PHASE_N))) == (phases & (!(PHASE_D | PHASE_N)))) {
                    ...
                    GL_THROW(
                            const_cast<char *>("Node:%d's parent does not have the proper phase connection to be a parent."),
                            obj->id);
                /*  TROUBLESHOOT
        ...
        case SM_NR: {
            ...
            if ((NR_curr_bus == NR_bus_count) &&
                (obj == NR_swing_bus))    //Only run the solver once everything has populated
            {
...
#else
                long result = NR_Solver.solver_nr(NR_bus_count, NR_busdata, NR_branch_count, NR_branchdata, &NR_powerflow, powerflow_type, NULL, &bad_computation);
#endif
                ...
                if (bad_computation == true) {
                    GL_THROW(
                            const_cast<char *>("Newton-Raphson method is unable to converge to a solution at this operation point"));
                    /*  TROUBLESHOOT
                ...
                return NR_retval;
                       ...
                       NR_bus_count)    //Population complete, we're not swing, let us go (or we never go on)
                return t1;
            else    //Population of data busses is not complete.  Flag us for a go-around, they should be ready next time
            {
                if (obj ==
                    NR_swing_bus)    //Only error on MASTER swing - if errors with others, seems to be upset.  Too lazy to track down why.
                {
    ...
    if ((deltamode_inclusive == true) && (dynamic_norton == true)) {
        ...
        if ((SubNode == CHILD) || (SubNode == DIFF_CHILD)) {
            ...
            if ((temp_property->is_valid() != true) || (temp_property->is_complex_array() != true)) {
                GL_THROW(const_cast<char *>("Node:%d - %s - Failed to map deltamode matrix to parent"), obj->id,
                         (obj->name ? obj->name : "Unnamed"));
                /*  TROUBLESHOOT
        ...
        } else    //Parent or stand-alone
        {
            ...
            {
                GL_THROW(
                        const_cast<char *>("Node:%d - %s - Node tried to update a deltamode matrix that does not exist!"),
                        obj->id, (obj->name ? obj->name : "Unnamed"));
                /*  TROUBLESHOOT
...
TIMESTAMP node::postsync(TIMESTAMP t0) {
    ...
    if (solver_method == SM_FBS) {
        ...
        double sync_V = (last_voltage[0] - voltage[0]).Mag() + (last_voltage[1] - voltage[1]).Mag() +
        ...
        if ((SubNode != CHILD) && (SubNode != DIFF_CHILD))    //We're stand-alone or a parent
        {
            ...
            if (dynamic_norton == true) {
                ...
                if (full_Y == NULL) {
                    ...
                    //Check it
                    if (full_Y == NULL) {
                        GL_THROW(const_cast<char *>("Node:%s failed to allocate space for the a deltamode variable"),
                                 me->name);
                        /*  TROUBLESHOOT
						While attempting to allocate memory for a dynamics-required (deltamode) variable, an error
						occurred. Please try again.  If the error persists, please submit your code and a bug
...
int node::NR_current_update(bool parentcall) {
    ...
    if (current_accumulated == false) {
        ...
        if (has_phase(PHASE_D))    //Delta connection
        {
            ...
            temp_current_val[0] =
                    delta_shunt[0] - delta_shunt[2] + delta_current[0] - delta_current[2] + adjusted_current_val[0] -
                    adjusted_current_val[2];
            temp_current_val[1] =
                    delta_shunt[1] - delta_shunt[0] + delta_current[1] - delta_current[0] + adjusted_current_val[1] -
        ...
        } else if (has_phase(PHASE_S))    //Split phase node
        {
            ...
            if (house_present)    //House present
            {
                ...
                //Update these current contributions
                house_pres_current[0] = nom_res_curr[0] /
            ...
            if ((Triplex_Data != NULL) && ((Triplex_Data[0] != 0.0) || (Triplex_Data[1] != 0.0))) {
                ...
                temp_current_inj[2] = ((voltage1.IsZero() || (power1.IsZero() && shunt1.IsZero())) ||
                                       (voltage2.IsZero() || (power2.IsZero() && shunt2.IsZero())))
                                      ? currentN : -((temp_current_inj[0] - temp_current[2]) +
        ...
        } else                    //Wye connection
        {
            ...
            temp_current_val[0] =
                    ((voltage[0] == 0) ? gld::complex(0, 0) : ~(power[0] / voltage[0])) + voltage[0] * shunt[0] +
                    adjusted_current_val[0] + pre_rotated_current[0];
            temp_current_val[1] =
                    ((voltage[1] == 0) ? gld::complex(0, 0) : ~(power[1] / voltage[1])) + voltage[1] * shunt[1] +
                    adjusted_current_val[1] + pre_rotated_current[1];
            temp_current_val[2] =
                    ((voltage[2] == 0) ? gld::complex(0, 0) : ~(power[2] / voltage[2])) + voltage[2] * shunt[2] +
                    adjusted_current_val[2] + pre_rotated_current[2];
        ...
        if (!(has_phase(PHASE_S))) {
            ...
            temp_current_inj[0] +=
                    ((voltage[0] == 0) ? gld::complex(0, 0) : ~(power_dy[3] / voltage[0])) + voltage[0] * shunt_dy[3] +
                    adjusted_current_val[0];
            temp_current_inj[1] +=
                    ((voltage[1] == 0) ? gld::complex(0, 0) : ~(power_dy[4] / voltage[1])) + voltage[1] * shunt_dy[4] +
                    adjusted_current_val[1];
            temp_current_inj[2] +=
                    ((voltage[2] == 0) ? gld::complex(0, 0) : ~(power_dy[5] / voltage[2])) + voltage[2] * shunt_dy[5] +
                    adjusted_current_val[2];
        }//End both delta/wye
        ...
        if ((SubNode == CHILD) || (SubNode == DIFF_CHILD)) {
            ...
            if (ParLoadObj->current_accumulated ==
                false)    //Locking not needed here - if parent hasn't accumulated yet, it is the one that called us (rank split)
            {
                                   ...
                                   DIFF_CHILD))    //Make sure we aren't children as well, since we'll get NULL pointers and make everyone upset
        {
            for (table_index = 0; table_index < NR_busdata[NR_node_reference].Link_Table_Size; table_index++) {
                ...
                //Make sure it worked
                if (temp_link == NULL) {
                    GL_THROW(const_cast<char *>("Attemped to update current for object:%s, which is not a link!"),
                             NR_branchdata[NR_busdata[NR_node_reference].Link_Table[table_index]].name);
                    /*  TROUBLESHOOT
                ...
                if (temp_result != 1) {
                    GL_THROW(const_cast<char *>("Attempt to update current on link:%s failed!"),
                             NR_branchdata[NR_busdata[NR_node_reference].Link_Table[table_index]].name);
                    /*  TROUBLESHOOT
...
node::inter_deltaupdate_node(unsigned int64 delta_time, unsigned long dt, unsigned int iteration_count_val,
    ...
    if ((GFA_enable == true) && (iteration_count_val == 0) &&
        (interupdate_pos == false))    //Always just do on the first pass
    {
        //Do the checks
    ...
    switch (phase_conf) {
        ...
        case 0x07:    //ABC
        {
            curr_freq_state.average_freq =
                    (curr_freq_state.fmeas[0] + curr_freq_state.fmeas[1] + curr_freq_state.fmeas[2]) / 3.0;
            break;
        }
...
STATUS node::reset_node_island_condition(void) {
    ...
    if ((SubNode != CHILD) && (SubNode != DIFF_CHILD)) {
        ...
        if (NR_busdata[NR_node_reference].island_number != -1) {
            gl_warning("node:%d - %s - Tried to re-enable a node that wasn't disabled!", obj->id,
                       (obj->name ? obj->name : "Unnamed"));
            /*  TROUBLESHOOT
    ...
    if (fault_check_object == NULL)    //Make sure we actually have a fault check object
    {
        ...
        GL_THROW(const_cast<char *>("node:%d - %s -- Island condition reset failed - no fault_check object mapped!"),
                 obj->id, (obj->name ? obj->name : "Unnamed"));
        /*  TROUBLESHOOT
    ...
    if (temp_fxn_val == NULL) {
        ...
        GL_THROW(const_cast<char *>("node:%d - %s -- Island condition reset failed - reset function mapping failed!"),
                 obj->id, (obj->name ? obj->name : "Unnamed"));
        /*  TROUBLESHOOT
...
STATUS node::NR_map_current_update_function(OBJECT *callObj) {
    ...
    if (solver_method == SM_NR) {
        ...
        if ((SubNode != CHILD) && (SubNode != DIFF_CHILD)) {
            ...
            if (NR_busdata[NR_node_reference].ExtraCurrentInjFunc == NULL) {
                //Map the function
                NR_busdata[NR_node_reference].ExtraCurrentInjFunc = (FUNCTIONADDR) (gl_get_function(callObj,
                                                                                                    "current_injection_update"));

                //Make sure it worked
                if (NR_busdata[NR_node_reference].ExtraCurrentInjFunc == NULL) {
                    gl_error("node:%d - %s - Failed to map current_injection_update from calling object:%d - %s",
            ...
            {
                gl_error("node:%d - %s - Already has an extra current injection function mapped", hdr->id,
                         (hdr->name ? hdr->name : "Unnamed"));
                /*  TROUBLESHOOT
        ...
        } else    //Child - push this to the parent
        {
            ...
            if (NR_busdata[*NR_subnode_reference].ExtraCurrentInjFunc == NULL) {
                //Map the function
                NR_busdata[*NR_subnode_reference].ExtraCurrentInjFunc = (FUNCTIONADDR) (gl_get_function(callObj,
                                                                                                        "current_injection_update"));
            ...
            {
                gl_error("node:%d - %s - Parent node:%d - %s - Already has an extra current injection function mapped",
                         hdr->id, (hdr->name ? hdr->name : "Unnamed"), phdr->id, (phdr->name ? phdr->name : "Unnamed"));
                /*  TROUBLESHOOT
    ...
    {
        gl_warning("node:%d - %s - Attempted to map an NR-based function, but is not using an NR solver", hdr->id,
                   (hdr->name ? hdr->name : "Unnamed"));
        /*  TROUBLESHOOT
...
interupdate_node(OBJECT *obj, unsigned int64 delta_time, unsigned long dt, unsigned int iteration_count_val,
                 bool interupdate_pos) {
    node *my = OBJECTDATA(obj, node);

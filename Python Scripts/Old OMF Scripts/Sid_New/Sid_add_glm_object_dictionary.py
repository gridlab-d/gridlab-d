...
######### ALL OBJECTS WE WISH TO CREATE SHOULD HAVE A STORED (KEY : VALUE) IN THIS DICTIONARY!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		glm_objects={'node' : ['name','groupid','parent','bustype','phases','nominal_voltage','comments'],
						    ...
						    'inverter' : ['name','parent','generator_status','generator_mode','inverter_type','power_factor', 'rated_power'],
						    ...
						    'solar' : ['name','parent','generator_status','generator_mode','panel_type', 'area', 'efficiency'],

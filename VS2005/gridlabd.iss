...
Source: ..\..\..\utilities\copy.bat; DestDir: {app}; Flags: deleteafterinstall
...
[_ISToolDownload]
Source: http://downloads.sourceforge.net/sourceforge/gridlab-d/climate-US-2_0.zip?use_mirror=superb-east; DestDir: {userappdata}; DestName: climate-US-2_0.zip; Components: Climate Module modules\climate; Tasks: Download TMY Files Download_TMY_Files
[Run]
Filename: {app}\copy.bat; Parameters: """{userappdata}\climate-US-2_0.zip"" ""{app}\tmy"""; WorkingDir: {app}; Flags: shellexec
[UninstallDelete]

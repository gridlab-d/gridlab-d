import os,stat,time,sys,re,getopt
...
def do_help():
	...
	print("     update_sourceforge.py [--rdir=<dir>] [--days=<days>] [--prefix=<prefix>]")
	return 0
...
if __name__ == "__main__":
	...
	opts, args = getopt.getopt(sys.argv[1:], "",["rdir=",'days=','prefix=','dry-run','help'])

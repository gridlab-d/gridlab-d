...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) {
  ...
  if (!m_wndDlgBar.Create(this, IDR_MAINFRAME, CBRS_ALIGN_TOP,
                          AFX_IDW_DIALOGBAR)) {
...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT /*lpcs*/,
  ...
  if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView),
                                CSize(200, dr.Height() * 70 / 100), pContext) ||
      !m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CGldEditorView),
                                CSize(200, dr.Height() * 70 / 100), pContext) ||
      !m_wndSplitter.CreateView(1, 0, RUNTIME_CLASS(CControlView),
                                CSize(200, 200), pContext) ||
      !m_wndSplitter.CreateView(1, 1, RUNTIME_CLASS(COutputView),
                                CSize(200, 200), pContext)) {

...
GLDErrorCode dummy_callback(GridLabD *gld) { return GLD_SUCCESS; }
...
int main() {
  ...
  GLDData data = {{"name", std::string("object1")},
  ...
  assert(sim.set_application_mode(GLD_APPLICATION_TYPE_GRIDLABD) ==
         GLD_SUCCESS);

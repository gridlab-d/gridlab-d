...
battery::battery(MODULE *module)
{
	if (oclass == nullptr)
	{
		...
		if (gl_publish_variable(oclass,
								...
								PT_complex, "value_Circuit_V[0]", PADDR(value_Circuit_V[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for value_Circuit_V[0]",
								PT_complex, "value_Circuit_V[1]", PADDR(value_Circuit_V[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for value_Circuit_V[1]",
								PT_complex, "value_Circuit_V[2]", PADDR(value_Circuit_V[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for value_Circuit_V[2]",
								PT_complex, "value_Line_I[0]", PADDR(value_Line_I[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for value_Line_I[0]",
								PT_complex, "value_Line_I[1]", PADDR(value_Line_I[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for value_Line_I[1]",
								PT_complex, "value_Line_I[2]", PADDR(value_Line_I[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for value_Line_I[2]",

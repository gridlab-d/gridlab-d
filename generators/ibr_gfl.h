#ifndef GLD_GENERATORS_IBR_GFL_H_
#define GLD_GENERATORS_IBR_GFL_H_
...
//ibr_gfl class
class ibr_gfl : public gld_object
{
private:
...
public:
	...
	gld::complex value_Circuit_V_NS;	   // Negative sequence voltage of three phase terminal voltages
	gld::complex terminal_current_val_PS;	   // Positive sequence current of three phase terminal currents
	gld::complex terminal_current_val_NS;	   // Negative sequence current of three phase terminal currents
	...
	double ed_pu[3]; // internal d-axis votlage in dq frame
	double eq_pu[3]; // internal q-axis votlage in dq frame
	...
	double Qref_min;	  //
	double Vset;  		  // Vset is the voltage set point in volt-var in grid-following
	...
	double Ipmax[3];
	double IpUL[3];
	double igq_hold_value;
	double igq_hold_time;
	double Ipmax_limit;
	double ug_lvrt_threshold;
	double ug_asym_neg_threshold;
	double ug_asym_threshold1;
	double Qref_asym_threshold1_lim;
	double ug_asym_threshold2;
	double Qref_asym_threshold2_lim;
	double ug_asym_threshold3;
	double Qref_asym_threshold3_k;
	double Qref_asym_threshold3_b;
	double ug_asym_threshold4;
	double Qref_asym_threshold4_k;
	double Qref_asym_threshold4_b;
	double ug_asym_threshold5;
	double Qref_asym_threshold5_k;
	double Qref_asym_threshold5_b;
	double ug_asym_threshold6;
	double Qref_asym_threshold6_k;
	double Qref_asym_threshold6_b;
	double Qref_asym_threshold7_lim;
	double Qref_asym_UL;
	double Qref_asym_LL;

	double ug_sym_threshold1;
	double Qref_sym_threshold1_lim;
	double ug_sym_threshold2;
	double Qref_sym_threshold2_k;
	double Qref_sym_threshold2_b;
	double ug_sym_threshold3;
	double Qref_sym_threshold3_k;
	double Qref_sym_threshold3_b;
	double ug_sym_threshold4;
	double Qref_sym_threshold4_k;
	double Qref_sym_threshold4_b;
	double ug_sym_threshold5;
	double Qref_sym_threshold5_k;
	double Qref_sym_threshold5_b;
	double Qref_sym_threshold6_lim;
	double Qref_sym_UL;
	double Qref_sym_LL;
...
public:
	static CLASS *oclass;
	static ibr_gfl *defaults;
	static CLASS *plcass;
};

#endif // GLD_GENERATORS_IBR_GFL_H_

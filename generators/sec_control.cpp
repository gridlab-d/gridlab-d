...
sec_control::sec_control(MODULE *module)
{
	if (oclass == NULL)
	{
		...
		if (gl_publish_variable(oclass,
								...
								PT_double, "next_perr(t)[MW]", PADDR(next_state.perr[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for next_state.perr[0]",
								PT_double, "next_perr(t-1)[MW]", PADDR(next_state.perr[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for next_state.perr[1]",
								PT_double, "next_uniterr[MW]", PADDR(next_state.uniterr), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for next_state.uniterr",
								PT_double, "next_deltaf[Hz]", PADDR(next_state.deltaf), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for next_state.deltaf",
								PT_double, "next_dxi[MW]", PADDR(next_state.dxi), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for next_state.dxi",
								PT_double, "next_xi[MW]", PADDR(next_state.xi), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for next_state.xi",
								PT_double, "next_PIDout[MW]", PADDR(next_state.PIDout), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for next_state.PIDout",
								PT_double, "next_dP[MW]", PADDR(next_state.dP), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: internal variable for next_state.dP",
								NULL) < 1)

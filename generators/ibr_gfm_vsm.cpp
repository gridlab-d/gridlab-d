	...
	if (oclass == nullptr)
	{
		...
		if (gl_publish_variable(oclass,
			...
			PT_enumeration, "P_f_droop_setting_mode", PADDR(P_f_droop_setting_mode), PT_DESCRIPTION, "Definition of P-f droop curve",
				...
				PT_complex, "phaseA_V[V]", PADDR(value_Circuit_V[0]), PT_DESCRIPTION, "AC current on A phase in three-phase system",
				PT_complex, "phaseB_V[V]", PADDR(value_Circuit_V[1]), PT_DESCRIPTION, "AC current on A phase in three-phase system",
				PT_complex, "phaseC_V[V]", PADDR(value_Circuit_V[2]), PT_DESCRIPTION, "AC current on A phase in three-phase system",

				//PT_complex, "terminal_current_val_PS", PADDR(terminal_current_val_PS), PT_DESCRIPTION, "AC current on A phase in three-phase system",
				PT_complex, "terminal_current_val_NS", PADDR(terminal_current_val_NS), PT_DESCRIPTION, "AC current on A phase in three-phase system",
			...
			PT_double, "Qreg_ctrl_out", PADDR(Qreg_ctrl_out[0]), PT_DESCRIPTION, " The rated power of the inverter",
			...
			//PT_double, "igq_ref", PADDR(igq_ref), PT_DESCRIPTION, "DELTAMODE: Integral gain of the V loop.",
			...
			//PT_double, "igd_cmd", PADDR(igd_cmd), PT_DESCRIPTION, "igd_cmd",
			//PT_double, "count1", PADDR(count1), PT_DESCRIPTION, "Ipmax",
			PT_double, "count_A", PADDR(count[0]), PT_DESCRIPTION, "IpUL",
			//PT_double, "igq_ref_A", PADDR(igq_ref[0]), PT_DESCRIPTION, "IpUL",
			...
			//PT_double, "ug_pu_NS", PADDR(ug_pu_NS), PT_DESCRIPTION, "Negative sequence voltage",
			PT_double, "I_source_NS_Re_A", PADDR(I_source_ns_Re[0]), PT_DESCRIPTION, "Negative sequence voltage",
			PT_double, "I_source_NS_Im_A", PADDR(I_source_ns_Im[0]), PT_DESCRIPTION, "Negative sequence voltage",
			PT_double, "igq_cmd_A", PADDR(igq_cmd[0]), PT_DESCRIPTION, "Negative sequence voltage",
			...
			PT_double, "P_o_pu", PADDR(P_o_pu), PT_DESCRIPTION, "Negative sequence voltage",
			PT_double, "Q_o_pu", PADDR(Q_o_pu), PT_DESCRIPTION, "Negative sequence voltage",
			...
			PT_double, "igd_ref_old_A", PADDR(igd_ref_old[0]), PT_DESCRIPTION, "IpUL",
			PT_double, "Test2", PADDR(Test2), PT_DESCRIPTION, "IpUL",
			PT_double, "Test3", PADDR(Test3), PT_DESCRIPTION, "IpUL",
			//PT_double, "Qref_pu", PADDR(Qref_pu), PT_DESCRIPTION, "IpUL",
			PT_double, "ug_pu_PS_risingedge", PADDR(ug_pu_PS_risingedge[0]), PT_DESCRIPTION, "ug_pu_PS_risingedge",

			//************************VSM GFM
			//PT_double, "Pset", PADDR(Pset), PT_DESCRIPTION, "Pset",
			...
			//PT_double, "wset", PADDR(wset), PT_DESCRIPTION, "wset",
			//PT_double, "Pref", PADDR(Pref), PT_DESCRIPTION, "Pref",
			PT_double, "Pref_droop_pu", PADDR(Pref_droop_pu), PT_DESCRIPTION, "Pref",
			...
			//PT_double, "Imax", PADDR(Imax), PT_DESCRIPTION, "Imax",
			PT_double, "kPF", PADDR(kPF), PT_DESCRIPTION, "kPF",


			PT_double, "AngleIT", PADDR(Angle_e[0]), PT_DESCRIPTION, "Angle_e[0]",
			...
			PT_double, "ugq_pu_PS", PADDR(ugq_pu_PS), PT_DESCRIPTION, "ugq_pu_PS",
			...
			//PT_double, "Id_measured", PADDR(Id_measured), PT_DESCRIPTION, "Id_measured",
			//PT_double, "Angle_PLL_A", PADDR(Angle_PLL[0]), PT_DESCRIPTION, "Angle_PLL_A",
			...
			PT_double, "CFilt", PADDR(CFilt), PT_DESCRIPTION, "CFilt",
			...
			PT_double, "igd_pu_A_filter", PADDR(igd_filter_ref[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "DELTAMODE: terminal current of grid-following inverter, d-axis, phase A, current source representation",
			PT_double, "igd_pu_B_filter", PADDR(igd_filter_ref[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "DELTAMODE: terminal current of grid-following inverter, d-axis, phase B, current source representation",
			PT_double, "igd_pu_C_filter", PADDR(igd_filter_ref[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "DELTAMODE: terminal current of grid-following inverter, d-axis, phase C, current source representation",
			...
			PT_complex, "terminal_current_val_PS", PADDR(terminal_current_val_PS), PT_DESCRIPTION, "DELTAMODE: Id_measured.",
			PT_complex, "terminal_current_val_A", PADDR(terminal_current_val[0]), PT_DESCRIPTION, "DELTAMODE: Id_measured.",
			...
			PT_double, "Ed_pu_NS", PADDR(Ed_pu_NS), PT_DESCRIPTION, "DELTAMODE: maximum limit and minimum limit of Qmax controller and Qmin controller.",
			PT_double, "Eq_pu_NS", PADDR(Eq_pu_NS), PT_DESCRIPTION, "DELTAMODE: maximum limit and minimum limit of Qmax controller and Qmin controller.",
			PT_double, "test", PADDR(test), PT_DESCRIPTION, "DELTAMODE: maximum limit and minimum limit of Qmax controller and Qmin controller.",
...
int ibr_gfm_vsm::create(void)
{
	...
	value_Frequency = 60;//60.0;	//Just set it to nominal

	// Inverter filter
	//Xfilter =  0.0847666868075443;//0.15; //per unit
	//Rfilter = 0.00165331338418422; // per unit


	// Droop, Grid-Forming controller parameters
	Tp = 0.01; // s
	Tq = 0.01; // s
	Tv = 0.01; // s
	...
	Tif_igd_ref = 0.01;
	Tif_igq_ref = 0.01;//0.005;////0.005;
	kqp  = 0.5*5;//0.5*1*2;//0.5*1;
	Tqi  = 1/(0.5/0.2/5)*1;//0.5*2;//1/(0.5/0.2/5);///(0.1);
	kvp  = 1*1;//1;
	Tvi  = 1/(1/0.02);// 0.01*0.1;//1/(1/0.02);///(0.1);
	...
	// VSM controlled Grid-Forming circuit and controller parameters

	ImaxF = 1.2;

	//CFilt = 0.0010964;//real
    LC_frequency = 600;
	// Inverter filter
	...
	//	kic = 5;
		//F_current = 0.5;
	//	Rfilter = 0.0001;
	//	Xfilter =  0.085;//0.09999100367753763791794382143344;//0.0847747117659296
	//}
	...
	node_nominal_voltage = 120;//550;		//Just pick a value
...
SIMULATIONMODE ibr_gfm_vsm::inter_deltaupdate(unsigned int64 delta_time, unsigned long dt, unsigned int iteration_count_val)
{
    ...
    if (gl_globaldeltaclock < start_time_igd_delay + 0.02)
    {
    	igd_delay_flag = 0;
    }
    else
			...
			if (iteration_count_val == 0) // Predictor pass
			{
				...
				else //Three-phase
				{
					if ((grid_following_mode == BALANCED_POWER)||(grid_following_mode == POSITIVE_SEQUENCE))
					{
						...
						//Test3 = Qref_droop_pu;//Qref_droop_pu_filter;
						// Function end

						// Find the limit for Qref, Qref_max and Qref_min & Pref, Pref_max and Pref_min
...
void ibr_gfm_vsm::pull_complex_powerflow_values(void)
{
	...
	if (parent_is_single_phase)
	{
		...
		//value_Circuit_I[0] = pLine_I[0]->get_complex();
...
void ibr_gfm_vsm::reset_complex_powerflow_accumulators(void)
{
	int indexval;

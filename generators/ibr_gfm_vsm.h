#ifndef GLD_GENERATORS_IBR_GFM_VSM_H_
#define GLD_GENERATORS_IBR_GFM_VSM_H_
...
public:
    ...
    double Iq_measured; // Output of voltage measurement block
	double Iqmax;
	double Emin;
	double Emax;
	double Emin_f;
	...
	double Idmax;
	double Angle_max;
	Integrator Anglemax_blk; // Voltage measurement block
	double AngleIT_max;
	double AngleIT_min;
...
public:
	static CLASS *oclass;
	static ibr_gfm_vsm *defaults;
	static CLASS *plcass;
};

#endif // GLD_GENERATORS_IBR_GFM_VSM_H_

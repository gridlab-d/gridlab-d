/** $Id: inverter_dyn.h,v 1.0 2019/03/11
	Copyright (C) 2019 Battelle Memorial Institute
	@file inverter_dyn.h
	@addtogroup inverter_dyn

 @{  
 **/

#ifndef _inverter_dyn_H
...
public:
	...
	enum INVERTER_TYPE {GRID_FORMING=0, GRID_FOLLOWING=1, GFL_CURRENT_SOURCE=2};

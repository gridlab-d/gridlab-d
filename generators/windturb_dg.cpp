	...
	if (oclass==NULL)
	{
		...
		if (gl_publish_variable(oclass,
			PT_enumeration,"Gen_status",PADDR(Gen_status), PT_DESCRIPTION, "Describes whether the generator is currently online or offline",
				PT_KEYWORD,"OFFLINE",OFFLINE, PT_DESCRIPTION, "Generator is currently not supplying power",
				PT_KEYWORD,"ONLINE",ONLINE, PT_DESCRIPTION, "Generator is currently available to supply power",
			PT_enumeration,"Gen_type",PADDR(Gen_type), PT_DESCRIPTION, "Type of generator",
				PT_KEYWORD,"INDUCTION",INDUCTION, PT_DESCRIPTION, "Standard induction generator",
				PT_KEYWORD,"SYNCHRONOUS",SYNCHRONOUS, PT_DESCRIPTION, "Standard synchronous generator; is also used to 'fake' a doubly-fed induction generator for now",
			PT_enumeration,"Gen_mode",PADDR(Gen_mode), PT_DESCRIPTION, "Control mode that is used for the generator output",
				PT_KEYWORD,"CONSTANTE",CONSTANTE, PT_DESCRIPTION, "Maintains the voltage at the terminals",
				PT_KEYWORD,"CONSTANTP",CONSTANTP, PT_DESCRIPTION, "Maintains the real power output at the terminals",
				PT_KEYWORD,"CONSTANTPQ",CONSTANTPQ, PT_DESCRIPTION, "Maintains the real and reactive output at the terminals - currently unsupported",
			PT_enumeration,"Turbine_Model",PADDR(Turbine_Model), PT_DESCRIPTION, "Type of turbine being represented; using any of these except USER_DEFINED also specifies a large number of defaults",
				PT_KEYWORD,"GENERIC_SYNCH_SMALL",GENERIC_SYNCH_SMALL, PT_DESCRIPTION, "Generic model for a small, fixed pitch synchronous turbine",
				PT_KEYWORD,"GENERIC_SYNCH_MID",GENERIC_SYNCH_MID, PT_DESCRIPTION, "Generic model for a mid-size, fixed pitch synchronous turbine",
				PT_KEYWORD,"GENERIC_SYNCH_LARGE",GENERIC_SYNCH_LARGE, PT_DESCRIPTION, "Generic model for a large, fixed pitch synchronous turbine",
				PT_KEYWORD,"GENERIC_IND_SMALL",GENERIC_IND_SMALL, PT_DESCRIPTION, "Generic model for a small induction, fixed pitch generator turbine",
				PT_KEYWORD,"GENERIC_IND_MID",GENERIC_IND_MID, PT_DESCRIPTION, "Generic model for a mid-size induction, fixed pitch generator turbine",
				PT_KEYWORD,"GENERIC_IND_LARGE",GENERIC_IND_LARGE, PT_DESCRIPTION, "Generic model for a large induction, fixed pitch generator turbine",
                PT_KEYWORD,"USER_DEFINED",USER_DEFINED, PT_DESCRIPTION, "Allows user to specify all parameters - is not currently supported", // TODO: Doesnt work yet
				PT_KEYWORD,"VESTAS_V82",VESTAS_V82, PT_DESCRIPTION, "Sets all defaults to represent the power output of a VESTAS V82 turbine",
				PT_KEYWORD,"GE_25MW",GE_25MW, PT_DESCRIPTION, "Sets all defaults to represent the power output of a GE 2.5MW turbine",
...
int windturb_dg::init(OBJECT *parent)
{
	...
	if (parent!=NULL)
	{
		...
		{
			GL_THROW("The wind turbine model does currently support a triplex meter connection.");
			/*  TROUBLESHOOT

...
diesel_dg::diesel_dg(MODULE *module)
{
    if (oclass == nullptr)
    {
        ...
        if (gl_publish_variable(oclass,
                                ...
                                PT_complex, "value_prev_Power_A", PADDR(value_prev_Power[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: previous power value for phase A",
                                PT_complex, "value_prev_Power_B", PADDR(value_prev_Power[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: previous power value for phase B",
                                PT_complex, "value_prev_Power_C", PADDR(value_prev_Power[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT_VAR: previous power value for phase C",

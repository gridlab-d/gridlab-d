#ifndef GLD_GENERATORS_IBR_GFM_DRP_H_
#define GLD_GENERATORS_IBR_GFM_DRP_H_
...
//ibr_gfm_drp class
class ibr_gfm_drp : public gld_object
{
private:
...
public:
	static CLASS *oclass;
	static ibr_gfm_drp *defaults;
	static CLASS *plcass;
};

#endif // GLD_GENERATORS_IBR_GFM_DRP_H_

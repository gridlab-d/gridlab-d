...
private:
	...
	INV_DYN2_STATE pred_state; ///< The predictor state of the inverter in delamode
	INV_DYN2_STATE next_state; ///< The next state of the inverter in delamode
	...
	std::vector<DC_OBJ2_FXNS> dc_interface_objects;
	double P_DC;
	double V_DC;
	double I_DC;
	double SOC;
...
public:
	...
	INV_DYN2_STATE curr_state; ///< The current state of the inverter in deltamode
	...
	STATUS init_dynamics(INV_DYN2_STATE *curr_time);

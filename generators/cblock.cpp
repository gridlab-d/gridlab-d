...
void Cblock::updatestate(double u, double dt, double xmin, double xmax,
                         double dxmin, double dxmax, IntegrationStage stage) {
  double xout, dx_dt;
...
double Cblock::getoutput(double u, double dt, double xmin, double xmax,
                         double ymin, double ymax, IntegrationStage stage,
                         bool dostateupdate) {
  double x_n, y_n, x_n1;
...
double Cblock::getoutput(double u, double dt, double xmin, double xmax,
                         double dxmin, double dxmax, double ymin, double ymax,
...
void PIControl::setparams(double Kp, double Ki, double xmin, double xmax,
...
void PIControl::setparams(double Kp, double Ki, double xmin, double xmax,
                          double dxmin, double dxmax, double ymin,
                          double ymax) {
  setparams(Kp, Ki);
  setxlimits(xmin, xmax);
...
void Filter::setparams(double T) { setparams(1.0, T); }

void Filter::setparams(double K, double T, double xmin, double xmax,
                       double ymin, double ymax) {
  setparams(K, T);
  setxlimits(xmin, xmax);
  setylimits(ymin, ymax);
...
void Filter::setparams(double T, double xmin, double xmax, double ymin,
                       double ymax) {
...
void Filter::setparams(double T, double xmin, double xmax, double dxmin,
...
void LeadLag::setparams(double TA, double TB, double xmin, double xmax,
                        double ymin, double ymax) {
  setparams(TA, TB);
  setxlimits(xmin, xmax);
  setylimits(ymin, ymax);

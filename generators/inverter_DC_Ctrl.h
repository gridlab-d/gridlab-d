#ifndef GLD_GENERATORS_inverter_DC_Ctrl_H_
#define GLD_GENERATORS_inverter_DC_Ctrl_H_
...
//inverter_DC_Ctrl class
class inverter_DC_Ctrl : public gld_object
{
private:
	...
	INV_DC_Ctrl_STATE pred_state; ///< The predictor state of the inverter in delamode
	INV_DC_Ctrl_STATE next_state; ///< The next state of the inverter in delamode
	...
	std::vector<DC_Ctrl_OBJ_FXNS> dc_interface_objects;
	double P_DC;
	double V_DC;
	double I_DC;
	double SOC;
...
public:
	...
	INV_DC_Ctrl_STATE curr_state; ///< The current state of the inverter in deltamode
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	bool DC_Ctrl;   // Boolean value indicating weather the inverter trgulate the DC link or not
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    double Vdc_ref_pu;   // DC link voltage reference in pu
	double Vdc_ref;      // DC link voltage reference in V
	double V_DC_pu;       // Actual DC link voltage in pu
	double Kp_dc;        // proportional gain and integral gain of DC Link loop
    double Ki_dc;        //
	double Test_1;
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	inverter_DC_Ctrl(MODULE *module);
	...
	STATUS init_dynamics(INV_DC_Ctrl_STATE *curr_time);
	STATUS DC_object_register(OBJECT *DC_object);

public:
	static CLASS *oclass;
	static inverter_DC_Ctrl *defaults;
	static CLASS *plcass;
};

#endif // GLD_GENERATORS_inverter_DC_Ctrl_H_

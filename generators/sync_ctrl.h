...
private: // Member Funcs: Utilities
  ...
  template <class T> void set_prop(gld_property *, T);
...
private: // Variables
  ...
  enum SWT_STATUS_ENUM { OPEN = 0, CLOSED = 1 } swt_status;
  ...
  enum class CGU_TYPE { UNKNOWN_CGU_TYPE = 0, DG = 1, INV = 2 } cgu_type;

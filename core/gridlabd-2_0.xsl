...
<TR><TH>Name</TH><TH>floor_area</TH><TH>floor_height</TH><TH>exterior_ua</TH><TH>interior_ua</TH><TH>interior_mass</TH><TH>glazing</TH><TH>glazing.north</TH><TH>glazing.northeast</TH><TH>glazing.east</TH><TH>glazing.southeast</TH><TH>glazing.south</TH><TH>glazing.southwest</TH><TH>glazing.west</TH><TH>glazing.northwest</TH><TH>glazing.horizontal</TH><TH>glazing.coefficient</TH><TH>occupancy</TH><TH>occupants</TH><TH>schedule</TH><TH>air_temperature</TH><TH>mass_temperature</TH><TH>temperature_change</TH><TH>Qh</TH><TH>Qs</TH><TH>Qi</TH><TH>Qz</TH><TH>hvac_mode</TH><TH>hvac.cooling.balance_temperature</TH><TH>hvac.cooling.capacity</TH><TH>hvac.cooling.capacity_perF</TH><TH>hvac.cooling.design_temperature</TH><TH>hvac.cooling.efficiency</TH><TH>hvac.cooling.cop</TH><TH>hvac.heating.balance_temperature</TH><TH>hvac.heating.capacity</TH><TH>hvac.heating.capacity_perF</TH><TH>hvac.heating.design_temperature</TH><TH>hvac.heating.efficiency</TH><TH>hvac.heating.cop</TH><TH>lights.capacity</TH><TH>lights.fraction</TH><TH>plugs.capacity</TH><TH>plugs.fraction</TH><TH>demand</TH><TH>total_load</TH><TH>energy</TH><TH>power_factor</TH><TH>power</TH><TH>current</TH><TH>admittance</TH><TH>hvac.demand</TH><TH>hvac.load</TH><TH>hvac.energy</TH><TH>hvac.power_factor</TH><TH>lights.demand</TH><TH>lights.load</TH><TH>lights.energy</TH><TH>lights.power_factor</TH><TH>plugs.demand</TH><TH>plugs.load</TH><TH>plugs.energy</TH><TH>plugs.power_factor</TH><TH>cooling_setpoint</TH><TH>heating_setpoint</TH><TH>thermostat_deadband</TH><TH>control.ventilation_fraction</TH><TH>control.lighting_fraction</TH></TR>
<xsl:for-each select="commercial/office_list/office"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="floor_area"/></TD><TD><xsl:value-of select="floor_height"/></TD><TD><xsl:value-of select="exterior_ua"/></TD><TD><xsl:value-of select="interior_ua"/></TD><TD><xsl:value-of select="interior_mass"/></TD><TD><xsl:value-of select="glazing"/></TD><TD><xsl:value-of select="glazing.north"/></TD><TD><xsl:value-of select="glazing.northeast"/></TD><TD><xsl:value-of select="glazing.east"/></TD><TD><xsl:value-of select="glazing.southeast"/></TD><TD><xsl:value-of select="glazing.south"/></TD><TD><xsl:value-of select="glazing.southwest"/></TD><TD><xsl:value-of select="glazing.west"/></TD><TD><xsl:value-of select="glazing.northwest"/></TD><TD><xsl:value-of select="glazing.horizontal"/></TD><TD><xsl:value-of select="glazing.coefficient"/></TD><TD><xsl:value-of select="occupancy"/></TD><TD><xsl:value-of select="occupants"/></TD><TD><xsl:value-of select="schedule"/></TD><TD><xsl:value-of select="air_temperature"/></TD><TD><xsl:value-of select="mass_temperature"/></TD><TD><xsl:value-of select="temperature_change"/></TD><TD><xsl:value-of select="Qh"/></TD><TD><xsl:value-of select="Qs"/></TD><TD><xsl:value-of select="Qi"/></TD><TD><xsl:value-of select="Qz"/></TD><TD><xsl:value-of select="hvac_mode"/></TD><TD><xsl:value-of select="hvac.cooling.balance_temperature"/></TD><TD><xsl:value-of select="hvac.cooling.capacity"/></TD><TD><xsl:value-of select="hvac.cooling.capacity_perF"/></TD><TD><xsl:value-of select="hvac.cooling.design_temperature"/></TD><TD><xsl:value-of select="hvac.cooling.efficiency"/></TD><TD><xsl:value-of select="hvac.cooling.cop"/></TD><TD><xsl:value-of select="hvac.heating.balance_temperature"/></TD><TD><xsl:value-of select="hvac.heating.capacity"/></TD><TD><xsl:value-of select="hvac.heating.capacity_perF"/></TD><TD><xsl:value-of select="hvac.heating.design_temperature"/></TD><TD><xsl:value-of select="hvac.heating.efficiency"/></TD><TD><xsl:value-of select="hvac.heating.cop"/></TD><TD><xsl:value-of select="lights.capacity"/></TD><TD><xsl:value-of select="lights.fraction"/></TD><TD><xsl:value-of select="plugs.capacity"/></TD><TD><xsl:value-of select="plugs.fraction"/></TD><TD><xsl:value-of select="demand"/></TD><TD><xsl:value-of select="total_load"/></TD><TD><xsl:value-of select="energy"/></TD><TD><xsl:value-of select="power_factor"/></TD><TD><xsl:value-of select="power"/></TD><TD><xsl:value-of select="current"/></TD><TD><xsl:value-of select="admittance"/></TD><TD><xsl:value-of select="hvac.demand"/></TD><TD><xsl:value-of select="hvac.load"/></TD><TD><xsl:value-of select="hvac.energy"/></TD><TD><xsl:value-of select="hvac.power_factor"/></TD><TD><xsl:value-of select="lights.demand"/></TD><TD><xsl:value-of select="lights.load"/></TD><TD><xsl:value-of select="lights.energy"/></TD><TD><xsl:value-of select="lights.power_factor"/></TD><TD><xsl:value-of select="plugs.demand"/></TD><TD><xsl:value-of select="plugs.load"/></TD><TD><xsl:value-of select="plugs.energy"/></TD><TD><xsl:value-of select="plugs.power_factor"/></TD><TD><xsl:value-of select="cooling_setpoint"/></TD><TD><xsl:value-of select="heating_setpoint"/></TD><TD><xsl:value-of select="thermostat_deadband"/></TD><TD><xsl:value-of select="control.ventilation_fraction"/></TD><TD><xsl:value-of select="control.lighting_fraction"/></TD></TR>
</xsl:for-each></TABLE>
...
<H4>link objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>status</TH><TH>from</TH><TH>to</TH><TH>power_in</TH><TH>power_out</TH><TH>power_losses</TH><TH>power_in_A</TH><TH>power_in_B</TH><TH>power_in_C</TH><TH>power_out_A</TH><TH>power_out_B</TH><TH>power_out_C</TH><TH>power_losses_A</TH><TH>power_losses_B</TH><TH>power_losses_C</TH><TH>direction_A</TH><TH>direction_B</TH><TH>direction_C</TH><TH>phases</TH><TH>nominal_voltage</TH></TR>
<xsl:for-each select="powerflow/link_list/link"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="status"/></TD><TD><a href="#{from}"><xsl:value-of select="from"/></a></TD><TD><a href="#{to}"><xsl:value-of select="to"/></a></TD><TD><xsl:value-of select="power_in"/></TD><TD><xsl:value-of select="power_out"/></TD><TD><xsl:value-of select="power_losses"/></TD><TD><xsl:value-of select="power_in_A"/></TD><TD><xsl:value-of select="power_in_B"/></TD><TD><xsl:value-of select="power_in_C"/></TD><TD><xsl:value-of select="power_out_A"/></TD><TD><xsl:value-of select="power_out_B"/></TD><TD><xsl:value-of select="power_out_C"/></TD><TD><xsl:value-of select="power_losses_A"/></TD><TD><xsl:value-of select="power_losses_B"/></TD><TD><xsl:value-of select="power_losses_C"/></TD><TD><xsl:value-of select="direction_A"/></TD><TD><xsl:value-of select="direction_B"/></TD><TD><xsl:value-of select="direction_C"/></TD><TD><xsl:value-of select="phases"/></TD><TD><xsl:value-of select="nominal_voltage"/></TD></TR>
</xsl:for-each></TABLE>
<H4>capacitor objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>pt_phase</TH><TH>phases_connected</TH><TH>switchA</TH><TH>switchB</TH><TH>switchC</TH><TH>control</TH><TH>voltage_set_high</TH><TH>voltage_set_low</TH><TH>VAr_set_high</TH><TH>VAr_set_low</TH><TH>capacitor_A</TH><TH>capacitor_B</TH><TH>capacitor_C</TH><TH>cap_nominal_voltage</TH><TH>time_delay</TH><TH>dwell_time</TH><TH>lockout_time</TH><TH>remote_sense</TH><TH>remote_sense_B</TH><TH>control_level</TH><TH>bustype</TH><TH>busflags</TH><TH>reference_bus</TH><TH>maximum_voltage_error</TH><TH>voltage_A</TH><TH>voltage_B</TH><TH>voltage_C</TH><TH>voltage_AB</TH><TH>voltage_BC</TH><TH>voltage_CA</TH><TH>current_A</TH><TH>current_B</TH><TH>current_C</TH><TH>power_A</TH><TH>power_B</TH><TH>power_C</TH><TH>shunt_A</TH><TH>shunt_B</TH><TH>shunt_C</TH><TH>phases</TH><TH>nominal_voltage</TH></TR>
<xsl:for-each select="powerflow/capacitor_list/capacitor"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="pt_phase"/></TD><TD><xsl:value-of select="phases_connected"/></TD><TD><xsl:value-of select="switchA"/></TD><TD><xsl:value-of select="switchB"/></TD><TD><xsl:value-of select="switchC"/></TD><TD><xsl:value-of select="control"/></TD><TD><xsl:value-of select="voltage_set_high"/></TD><TD><xsl:value-of select="voltage_set_low"/></TD><TD><xsl:value-of select="VAr_set_high"/></TD><TD><xsl:value-of select="VAr_set_low"/></TD><TD><xsl:value-of select="capacitor_A"/></TD><TD><xsl:value-of select="capacitor_B"/></TD><TD><xsl:value-of select="capacitor_C"/></TD><TD><xsl:value-of select="cap_nominal_voltage"/></TD><TD><xsl:value-of select="time_delay"/></TD><TD><xsl:value-of select="dwell_time"/></TD><TD><xsl:value-of select="lockout_time"/></TD><TD><a href="#{remote_sense}"><xsl:value-of select="remote_sense"/></a></TD><TD><a href="#{remote_sense_B}"><xsl:value-of select="remote_sense_B"/></a></TD><TD><xsl:value-of select="control_level"/></TD><TD><xsl:value-of select="bustype"/></TD><TD><xsl:value-of select="busflags"/></TD><TD><a href="#{reference_bus}"><xsl:value-of select="reference_bus"/></a></TD><TD><xsl:value-of select="maximum_voltage_error"/></TD><TD><xsl:value-of select="voltage_A"/></TD><TD><xsl:value-of select="voltage_B"/></TD><TD><xsl:value-of select="voltage_C"/></TD><TD><xsl:value-of select="voltage_AB"/></TD><TD><xsl:value-of select="voltage_BC"/></TD><TD><xsl:value-of select="voltage_CA"/></TD><TD><xsl:value-of select="current_A"/></TD><TD><xsl:value-of select="current_B"/></TD><TD><xsl:value-of select="current_C"/></TD><TD><xsl:value-of select="power_A"/></TD><TD><xsl:value-of select="power_B"/></TD><TD><xsl:value-of select="power_C"/></TD><TD><xsl:value-of select="shunt_A"/></TD><TD><xsl:value-of select="shunt_B"/></TD><TD><xsl:value-of select="shunt_C"/></TD><TD><xsl:value-of select="phases"/></TD><TD><xsl:value-of select="nominal_voltage"/></TD></TR>
</xsl:for-each></TABLE>
<H4>fuse objects</H4><TABLE BORDER="1">
...
<H4>relay objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>time_to_change</TH><TH>recloser_delay</TH><TH>recloser_tries</TH><TH>status</TH><TH>from</TH><TH>to</TH><TH>power_in</TH><TH>power_out</TH><TH>power_losses</TH><TH>power_in_A</TH><TH>power_in_B</TH><TH>power_in_C</TH><TH>power_out_A</TH><TH>power_out_B</TH><TH>power_out_C</TH><TH>power_losses_A</TH><TH>power_losses_B</TH><TH>power_losses_C</TH><TH>direction_A</TH><TH>direction_B</TH><TH>direction_C</TH><TH>phases</TH><TH>nominal_voltage</TH></TR>
...
<TR><TH>Name</TH><TH>bustype</TH><TH>busflags</TH><TH>reference_bus</TH><TH>maximum_voltage_error</TH><TH>voltage_1</TH><TH>voltage_2</TH><TH>voltage_N</TH><TH>voltage_12</TH><TH>voltage_1N</TH><TH>voltage_2N</TH><TH>current_1</TH><TH>current_2</TH><TH>current_N</TH><TH>current_12</TH><TH>power_1</TH><TH>power_2</TH><TH>power_12</TH><TH>shunt_1</TH><TH>shunt_2</TH><TH>shunt_12</TH><TH>impedance_1</TH><TH>impedance_2</TH><TH>impedance_12</TH><TH>phases</TH><TH>nominal_voltage</TH></TR>
<xsl:for-each select="powerflow/triplex_node_list/triplex_node"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="bustype"/></TD><TD><xsl:value-of select="busflags"/></TD><TD><a href="#{reference_bus}"><xsl:value-of select="reference_bus"/></a></TD><TD><xsl:value-of select="maximum_voltage_error"/></TD><TD><xsl:value-of select="voltage_1"/></TD><TD><xsl:value-of select="voltage_2"/></TD><TD><xsl:value-of select="voltage_N"/></TD><TD><xsl:value-of select="voltage_12"/></TD><TD><xsl:value-of select="voltage_1N"/></TD><TD><xsl:value-of select="voltage_2N"/></TD><TD><xsl:value-of select="current_1"/></TD><TD><xsl:value-of select="current_2"/></TD><TD><xsl:value-of select="current_N"/></TD><TD><xsl:value-of select="current_12"/></TD><TD><xsl:value-of select="power_1"/></TD><TD><xsl:value-of select="power_2"/></TD><TD><xsl:value-of select="power_12"/></TD><TD><xsl:value-of select="shunt_1"/></TD><TD><xsl:value-of select="shunt_2"/></TD><TD><xsl:value-of select="shunt_12"/></TD><TD><xsl:value-of select="impedance_1"/></TD><TD><xsl:value-of select="impedance_2"/></TD><TD><xsl:value-of select="impedance_12"/></TD><TD><xsl:value-of select="phases"/></TD><TD><xsl:value-of select="nominal_voltage"/></TD></TR>
</xsl:for-each></TABLE>
<H4>triplex_meter objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>measured_energy</TH><TH>measured_power</TH><TH>measured_demand</TH><TH>measured_real_power</TH><TH>measured_voltage_1</TH><TH>measured_voltage_2</TH><TH>measured_voltage_N</TH><TH>measured_current_1</TH><TH>measured_current_2</TH><TH>measured_current_N</TH><TH>bustype</TH><TH>busflags</TH><TH>reference_bus</TH><TH>maximum_voltage_error</TH><TH>voltage_1</TH><TH>voltage_2</TH><TH>voltage_N</TH><TH>voltage_12</TH><TH>voltage_1N</TH><TH>voltage_2N</TH><TH>current_1</TH><TH>current_2</TH><TH>current_N</TH><TH>current_12</TH><TH>power_1</TH><TH>power_2</TH><TH>power_12</TH><TH>shunt_1</TH><TH>shunt_2</TH><TH>shunt_12</TH><TH>impedance_1</TH><TH>impedance_2</TH><TH>impedance_12</TH><TH>phases</TH><TH>nominal_voltage</TH></TR>
<xsl:for-each select="powerflow/triplex_meter_list/triplex_meter"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="measured_energy"/></TD><TD><xsl:value-of select="measured_power"/></TD><TD><xsl:value-of select="measured_demand"/></TD><TD><xsl:value-of select="measured_real_power"/></TD><TD><xsl:value-of select="measured_voltage_1"/></TD><TD><xsl:value-of select="measured_voltage_2"/></TD><TD><xsl:value-of select="measured_voltage_N"/></TD><TD><xsl:value-of select="measured_current_1"/></TD><TD><xsl:value-of select="measured_current_2"/></TD><TD><xsl:value-of select="measured_current_N"/></TD><TD><xsl:value-of select="bustype"/></TD><TD><xsl:value-of select="busflags"/></TD><TD><a href="#{reference_bus}"><xsl:value-of select="reference_bus"/></a></TD><TD><xsl:value-of select="maximum_voltage_error"/></TD><TD><xsl:value-of select="voltage_1"/></TD><TD><xsl:value-of select="voltage_2"/></TD><TD><xsl:value-of select="voltage_N"/></TD><TD><xsl:value-of select="voltage_12"/></TD><TD><xsl:value-of select="voltage_1N"/></TD><TD><xsl:value-of select="voltage_2N"/></TD><TD><xsl:value-of select="current_1"/></TD><TD><xsl:value-of select="current_2"/></TD><TD><xsl:value-of select="current_N"/></TD><TD><xsl:value-of select="current_12"/></TD><TD><xsl:value-of select="power_1"/></TD><TD><xsl:value-of select="power_2"/></TD><TD><xsl:value-of select="power_12"/></TD><TD><xsl:value-of select="shunt_1"/></TD><TD><xsl:value-of select="shunt_2"/></TD><TD><xsl:value-of select="shunt_12"/></TD><TD><xsl:value-of select="impedance_1"/></TD><TD><xsl:value-of select="impedance_2"/></TD><TD><xsl:value-of select="impedance_12"/></TD><TD><xsl:value-of select="phases"/></TD><TD><xsl:value-of select="nominal_voltage"/></TD></TR>
</xsl:for-each></TABLE>
...
<TR><TH>Name</TH><TH>weather</TH><TH>T_nominal</TH><TH>Zp_T</TH><TH>Zp_H</TH><TH>Zp_S</TH><TH>Zp_W</TH><TH>Zp_R</TH><TH>Zp</TH><TH>Zq_T</TH><TH>Zq_H</TH><TH>Zq_S</TH><TH>Zq_W</TH><TH>Zq_R</TH><TH>Zq</TH><TH>Im_T</TH><TH>Im_H</TH><TH>Im_S</TH><TH>Im_W</TH><TH>Im_R</TH><TH>Im</TH><TH>Ia_T</TH><TH>Ia_H</TH><TH>Ia_S</TH><TH>Ia_W</TH><TH>Ia_R</TH><TH>Ia</TH><TH>Pp_T</TH><TH>Pp_H</TH><TH>Pp_S</TH><TH>Pp_W</TH><TH>Pp_R</TH><TH>Pp</TH><TH>Pq_T</TH><TH>Pq_H</TH><TH>Pq_S</TH><TH>Pq_W</TH><TH>Pq_R</TH><TH>Pq</TH><TH>input_temp</TH><TH>input_humid</TH><TH>input_solar</TH><TH>input_wind</TH><TH>input_rain</TH><TH>output_imped_p</TH><TH>output_imped_q</TH><TH>output_current_m</TH><TH>output_current_a</TH><TH>output_power_p</TH><TH>output_power_q</TH><TH>output_impedance</TH><TH>output_current</TH><TH>output_power</TH><TH>load_class</TH><TH>constant_power_A</TH><TH>constant_power_B</TH><TH>constant_power_C</TH><TH>constant_current_A</TH><TH>constant_current_B</TH><TH>constant_current_C</TH><TH>constant_impedance_A</TH><TH>constant_impedance_B</TH><TH>constant_impedance_C</TH><TH>measured_voltage_A</TH><TH>measured_voltage_B</TH><TH>measured_voltage_C</TH><TH>measured_voltage_AB</TH><TH>measured_voltage_BC</TH><TH>measured_voltage_CA</TH><TH>bustype</TH><TH>busflags</TH><TH>reference_bus</TH><TH>maximum_voltage_error</TH><TH>voltage_A</TH><TH>voltage_B</TH><TH>voltage_C</TH><TH>voltage_AB</TH><TH>voltage_BC</TH><TH>voltage_CA</TH><TH>current_A</TH><TH>current_B</TH><TH>current_C</TH><TH>power_A</TH><TH>power_B</TH><TH>power_C</TH><TH>shunt_A</TH><TH>shunt_B</TH><TH>shunt_C</TH><TH>phases</TH><TH>nominal_voltage</TH></TR>
<xsl:for-each select="powerflow/pqload_list/pqload"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><a href="#{weather}"><xsl:value-of select="weather"/></a></TD><TD><xsl:value-of select="T_nominal"/></TD><TD><xsl:value-of select="Zp_T"/></TD><TD><xsl:value-of select="Zp_H"/></TD><TD><xsl:value-of select="Zp_S"/></TD><TD><xsl:value-of select="Zp_W"/></TD><TD><xsl:value-of select="Zp_R"/></TD><TD><xsl:value-of select="Zp"/></TD><TD><xsl:value-of select="Zq_T"/></TD><TD><xsl:value-of select="Zq_H"/></TD><TD><xsl:value-of select="Zq_S"/></TD><TD><xsl:value-of select="Zq_W"/></TD><TD><xsl:value-of select="Zq_R"/></TD><TD><xsl:value-of select="Zq"/></TD><TD><xsl:value-of select="Im_T"/></TD><TD><xsl:value-of select="Im_H"/></TD><TD><xsl:value-of select="Im_S"/></TD><TD><xsl:value-of select="Im_W"/></TD><TD><xsl:value-of select="Im_R"/></TD><TD><xsl:value-of select="Im"/></TD><TD><xsl:value-of select="Ia_T"/></TD><TD><xsl:value-of select="Ia_H"/></TD><TD><xsl:value-of select="Ia_S"/></TD><TD><xsl:value-of select="Ia_W"/></TD><TD><xsl:value-of select="Ia_R"/></TD><TD><xsl:value-of select="Ia"/></TD><TD><xsl:value-of select="Pp_T"/></TD><TD><xsl:value-of select="Pp_H"/></TD><TD><xsl:value-of select="Pp_S"/></TD><TD><xsl:value-of select="Pp_W"/></TD><TD><xsl:value-of select="Pp_R"/></TD><TD><xsl:value-of select="Pp"/></TD><TD><xsl:value-of select="Pq_T"/></TD><TD><xsl:value-of select="Pq_H"/></TD><TD><xsl:value-of select="Pq_S"/></TD><TD><xsl:value-of select="Pq_W"/></TD><TD><xsl:value-of select="Pq_R"/></TD><TD><xsl:value-of select="Pq"/></TD><TD><xsl:value-of select="input_temp"/></TD><TD><xsl:value-of select="input_humid"/></TD><TD><xsl:value-of select="input_solar"/></TD><TD><xsl:value-of select="input_wind"/></TD><TD><xsl:value-of select="input_rain"/></TD><TD><xsl:value-of select="output_imped_p"/></TD><TD><xsl:value-of select="output_imped_q"/></TD><TD><xsl:value-of select="output_current_m"/></TD><TD><xsl:value-of select="output_current_a"/></TD><TD><xsl:value-of select="output_power_p"/></TD><TD><xsl:value-of select="output_power_q"/></TD><TD><xsl:value-of select="output_impedance"/></TD><TD><xsl:value-of select="output_current"/></TD><TD><xsl:value-of select="output_power"/></TD><TD><xsl:value-of select="load_class"/></TD><TD><xsl:value-of select="constant_power_A"/></TD><TD><xsl:value-of select="constant_power_B"/></TD><TD><xsl:value-of select="constant_power_C"/></TD><TD><xsl:value-of select="constant_current_A"/></TD><TD><xsl:value-of select="constant_current_B"/></TD><TD><xsl:value-of select="constant_current_C"/></TD><TD><xsl:value-of select="constant_impedance_A"/></TD><TD><xsl:value-of select="constant_impedance_B"/></TD><TD><xsl:value-of select="constant_impedance_C"/></TD><TD><xsl:value-of select="measured_voltage_A"/></TD><TD><xsl:value-of select="measured_voltage_B"/></TD><TD><xsl:value-of select="measured_voltage_C"/></TD><TD><xsl:value-of select="measured_voltage_AB"/></TD><TD><xsl:value-of select="measured_voltage_BC"/></TD><TD><xsl:value-of select="measured_voltage_CA"/></TD><TD><xsl:value-of select="bustype"/></TD><TD><xsl:value-of select="busflags"/></TD><TD><a href="#{reference_bus}"><xsl:value-of select="reference_bus"/></a></TD><TD><xsl:value-of select="maximum_voltage_error"/></TD><TD><xsl:value-of select="voltage_A"/></TD><TD><xsl:value-of select="voltage_B"/></TD><TD><xsl:value-of select="voltage_C"/></TD><TD><xsl:value-of select="voltage_AB"/></TD><TD><xsl:value-of select="voltage_BC"/></TD><TD><xsl:value-of select="voltage_CA"/></TD><TD><xsl:value-of select="current_A"/></TD><TD><xsl:value-of select="current_B"/></TD><TD><xsl:value-of select="current_C"/></TD><TD><xsl:value-of select="power_A"/></TD><TD><xsl:value-of select="power_B"/></TD><TD><xsl:value-of select="power_C"/></TD><TD><xsl:value-of select="shunt_A"/></TD><TD><xsl:value-of select="shunt_B"/></TD><TD><xsl:value-of select="shunt_C"/></TD><TD><xsl:value-of select="phases"/></TD><TD><xsl:value-of select="nominal_voltage"/></TD></TR>
</xsl:for-each></TABLE>
...
<TR><TH>Name</TH><TH>floor_area</TH><TH>gross_wall_area</TH><TH>ceiling_height</TH><TH>aspect_ratio</TH><TH>envelope_UA</TH><TH>window_wall_ratio</TH><TH>glazing_shgc</TH><TH>airchange_per_hour</TH><TH>internal_gain</TH><TH>solar_gain</TH><TH>heat_cool_gain</TH><TH>thermostat_deadband</TH><TH>heating_setpoint</TH><TH>cooling_setpoint</TH><TH>design_heating_capacity</TH><TH>design_cooling_capacity</TH><TH>heating_COP</TH><TH>cooling_COP</TH><TH>COP_coeff</TH><TH>air_temperature</TH><TH>outside_temp</TH><TH>mass_temperature</TH><TH>mass_heat_coeff</TH><TH>outdoor_temperature</TH><TH>heat_mode</TH><TH>hc_mode</TH><TH>total_load</TH><TH>enduse_load</TH><TH>power</TH><TH>current</TH><TH>admittance</TH><TH>energy</TH></TR>
<xsl:for-each select="residential/house_list/house"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="floor_area"/></TD><TD><xsl:value-of select="gross_wall_area"/></TD><TD><xsl:value-of select="ceiling_height"/></TD><TD><xsl:value-of select="aspect_ratio"/></TD><TD><xsl:value-of select="envelope_UA"/></TD><TD><xsl:value-of select="window_wall_ratio"/></TD><TD><xsl:value-of select="glazing_shgc"/></TD><TD><xsl:value-of select="airchange_per_hour"/></TD><TD><xsl:value-of select="internal_gain"/></TD><TD><xsl:value-of select="solar_gain"/></TD><TD><xsl:value-of select="heat_cool_gain"/></TD><TD><xsl:value-of select="thermostat_deadband"/></TD><TD><xsl:value-of select="heating_setpoint"/></TD><TD><xsl:value-of select="cooling_setpoint"/></TD><TD><xsl:value-of select="design_heating_capacity"/></TD><TD><xsl:value-of select="design_cooling_capacity"/></TD><TD><xsl:value-of select="heating_COP"/></TD><TD><xsl:value-of select="cooling_COP"/></TD><TD><xsl:value-of select="COP_coeff"/></TD><TD><xsl:value-of select="air_temperature"/></TD><TD><xsl:value-of select="outside_temp"/></TD><TD><xsl:value-of select="mass_temperature"/></TD><TD><xsl:value-of select="mass_heat_coeff"/></TD><TD><xsl:value-of select="outdoor_temperature"/></TD><TD><xsl:value-of select="heat_mode"/></TD><TD><xsl:value-of select="hc_mode"/></TD><TD><xsl:value-of select="total_load"/></TD><TD><xsl:value-of select="enduse_load"/></TD><TD><xsl:value-of select="power"/></TD><TD><xsl:value-of select="current"/></TD><TD><xsl:value-of select="admittance"/></TD><TD><xsl:value-of select="energy"/></TD></TR>
</xsl:for-each></TABLE>
<H4>house_e objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>floor_area</TH><TH>gross_wall_area</TH><TH>ceiling_height</TH><TH>aspect_ratio</TH><TH>envelope_UA</TH><TH>window_wall_ratio</TH><TH>glazing_shgc</TH><TH>airchange_per_hour</TH><TH>internal_gain</TH><TH>solar_gain</TH><TH>heat_cool_gain</TH><TH>thermostat_deadband</TH><TH>heating_setpoint</TH><TH>cooling_setpoint</TH><TH>design_heating_capacity</TH><TH>design_cooling_capacity</TH><TH>cooling_design_temperature</TH><TH>heating_design_temperature</TH><TH>design_peak_solar</TH><TH>design_internal_gains</TH><TH>heating_COP</TH><TH>cooling_COP</TH><TH>COP_coeff</TH><TH>air_temperature</TH><TH>outdoor_temperature</TH><TH>mass_heat_capacity</TH><TH>mass_heat_coeff</TH><TH>mass_temperature</TH><TH>heat_mode</TH><TH>total_load</TH><TH>enduse_load</TH><TH>power</TH><TH>current</TH><TH>admittance</TH><TH>energy</TH><TH>hc_mode</TH><TH>Rroof</TH><TH>Rwall</TH><TH>Rfloor</TH><TH>Rwindows</TH><TH>clotheswasher.current_fraction</TH><TH>clotheswasher.demand</TH><TH>clotheswasher.energy</TH><TH>clotheswasher.heatgain</TH><TH>clotheswasher.heatgain_fraction</TH><TH>clotheswasher.impedance_fraction</TH><TH>clotheswasher.power</TH><TH>clotheswasher.power_factor</TH><TH>clotheswasher.power_fraction</TH><TH>clotheswasher.shape</TH><TH>clotheswasher.load</TH><TH>clotheswasher.voltage_factor</TH><TH>dishwasher.current_fraction</TH><TH>dishwasher.demand</TH><TH>dishwasher.energy</TH><TH>dishwasher.heatgain</TH><TH>dishwasher.heatgain_fraction</TH><TH>dishwasher.impedance_fraction</TH><TH>dishwasher.power</TH><TH>dishwasher.power_factor</TH><TH>dishwasher.power_fraction</TH><TH>dishwasher.shape</TH><TH>dishwasher.load</TH><TH>dishwasher.voltage_factor</TH><TH>dryer.current_fraction</TH><TH>dryer.demand</TH><TH>dryer.energy</TH><TH>dryer.heatgain</TH><TH>dryer.heatgain_fraction</TH><TH>dryer.impedance_fraction</TH><TH>dryer.power</TH><TH>dryer.power_factor</TH><TH>dryer.power_fraction</TH><TH>dryer.shape</TH><TH>dryer.load</TH><TH>dryer.voltage_factor</TH><TH>freezer.current_fraction</TH><TH>freezer.demand</TH><TH>freezer.energy</TH><TH>freezer.heatgain</TH><TH>freezer.heatgain_fraction</TH><TH>freezer.impedance_fraction</TH><TH>freezer.power</TH><TH>freezer.power_factor</TH><TH>freezer.power_fraction</TH><TH>freezer.shape</TH><TH>freezer.load</TH><TH>freezer.voltage_factor</TH><TH>light.current_fraction</TH><TH>light.demand</TH><TH>light.energy</TH><TH>light.heatgain</TH><TH>light.heatgain_fraction</TH><TH>light.impedance_fraction</TH><TH>light.power</TH><TH>light.power_factor</TH><TH>light.power_fraction</TH><TH>light.shape</TH><TH>light.load</TH><TH>light.voltage_factor</TH><TH>microwave.current_fraction</TH><TH>microwave.demand</TH><TH>microwave.energy</TH><TH>microwave.heatgain</TH><TH>microwave.heatgain_fraction</TH><TH>microwave.impedance_fraction</TH><TH>microwave.power</TH><TH>microwave.power_factor</TH><TH>microwave.power_fraction</TH><TH>microwave.shape</TH><TH>microwave.load</TH><TH>microwave.voltage_factor</TH><TH>occupants.current_fraction</TH><TH>occupants.demand</TH><TH>occupants.energy</TH><TH>occupants.heatgain</TH><TH>occupants.heatgain_fraction</TH><TH>occupants.impedance_fraction</TH><TH>occupants.power</TH><TH>occupants.power_factor</TH><TH>occupants.power_fraction</TH><TH>occupants.shape</TH><TH>occupants.load</TH><TH>occupants.voltage_factor</TH><TH>plugs.current_fraction</TH><TH>plugs.demand</TH><TH>plugs.energy</TH><TH>plugs.heatgain</TH><TH>plugs.heatgain_fraction</TH><TH>plugs.impedance_fraction</TH><TH>plugs.power</TH><TH>plugs.power_factor</TH><TH>plugs.power_fraction</TH><TH>plugs.shape</TH><TH>plugs.load</TH><TH>plugs.voltage_factor</TH><TH>refrigerator.current_fraction</TH><TH>refrigerator.demand</TH><TH>refrigerator.energy</TH><TH>refrigerator.heatgain</TH><TH>refrigerator.heatgain_fraction</TH><TH>refrigerator.impedance_fraction</TH><TH>refrigerator.power</TH><TH>refrigerator.power_factor</TH><TH>refrigerator.power_fraction</TH><TH>refrigerator.shape</TH><TH>refrigerator.load</TH><TH>refrigerator.voltage_factor</TH></TR>
<xsl:for-each select="residential/house_e_list/house_e"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="floor_area"/></TD><TD><xsl:value-of select="gross_wall_area"/></TD><TD><xsl:value-of select="ceiling_height"/></TD><TD><xsl:value-of select="aspect_ratio"/></TD><TD><xsl:value-of select="envelope_UA"/></TD><TD><xsl:value-of select="window_wall_ratio"/></TD><TD><xsl:value-of select="glazing_shgc"/></TD><TD><xsl:value-of select="airchange_per_hour"/></TD><TD><xsl:value-of select="internal_gain"/></TD><TD><xsl:value-of select="solar_gain"/></TD><TD><xsl:value-of select="heat_cool_gain"/></TD><TD><xsl:value-of select="thermostat_deadband"/></TD><TD><xsl:value-of select="heating_setpoint"/></TD><TD><xsl:value-of select="cooling_setpoint"/></TD><TD><xsl:value-of select="design_heating_capacity"/></TD><TD><xsl:value-of select="design_cooling_capacity"/></TD><TD><xsl:value-of select="cooling_design_temperature"/></TD><TD><xsl:value-of select="heating_design_temperature"/></TD><TD><xsl:value-of select="design_peak_solar"/></TD><TD><xsl:value-of select="design_internal_gains"/></TD><TD><xsl:value-of select="heating_COP"/></TD><TD><xsl:value-of select="cooling_COP"/></TD><TD><xsl:value-of select="COP_coeff"/></TD><TD><xsl:value-of select="air_temperature"/></TD><TD><xsl:value-of select="outdoor_temperature"/></TD><TD><xsl:value-of select="mass_heat_capacity"/></TD><TD><xsl:value-of select="mass_heat_coeff"/></TD><TD><xsl:value-of select="mass_temperature"/></TD><TD><xsl:value-of select="heat_mode"/></TD><TD><xsl:value-of select="total_load"/></TD><TD><xsl:value-of select="enduse_load"/></TD><TD><xsl:value-of select="power"/></TD><TD><xsl:value-of select="current"/></TD><TD><xsl:value-of select="admittance"/></TD><TD><xsl:value-of select="energy"/></TD><TD><xsl:value-of select="hc_mode"/></TD><TD><xsl:value-of select="Rroof"/></TD><TD><xsl:value-of select="Rwall"/></TD><TD><xsl:value-of select="Rfloor"/></TD><TD><xsl:value-of select="Rwindows"/></TD><TD><xsl:value-of select="clotheswasher.current_fraction"/></TD><TD><xsl:value-of select="clotheswasher.demand"/></TD><TD><xsl:value-of select="clotheswasher.energy"/></TD><TD><xsl:value-of select="clotheswasher.heatgain"/></TD><TD><xsl:value-of select="clotheswasher.heatgain_fraction"/></TD><TD><xsl:value-of select="clotheswasher.impedance_fraction"/></TD><TD><xsl:value-of select="clotheswasher.power"/></TD><TD><xsl:value-of select="clotheswasher.power_factor"/></TD><TD><xsl:value-of select="clotheswasher.power_fraction"/></TD><TD><xsl:value-of select="clotheswasher.shape"/></TD><TD><xsl:value-of select="clotheswasher.load"/></TD><TD><xsl:value-of select="clotheswasher.voltage_factor"/></TD><TD><xsl:value-of select="dishwasher.current_fraction"/></TD><TD><xsl:value-of select="dishwasher.demand"/></TD><TD><xsl:value-of select="dishwasher.energy"/></TD><TD><xsl:value-of select="dishwasher.heatgain"/></TD><TD><xsl:value-of select="dishwasher.heatgain_fraction"/></TD><TD><xsl:value-of select="dishwasher.impedance_fraction"/></TD><TD><xsl:value-of select="dishwasher.power"/></TD><TD><xsl:value-of select="dishwasher.power_factor"/></TD><TD><xsl:value-of select="dishwasher.power_fraction"/></TD><TD><xsl:value-of select="dishwasher.shape"/></TD><TD><xsl:value-of select="dishwasher.load"/></TD><TD><xsl:value-of select="dishwasher.voltage_factor"/></TD><TD><xsl:value-of select="dryer.current_fraction"/></TD><TD><xsl:value-of select="dryer.demand"/></TD><TD><xsl:value-of select="dryer.energy"/></TD><TD><xsl:value-of select="dryer.heatgain"/></TD><TD><xsl:value-of select="dryer.heatgain_fraction"/></TD><TD><xsl:value-of select="dryer.impedance_fraction"/></TD><TD><xsl:value-of select="dryer.power"/></TD><TD><xsl:value-of select="dryer.power_factor"/></TD><TD><xsl:value-of select="dryer.power_fraction"/></TD><TD><xsl:value-of select="dryer.shape"/></TD><TD><xsl:value-of select="dryer.load"/></TD><TD><xsl:value-of select="dryer.voltage_factor"/></TD><TD><xsl:value-of select="freezer.current_fraction"/></TD><TD><xsl:value-of select="freezer.demand"/></TD><TD><xsl:value-of select="freezer.energy"/></TD><TD><xsl:value-of select="freezer.heatgain"/></TD><TD><xsl:value-of select="freezer.heatgain_fraction"/></TD><TD><xsl:value-of select="freezer.impedance_fraction"/></TD><TD><xsl:value-of select="freezer.power"/></TD><TD><xsl:value-of select="freezer.power_factor"/></TD><TD><xsl:value-of select="freezer.power_fraction"/></TD><TD><xsl:value-of select="freezer.shape"/></TD><TD><xsl:value-of select="freezer.load"/></TD><TD><xsl:value-of select="freezer.voltage_factor"/></TD><TD><xsl:value-of select="light.current_fraction"/></TD><TD><xsl:value-of select="light.demand"/></TD><TD><xsl:value-of select="light.energy"/></TD><TD><xsl:value-of select="light.heatgain"/></TD><TD><xsl:value-of select="light.heatgain_fraction"/></TD><TD><xsl:value-of select="light.impedance_fraction"/></TD><TD><xsl:value-of select="light.power"/></TD><TD><xsl:value-of select="light.power_factor"/></TD><TD><xsl:value-of select="light.power_fraction"/></TD><TD><xsl:value-of select="light.shape"/></TD><TD><xsl:value-of select="light.load"/></TD><TD><xsl:value-of select="light.voltage_factor"/></TD><TD><xsl:value-of select="microwave.current_fraction"/></TD><TD><xsl:value-of select="microwave.demand"/></TD><TD><xsl:value-of select="microwave.energy"/></TD><TD><xsl:value-of select="microwave.heatgain"/></TD><TD><xsl:value-of select="microwave.heatgain_fraction"/></TD><TD><xsl:value-of select="microwave.impedance_fraction"/></TD><TD><xsl:value-of select="microwave.power"/></TD><TD><xsl:value-of select="microwave.power_factor"/></TD><TD><xsl:value-of select="microwave.power_fraction"/></TD><TD><xsl:value-of select="microwave.shape"/></TD><TD><xsl:value-of select="microwave.load"/></TD><TD><xsl:value-of select="microwave.voltage_factor"/></TD><TD><xsl:value-of select="occupants.current_fraction"/></TD><TD><xsl:value-of select="occupants.demand"/></TD><TD><xsl:value-of select="occupants.energy"/></TD><TD><xsl:value-of select="occupants.heatgain"/></TD><TD><xsl:value-of select="occupants.heatgain_fraction"/></TD><TD><xsl:value-of select="occupants.impedance_fraction"/></TD><TD><xsl:value-of select="occupants.power"/></TD><TD><xsl:value-of select="occupants.power_factor"/></TD><TD><xsl:value-of select="occupants.power_fraction"/></TD><TD><xsl:value-of select="occupants.shape"/></TD><TD><xsl:value-of select="occupants.load"/></TD><TD><xsl:value-of select="occupants.voltage_factor"/></TD><TD><xsl:value-of select="plugs.current_fraction"/></TD><TD><xsl:value-of select="plugs.demand"/></TD><TD><xsl:value-of select="plugs.energy"/></TD><TD><xsl:value-of select="plugs.heatgain"/></TD><TD><xsl:value-of select="plugs.heatgain_fraction"/></TD><TD><xsl:value-of select="plugs.impedance_fraction"/></TD><TD><xsl:value-of select="plugs.power"/></TD><TD><xsl:value-of select="plugs.power_factor"/></TD><TD><xsl:value-of select="plugs.power_fraction"/></TD><TD><xsl:value-of select="plugs.shape"/></TD><TD><xsl:value-of select="plugs.load"/></TD><TD><xsl:value-of select="plugs.voltage_factor"/></TD><TD><xsl:value-of select="refrigerator.current_fraction"/></TD><TD><xsl:value-of select="refrigerator.demand"/></TD><TD><xsl:value-of select="refrigerator.energy"/></TD><TD><xsl:value-of select="refrigerator.heatgain"/></TD><TD><xsl:value-of select="refrigerator.heatgain_fraction"/></TD><TD><xsl:value-of select="refrigerator.impedance_fraction"/></TD><TD><xsl:value-of select="refrigerator.power"/></TD><TD><xsl:value-of select="refrigerator.power_factor"/></TD><TD><xsl:value-of select="refrigerator.power_fraction"/></TD><TD><xsl:value-of select="refrigerator.shape"/></TD><TD><xsl:value-of select="refrigerator.load"/></TD><TD><xsl:value-of select="refrigerator.voltage_factor"/></TD></TR>
</xsl:for-each></TABLE>
<H4>waterheater objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>tank_volume</TH><TH>tank_UA</TH><TH>tank_diameter</TH><TH>water_demand</TH><TH>heating_element_capacity</TH><TH>inlet_water_temperature</TH><TH>heat_mode</TH><TH>location</TH><TH>tank_setpoint</TH><TH>thermostat_deadband</TH><TH>meter</TH><TH>temperature</TH><TH>height</TH><TH>faux_gain</TH><TH>enduse_load</TH><TH>constant_power</TH><TH>constant_current</TH><TH>constant_admittance</TH><TH>energy_meter</TH><TH>internal_gains</TH></TR>
<xsl:for-each select="residential/waterheater_list/waterheater"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="tank_volume"/></TD><TD><xsl:value-of select="tank_UA"/></TD><TD><xsl:value-of select="tank_diameter"/></TD><TD><xsl:value-of select="water_demand"/></TD><TD><xsl:value-of select="heating_element_capacity"/></TD><TD><xsl:value-of select="inlet_water_temperature"/></TD><TD><xsl:value-of select="heat_mode"/></TD><TD><xsl:value-of select="location"/></TD><TD><xsl:value-of select="tank_setpoint"/></TD><TD><xsl:value-of select="thermostat_deadband"/></TD><TD><xsl:value-of select="meter"/></TD><TD><xsl:value-of select="temperature"/></TD><TD><xsl:value-of select="height"/></TD><TD><xsl:value-of select="faux_gain"/></TD><TD><xsl:value-of select="enduse_load"/></TD><TD><xsl:value-of select="constant_power"/></TD><TD><xsl:value-of select="constant_current"/></TD><TD><xsl:value-of select="constant_admittance"/></TD><TD><xsl:value-of select="energy_meter"/></TD><TD><xsl:value-of select="internal_gains"/></TD></TR>
</xsl:for-each></TABLE>
<H4>lights objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>type</TH><TH>placement</TH><TH>installed_power</TH><TH>circuit_split</TH><TH>demand</TH><TH>enduse_load</TH><TH>constant_power</TH><TH>constant_current</TH><TH>constant_admittance</TH><TH>internal_gains</TH><TH>energy_meter</TH></TR>
...
<TR><TH>Name</TH><TH>number_of_occupants</TH><TH>enduse_load</TH><TH>occupancy_fraction</TH><TH>heatgain_per_person</TH><TH>internal_gains</TH></TR>
<xsl:for-each select="residential/occupantload_list/occupantload"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="number_of_occupants"/></TD><TD><xsl:value-of select="enduse_load"/></TD><TD><xsl:value-of select="occupancy_fraction"/></TD><TD><xsl:value-of select="heatgain_per_person"/></TD><TD><xsl:value-of select="internal_gains"/></TD></TR>
</xsl:for-each></TABLE>
<H4>plugload objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>circuit_split</TH><TH>demand</TH><TH>enduse_load</TH><TH>constant_power</TH><TH>constant_current</TH><TH>constant_admittance</TH><TH>internal_gains</TH><TH>energy_meter</TH><TH>heat_fraction</TH></TR>
...
<TR><TH>Name</TH><TH>installed_power</TH><TH>standby_power</TH><TH>circuit_split</TH><TH>demand</TH><TH>enduse_load</TH><TH>constant_power</TH><TH>constant_current</TH><TH>constant_admittance</TH><TH>internal_gains</TH><TH>energy_meter</TH><TH>heat_fraction</TH><TH>cycle_length</TH><TH>state</TH><TH>runtime</TH><TH>state_time</TH></TR>
<xsl:for-each select="residential/microwave_list/microwave"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="installed_power"/></TD><TD><xsl:value-of select="standby_power"/></TD><TD><xsl:value-of select="circuit_split"/></TD><TD><xsl:value-of select="demand"/></TD><TD><xsl:value-of select="enduse_load"/></TD><TD><xsl:value-of select="constant_power"/></TD><TD><xsl:value-of select="constant_current"/></TD><TD><xsl:value-of select="constant_admittance"/></TD><TD><xsl:value-of select="internal_gains"/></TD><TD><xsl:value-of select="energy_meter"/></TD><TD><xsl:value-of select="heat_fraction"/></TD><TD><xsl:value-of select="cycle_length"/></TD><TD><xsl:value-of select="state"/></TD><TD><xsl:value-of select="runtime"/></TD><TD><xsl:value-of select="state_time"/></TD></TR>
</xsl:for-each></TABLE>
...
</xsl:if><xsl:if test="direction_A">	direction_A <xsl:value-of select="direction_A"/>;
</xsl:if><xsl:if test="direction_B">	direction_B <xsl:value-of select="direction_B"/>;
</xsl:if><xsl:if test="direction_C">	direction_C <xsl:value-of select="direction_C"/>;
</xsl:if>}
</xsl:for-each>
...
# residential::house_e objects
<xsl:for-each select="house_e_list/house_e"><a name="#GLM.{name}"/>object house_e:<xsl:value-of select="id"/> {
<xsl:if test="name!=''">	name "<xsl:value-of select="name"/>";
</xsl:if><xsl:if test="parent!=''">	parent "<a href="#GLM.{parent}"><xsl:value-of select="parent"/></a>";
</xsl:if><xsl:if test="clock!=''">	clock '<xsl:value-of select="clock"/>';
</xsl:if><xsl:if test="in_svc!=''">	in_svc '<xsl:value-of select="in_svc"/>';
...
</xsl:if><xsl:if test="clotheswasher.current_fraction">	clotheswasher.current_fraction <xsl:value-of select="clotheswasher.current_fraction"/>;
</xsl:if><xsl:if test="clotheswasher.demand">	clotheswasher.demand <xsl:value-of select="clotheswasher.demand"/>;
</xsl:if><xsl:if test="clotheswasher.energy">	clotheswasher.energy <xsl:value-of select="clotheswasher.energy"/>;
</xsl:if><xsl:if test="clotheswasher.heatgain">	clotheswasher.heatgain <xsl:value-of select="clotheswasher.heatgain"/>;
</xsl:if><xsl:if test="clotheswasher.heatgain_fraction">	clotheswasher.heatgain_fraction <xsl:value-of select="clotheswasher.heatgain_fraction"/>;
</xsl:if><xsl:if test="clotheswasher.impedance_fraction">	clotheswasher.impedance_fraction <xsl:value-of select="clotheswasher.impedance_fraction"/>;
</xsl:if><xsl:if test="clotheswasher.power">	clotheswasher.power <xsl:value-of select="clotheswasher.power"/>;
</xsl:if><xsl:if test="clotheswasher.power_factor">	clotheswasher.power_factor <xsl:value-of select="clotheswasher.power_factor"/>;
</xsl:if><xsl:if test="clotheswasher.power_fraction">	clotheswasher.power_fraction <xsl:value-of select="clotheswasher.power_fraction"/>;
</xsl:if><xsl:if test="clotheswasher.shape">	clotheswasher.shape <xsl:value-of select="clotheswasher.shape"/>;
</xsl:if><xsl:if test="clotheswasher.load">	clotheswasher.load <xsl:value-of select="clotheswasher.load"/>;
</xsl:if><xsl:if test="clotheswasher.voltage_factor">	clotheswasher.voltage_factor <xsl:value-of select="clotheswasher.voltage_factor"/>;
</xsl:if><xsl:if test="dishwasher.current_fraction">	dishwasher.current_fraction <xsl:value-of select="dishwasher.current_fraction"/>;
</xsl:if><xsl:if test="dishwasher.demand">	dishwasher.demand <xsl:value-of select="dishwasher.demand"/>;
</xsl:if><xsl:if test="dishwasher.energy">	dishwasher.energy <xsl:value-of select="dishwasher.energy"/>;
</xsl:if><xsl:if test="dishwasher.heatgain">	dishwasher.heatgain <xsl:value-of select="dishwasher.heatgain"/>;
</xsl:if><xsl:if test="dishwasher.heatgain_fraction">	dishwasher.heatgain_fraction <xsl:value-of select="dishwasher.heatgain_fraction"/>;
</xsl:if><xsl:if test="dishwasher.impedance_fraction">	dishwasher.impedance_fraction <xsl:value-of select="dishwasher.impedance_fraction"/>;
</xsl:if><xsl:if test="dishwasher.power">	dishwasher.power <xsl:value-of select="dishwasher.power"/>;
</xsl:if><xsl:if test="dishwasher.power_factor">	dishwasher.power_factor <xsl:value-of select="dishwasher.power_factor"/>;
</xsl:if><xsl:if test="dishwasher.power_fraction">	dishwasher.power_fraction <xsl:value-of select="dishwasher.power_fraction"/>;
</xsl:if><xsl:if test="dishwasher.shape">	dishwasher.shape <xsl:value-of select="dishwasher.shape"/>;
</xsl:if><xsl:if test="dishwasher.load">	dishwasher.load <xsl:value-of select="dishwasher.load"/>;
</xsl:if><xsl:if test="dishwasher.voltage_factor">	dishwasher.voltage_factor <xsl:value-of select="dishwasher.voltage_factor"/>;
</xsl:if><xsl:if test="dryer.current_fraction">	dryer.current_fraction <xsl:value-of select="dryer.current_fraction"/>;
</xsl:if><xsl:if test="dryer.demand">	dryer.demand <xsl:value-of select="dryer.demand"/>;
</xsl:if><xsl:if test="dryer.energy">	dryer.energy <xsl:value-of select="dryer.energy"/>;
</xsl:if><xsl:if test="dryer.heatgain">	dryer.heatgain <xsl:value-of select="dryer.heatgain"/>;
</xsl:if><xsl:if test="dryer.heatgain_fraction">	dryer.heatgain_fraction <xsl:value-of select="dryer.heatgain_fraction"/>;
</xsl:if><xsl:if test="dryer.impedance_fraction">	dryer.impedance_fraction <xsl:value-of select="dryer.impedance_fraction"/>;
</xsl:if><xsl:if test="dryer.power">	dryer.power <xsl:value-of select="dryer.power"/>;
</xsl:if><xsl:if test="dryer.power_factor">	dryer.power_factor <xsl:value-of select="dryer.power_factor"/>;
</xsl:if><xsl:if test="dryer.power_fraction">	dryer.power_fraction <xsl:value-of select="dryer.power_fraction"/>;
</xsl:if><xsl:if test="dryer.shape">	dryer.shape <xsl:value-of select="dryer.shape"/>;
</xsl:if><xsl:if test="dryer.load">	dryer.load <xsl:value-of select="dryer.load"/>;
</xsl:if><xsl:if test="dryer.voltage_factor">	dryer.voltage_factor <xsl:value-of select="dryer.voltage_factor"/>;
</xsl:if><xsl:if test="freezer.current_fraction">	freezer.current_fraction <xsl:value-of select="freezer.current_fraction"/>;
</xsl:if><xsl:if test="freezer.demand">	freezer.demand <xsl:value-of select="freezer.demand"/>;
</xsl:if><xsl:if test="freezer.energy">	freezer.energy <xsl:value-of select="freezer.energy"/>;
</xsl:if><xsl:if test="freezer.heatgain">	freezer.heatgain <xsl:value-of select="freezer.heatgain"/>;
</xsl:if><xsl:if test="freezer.heatgain_fraction">	freezer.heatgain_fraction <xsl:value-of select="freezer.heatgain_fraction"/>;
</xsl:if><xsl:if test="freezer.impedance_fraction">	freezer.impedance_fraction <xsl:value-of select="freezer.impedance_fraction"/>;
</xsl:if><xsl:if test="freezer.power">	freezer.power <xsl:value-of select="freezer.power"/>;
</xsl:if><xsl:if test="freezer.power_factor">	freezer.power_factor <xsl:value-of select="freezer.power_factor"/>;
</xsl:if><xsl:if test="freezer.power_fraction">	freezer.power_fraction <xsl:value-of select="freezer.power_fraction"/>;
</xsl:if><xsl:if test="freezer.shape">	freezer.shape <xsl:value-of select="freezer.shape"/>;
</xsl:if><xsl:if test="freezer.load">	freezer.load <xsl:value-of select="freezer.load"/>;
</xsl:if><xsl:if test="freezer.voltage_factor">	freezer.voltage_factor <xsl:value-of select="freezer.voltage_factor"/>;
</xsl:if><xsl:if test="light.current_fraction">	light.current_fraction <xsl:value-of select="light.current_fraction"/>;
</xsl:if><xsl:if test="light.demand">	light.demand <xsl:value-of select="light.demand"/>;
</xsl:if><xsl:if test="light.energy">	light.energy <xsl:value-of select="light.energy"/>;
</xsl:if><xsl:if test="light.heatgain">	light.heatgain <xsl:value-of select="light.heatgain"/>;
</xsl:if><xsl:if test="light.heatgain_fraction">	light.heatgain_fraction <xsl:value-of select="light.heatgain_fraction"/>;
</xsl:if><xsl:if test="light.impedance_fraction">	light.impedance_fraction <xsl:value-of select="light.impedance_fraction"/>;
</xsl:if><xsl:if test="light.power">	light.power <xsl:value-of select="light.power"/>;
</xsl:if><xsl:if test="light.power_factor">	light.power_factor <xsl:value-of select="light.power_factor"/>;
</xsl:if><xsl:if test="light.power_fraction">	light.power_fraction <xsl:value-of select="light.power_fraction"/>;
</xsl:if><xsl:if test="light.shape">	light.shape <xsl:value-of select="light.shape"/>;
</xsl:if><xsl:if test="light.load">	light.load <xsl:value-of select="light.load"/>;
</xsl:if><xsl:if test="light.voltage_factor">	light.voltage_factor <xsl:value-of select="light.voltage_factor"/>;
</xsl:if><xsl:if test="microwave.current_fraction">	microwave.current_fraction <xsl:value-of select="microwave.current_fraction"/>;
</xsl:if><xsl:if test="microwave.demand">	microwave.demand <xsl:value-of select="microwave.demand"/>;
</xsl:if><xsl:if test="microwave.energy">	microwave.energy <xsl:value-of select="microwave.energy"/>;
</xsl:if><xsl:if test="microwave.heatgain">	microwave.heatgain <xsl:value-of select="microwave.heatgain"/>;
</xsl:if><xsl:if test="microwave.heatgain_fraction">	microwave.heatgain_fraction <xsl:value-of select="microwave.heatgain_fraction"/>;
</xsl:if><xsl:if test="microwave.impedance_fraction">	microwave.impedance_fraction <xsl:value-of select="microwave.impedance_fraction"/>;
</xsl:if><xsl:if test="microwave.power">	microwave.power <xsl:value-of select="microwave.power"/>;
</xsl:if><xsl:if test="microwave.power_factor">	microwave.power_factor <xsl:value-of select="microwave.power_factor"/>;
</xsl:if><xsl:if test="microwave.power_fraction">	microwave.power_fraction <xsl:value-of select="microwave.power_fraction"/>;
</xsl:if><xsl:if test="microwave.shape">	microwave.shape <xsl:value-of select="microwave.shape"/>;
</xsl:if><xsl:if test="microwave.load">	microwave.load <xsl:value-of select="microwave.load"/>;
</xsl:if><xsl:if test="microwave.voltage_factor">	microwave.voltage_factor <xsl:value-of select="microwave.voltage_factor"/>;
</xsl:if><xsl:if test="occupants.current_fraction">	occupants.current_fraction <xsl:value-of select="occupants.current_fraction"/>;
</xsl:if><xsl:if test="occupants.demand">	occupants.demand <xsl:value-of select="occupants.demand"/>;
</xsl:if><xsl:if test="occupants.energy">	occupants.energy <xsl:value-of select="occupants.energy"/>;
</xsl:if><xsl:if test="occupants.heatgain">	occupants.heatgain <xsl:value-of select="occupants.heatgain"/>;
</xsl:if><xsl:if test="occupants.heatgain_fraction">	occupants.heatgain_fraction <xsl:value-of select="occupants.heatgain_fraction"/>;
</xsl:if><xsl:if test="occupants.impedance_fraction">	occupants.impedance_fraction <xsl:value-of select="occupants.impedance_fraction"/>;
</xsl:if><xsl:if test="occupants.power">	occupants.power <xsl:value-of select="occupants.power"/>;
</xsl:if><xsl:if test="occupants.power_factor">	occupants.power_factor <xsl:value-of select="occupants.power_factor"/>;
</xsl:if><xsl:if test="occupants.power_fraction">	occupants.power_fraction <xsl:value-of select="occupants.power_fraction"/>;
</xsl:if><xsl:if test="occupants.shape">	occupants.shape <xsl:value-of select="occupants.shape"/>;
</xsl:if><xsl:if test="occupants.load">	occupants.load <xsl:value-of select="occupants.load"/>;
</xsl:if><xsl:if test="occupants.voltage_factor">	occupants.voltage_factor <xsl:value-of select="occupants.voltage_factor"/>;
</xsl:if><xsl:if test="plugs.current_fraction">	plugs.current_fraction <xsl:value-of select="plugs.current_fraction"/>;
</xsl:if><xsl:if test="plugs.demand">	plugs.demand <xsl:value-of select="plugs.demand"/>;
</xsl:if><xsl:if test="plugs.energy">	plugs.energy <xsl:value-of select="plugs.energy"/>;
...
</xsl:if><xsl:if test="plugs.impedance_fraction">	plugs.impedance_fraction <xsl:value-of select="plugs.impedance_fraction"/>;
</xsl:if><xsl:if test="plugs.power">	plugs.power <xsl:value-of select="plugs.power"/>;
</xsl:if><xsl:if test="plugs.power_factor">	plugs.power_factor <xsl:value-of select="plugs.power_factor"/>;
</xsl:if><xsl:if test="plugs.power_fraction">	plugs.power_fraction <xsl:value-of select="plugs.power_fraction"/>;
</xsl:if><xsl:if test="plugs.shape">	plugs.shape <xsl:value-of select="plugs.shape"/>;
</xsl:if><xsl:if test="plugs.load">	plugs.load <xsl:value-of select="plugs.load"/>;
</xsl:if><xsl:if test="plugs.voltage_factor">	plugs.voltage_factor <xsl:value-of select="plugs.voltage_factor"/>;
</xsl:if><xsl:if test="refrigerator.current_fraction">	refrigerator.current_fraction <xsl:value-of select="refrigerator.current_fraction"/>;
</xsl:if><xsl:if test="refrigerator.demand">	refrigerator.demand <xsl:value-of select="refrigerator.demand"/>;
</xsl:if><xsl:if test="refrigerator.energy">	refrigerator.energy <xsl:value-of select="refrigerator.energy"/>;
</xsl:if><xsl:if test="refrigerator.heatgain">	refrigerator.heatgain <xsl:value-of select="refrigerator.heatgain"/>;
</xsl:if><xsl:if test="refrigerator.heatgain_fraction">	refrigerator.heatgain_fraction <xsl:value-of select="refrigerator.heatgain_fraction"/>;
</xsl:if><xsl:if test="refrigerator.impedance_fraction">	refrigerator.impedance_fraction <xsl:value-of select="refrigerator.impedance_fraction"/>;
</xsl:if><xsl:if test="refrigerator.power">	refrigerator.power <xsl:value-of select="refrigerator.power"/>;
</xsl:if><xsl:if test="refrigerator.power_factor">	refrigerator.power_factor <xsl:value-of select="refrigerator.power_factor"/>;
</xsl:if><xsl:if test="refrigerator.power_fraction">	refrigerator.power_fraction <xsl:value-of select="refrigerator.power_fraction"/>;
</xsl:if><xsl:if test="refrigerator.shape">	refrigerator.shape <xsl:value-of select="refrigerator.shape"/>;
</xsl:if><xsl:if test="refrigerator.load">	refrigerator.load <xsl:value-of select="refrigerator.load"/>;
</xsl:if><xsl:if test="refrigerator.voltage_factor">	refrigerator.voltage_factor <xsl:value-of select="refrigerator.voltage_factor"/>;
</xsl:if>}
</xsl:for-each>
...
</xsl:if><xsl:if test="faux_gain">	faux_gain <xsl:value-of select="faux_gain"/>;
</xsl:if><xsl:if test="enduse_load">	enduse_load <xsl:value-of select="enduse_load"/>;

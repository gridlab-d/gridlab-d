...
<TR><TH>Name</TH><TH>type</TH><TH>unit</TH><TH>period</TH><TH>latency</TH><TH>market_id</TH><TH>last.Q</TH><TH>last.P</TH><TH>next.Q</TH><TH>next.P</TH><TH>avg24</TH><TH>std24</TH><TH>avg168</TH><TH>std168</TH><TH>network</TH></TR>
...
<TR><TH>Name</TH><TH>group</TH><TH>runtime</TH><TH>filename</TH></TR>
<xsl:for-each select="powerflow/voltdump_list/voltdump"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="group"/></TD><TD><xsl:value-of select="runtime"/></TD><TD><xsl:value-of select="filename"/></TD></TR>
</xsl:for-each></TABLE>

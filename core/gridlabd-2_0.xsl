...
<TR><TH>Name</TH><TH>floor_area</TH><TH>gross_wall_area</TH><TH>ceiling_height</TH><TH>aspect_ratio</TH><TH>envelope_UA</TH><TH>window_wall_ratio</TH><TH>glazing_shgc</TH><TH>airchange_per_hour</TH><TH>internal_gain</TH><TH>solar_gain</TH><TH>heat_cool_gain</TH><TH>thermostat_deadband</TH><TH>heating_setpoint</TH><TH>cooling_setpoint</TH><TH>design_heating_capacity</TH><TH>design_cooling_capacity</TH><TH>heating_COP</TH><TH>cooling_COP</TH><TH>COP_coeff</TH><TH>air_temperature</TH><TH>outside_temp</TH><TH>mass_temperature</TH><TH>mass_heat_coeff</TH><TH>outdoor_temperature</TH><TH>heat_mode</TH><TH>hc_mode</TH><TH>total_load</TH><TH>enduse_load</TH><TH>power</TH><TH>current</TH><TH>admittance</TH><TH>energy</TH><TH>total</TH><TH>total.energy</TH><TH>total.power</TH><TH>total.demand</TH><TH>total.heatgain</TH><TH>total.heatgain_fraction</TH><TH>total.current_fraction</TH><TH>total.impedance_fraction</TH><TH>total.power_fraction</TH><TH>total.power_factor</TH><TH>total.constant_power</TH><TH>total.constant_current</TH><TH>total.constant_admittance</TH><TH>total.voltage_factor</TH><TH>total.configuration</TH><TH>total.total</TH><TH>total.total_power</TH><TH>total.current</TH><TH>total.admittance</TH><TH>system</TH><TH>system.energy</TH><TH>system.power</TH><TH>system.demand</TH><TH>system.heatgain</TH><TH>system.heatgain_fraction</TH><TH>system.current_fraction</TH><TH>system.impedance_fraction</TH><TH>system.power_fraction</TH><TH>system.power_factor</TH><TH>system.constant_power</TH><TH>system.constant_current</TH><TH>system.constant_admittance</TH><TH>system.voltage_factor</TH><TH>system.configuration</TH><TH>system.total</TH><TH>system.total_power</TH><TH>system.current</TH><TH>system.admittance</TH></TR>
<xsl:for-each select="residential/house_list/house"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="floor_area"/></TD><TD><xsl:value-of select="gross_wall_area"/></TD><TD><xsl:value-of select="ceiling_height"/></TD><TD><xsl:value-of select="aspect_ratio"/></TD><TD><xsl:value-of select="envelope_UA"/></TD><TD><xsl:value-of select="window_wall_ratio"/></TD><TD><xsl:value-of select="glazing_shgc"/></TD><TD><xsl:value-of select="airchange_per_hour"/></TD><TD><xsl:value-of select="internal_gain"/></TD><TD><xsl:value-of select="solar_gain"/></TD><TD><xsl:value-of select="heat_cool_gain"/></TD><TD><xsl:value-of select="thermostat_deadband"/></TD><TD><xsl:value-of select="heating_setpoint"/></TD><TD><xsl:value-of select="cooling_setpoint"/></TD><TD><xsl:value-of select="design_heating_capacity"/></TD><TD><xsl:value-of select="design_cooling_capacity"/></TD><TD><xsl:value-of select="heating_COP"/></TD><TD><xsl:value-of select="cooling_COP"/></TD><TD><xsl:value-of select="COP_coeff"/></TD><TD><xsl:value-of select="air_temperature"/></TD><TD><xsl:value-of select="outside_temp"/></TD><TD><xsl:value-of select="mass_temperature"/></TD><TD><xsl:value-of select="mass_heat_coeff"/></TD><TD><xsl:value-of select="outdoor_temperature"/></TD><TD><xsl:value-of select="heat_mode"/></TD><TD><xsl:value-of select="hc_mode"/></TD><TD><xsl:value-of select="total_load"/></TD><TD><xsl:value-of select="enduse_load"/></TD><TD><xsl:value-of select="power"/></TD><TD><xsl:value-of select="current"/></TD><TD><xsl:value-of select="admittance"/></TD><TD><xsl:value-of select="energy"/></TD><TD><xsl:value-of select="total"/></TD><TD><xsl:value-of select="total.energy"/></TD><TD><xsl:value-of select="total.power"/></TD><TD><xsl:value-of select="total.demand"/></TD><TD><xsl:value-of select="total.heatgain"/></TD><TD><xsl:value-of select="total.heatgain_fraction"/></TD><TD><xsl:value-of select="total.current_fraction"/></TD><TD><xsl:value-of select="total.impedance_fraction"/></TD><TD><xsl:value-of select="total.power_fraction"/></TD><TD><xsl:value-of select="total.power_factor"/></TD><TD><xsl:value-of select="total.constant_power"/></TD><TD><xsl:value-of select="total.constant_current"/></TD><TD><xsl:value-of select="total.constant_admittance"/></TD><TD><xsl:value-of select="total.voltage_factor"/></TD><TD><xsl:value-of select="total.configuration"/></TD><TD><xsl:value-of select="total.total"/></TD><TD><xsl:value-of select="total.total_power"/></TD><TD><xsl:value-of select="total.current"/></TD><TD><xsl:value-of select="total.admittance"/></TD><TD><xsl:value-of select="system"/></TD><TD><xsl:value-of select="system.energy"/></TD><TD><xsl:value-of select="system.power"/></TD><TD><xsl:value-of select="system.demand"/></TD><TD><xsl:value-of select="system.heatgain"/></TD><TD><xsl:value-of select="system.heatgain_fraction"/></TD><TD><xsl:value-of select="system.current_fraction"/></TD><TD><xsl:value-of select="system.impedance_fraction"/></TD><TD><xsl:value-of select="system.power_fraction"/></TD><TD><xsl:value-of select="system.power_factor"/></TD><TD><xsl:value-of select="system.constant_power"/></TD><TD><xsl:value-of select="system.constant_current"/></TD><TD><xsl:value-of select="system.constant_admittance"/></TD><TD><xsl:value-of select="system.voltage_factor"/></TD><TD><xsl:value-of select="system.configuration"/></TD><TD><xsl:value-of select="system.total"/></TD><TD><xsl:value-of select="system.total_power"/></TD><TD><xsl:value-of select="system.current"/></TD><TD><xsl:value-of select="system.admittance"/></TD></TR>
</xsl:for-each></TABLE>
<H4>house_e objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>weather</TH><TH>floor_area</TH><TH>gross_wall_area</TH><TH>ceiling_height</TH><TH>aspect_ratio</TH><TH>envelope_UA</TH><TH>window_wall_ratio</TH><TH>door_wall_ratio</TH><TH>glazing_shgc</TH><TH>window_shading</TH><TH>airchange_per_hour</TH><TH>internal_gain</TH><TH>solar_gain</TH><TH>heat_cool_gain</TH><TH>thermostat_deadband</TH><TH>heating_setpoint</TH><TH>cooling_setpoint</TH><TH>design_heating_capacity</TH><TH>design_cooling_capacity</TH><TH>cooling_design_temperature</TH><TH>heating_design_temperature</TH><TH>design_peak_solar</TH><TH>design_internal_gains</TH><TH>heating_COP</TH><TH>cooling_COP</TH><TH>COP_coeff</TH><TH>air_temperature</TH><TH>outdoor_temperature</TH><TH>mass_heat_capacity</TH><TH>mass_heat_coeff</TH><TH>mass_temperature</TH><TH>system_type</TH><TH>system_mode</TH><TH>Rroof</TH><TH>Rwall</TH><TH>Rfloor</TH><TH>Rwindows</TH><TH>Rdoors</TH><TH>system</TH><TH>system.energy</TH><TH>system.power</TH><TH>system.demand</TH><TH>system.heatgain</TH><TH>system.heatgain_fraction</TH><TH>system.current_fraction</TH><TH>system.impedance_fraction</TH><TH>system.power_fraction</TH><TH>system.power_factor</TH><TH>system.constant_power</TH><TH>system.constant_current</TH><TH>system.constant_admittance</TH><TH>system.voltage_factor</TH><TH>system.configuration</TH><TH>system.total</TH><TH>system.total_power</TH><TH>system.current</TH><TH>system.admittance</TH><TH>total</TH><TH>total.energy</TH><TH>total.power</TH><TH>total.demand</TH><TH>total.heatgain</TH><TH>total.heatgain_fraction</TH><TH>total.current_fraction</TH><TH>total.impedance_fraction</TH><TH>total.power_fraction</TH><TH>total.power_factor</TH><TH>total.constant_power</TH><TH>total.constant_current</TH><TH>total.constant_admittance</TH><TH>total.voltage_factor</TH><TH>total.configuration</TH><TH>total.total</TH><TH>total.total_power</TH><TH>total.current</TH><TH>total.admittance</TH></TR>
<xsl:for-each select="residential/house_e_list/house_e"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><a href="#{weather}"><xsl:value-of select="weather"/></a></TD><TD><xsl:value-of select="floor_area"/></TD><TD><xsl:value-of select="gross_wall_area"/></TD><TD><xsl:value-of select="ceiling_height"/></TD><TD><xsl:value-of select="aspect_ratio"/></TD><TD><xsl:value-of select="envelope_UA"/></TD><TD><xsl:value-of select="window_wall_ratio"/></TD><TD><xsl:value-of select="door_wall_ratio"/></TD><TD><xsl:value-of select="glazing_shgc"/></TD><TD><xsl:value-of select="window_shading"/></TD><TD><xsl:value-of select="airchange_per_hour"/></TD><TD><xsl:value-of select="internal_gain"/></TD><TD><xsl:value-of select="solar_gain"/></TD><TD><xsl:value-of select="heat_cool_gain"/></TD><TD><xsl:value-of select="thermostat_deadband"/></TD><TD><xsl:value-of select="heating_setpoint"/></TD><TD><xsl:value-of select="cooling_setpoint"/></TD><TD><xsl:value-of select="design_heating_capacity"/></TD><TD><xsl:value-of select="design_cooling_capacity"/></TD><TD><xsl:value-of select="cooling_design_temperature"/></TD><TD><xsl:value-of select="heating_design_temperature"/></TD><TD><xsl:value-of select="design_peak_solar"/></TD><TD><xsl:value-of select="design_internal_gains"/></TD><TD><xsl:value-of select="heating_COP"/></TD><TD><xsl:value-of select="cooling_COP"/></TD><TD><xsl:value-of select="COP_coeff"/></TD><TD><xsl:value-of select="air_temperature"/></TD><TD><xsl:value-of select="outdoor_temperature"/></TD><TD><xsl:value-of select="mass_heat_capacity"/></TD><TD><xsl:value-of select="mass_heat_coeff"/></TD><TD><xsl:value-of select="mass_temperature"/></TD><TD><xsl:value-of select="system_type"/></TD><TD><xsl:value-of select="system_mode"/></TD><TD><xsl:value-of select="Rroof"/></TD><TD><xsl:value-of select="Rwall"/></TD><TD><xsl:value-of select="Rfloor"/></TD><TD><xsl:value-of select="Rwindows"/></TD><TD><xsl:value-of select="Rdoors"/></TD><TD><xsl:value-of select="system"/></TD><TD><xsl:value-of select="system.energy"/></TD><TD><xsl:value-of select="system.power"/></TD><TD><xsl:value-of select="system.demand"/></TD><TD><xsl:value-of select="system.heatgain"/></TD><TD><xsl:value-of select="system.heatgain_fraction"/></TD><TD><xsl:value-of select="system.current_fraction"/></TD><TD><xsl:value-of select="system.impedance_fraction"/></TD><TD><xsl:value-of select="system.power_fraction"/></TD><TD><xsl:value-of select="system.power_factor"/></TD><TD><xsl:value-of select="system.constant_power"/></TD><TD><xsl:value-of select="system.constant_current"/></TD><TD><xsl:value-of select="system.constant_admittance"/></TD><TD><xsl:value-of select="system.voltage_factor"/></TD><TD><xsl:value-of select="system.configuration"/></TD><TD><xsl:value-of select="system.total"/></TD><TD><xsl:value-of select="system.total_power"/></TD><TD><xsl:value-of select="system.current"/></TD><TD><xsl:value-of select="system.admittance"/></TD><TD><xsl:value-of select="total"/></TD><TD><xsl:value-of select="total.energy"/></TD><TD><xsl:value-of select="total.power"/></TD><TD><xsl:value-of select="total.demand"/></TD><TD><xsl:value-of select="total.heatgain"/></TD><TD><xsl:value-of select="total.heatgain_fraction"/></TD><TD><xsl:value-of select="total.current_fraction"/></TD><TD><xsl:value-of select="total.impedance_fraction"/></TD><TD><xsl:value-of select="total.power_fraction"/></TD><TD><xsl:value-of select="total.power_factor"/></TD><TD><xsl:value-of select="total.constant_power"/></TD><TD><xsl:value-of select="total.constant_current"/></TD><TD><xsl:value-of select="total.constant_admittance"/></TD><TD><xsl:value-of select="total.voltage_factor"/></TD><TD><xsl:value-of select="total.configuration"/></TD><TD><xsl:value-of select="total.total"/></TD><TD><xsl:value-of select="total.total_power"/></TD><TD><xsl:value-of select="total.current"/></TD><TD><xsl:value-of select="total.admittance"/></TD></TR>
</xsl:for-each></TABLE>
<H4>residential_enduse objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>shape</TH><TH>load</TH><TH>energy</TH><TH>power</TH><TH>demand</TH><TH>heatgain</TH><TH>heatgain_fraction</TH><TH>current_fraction</TH><TH>impedance_fraction</TH><TH>power_fraction</TH><TH>power_factor</TH><TH>constant_power</TH><TH>constant_current</TH><TH>constant_admittance</TH><TH>voltage_factor</TH><TH>configuration</TH><TH>total</TH><TH>total_power</TH><TH>current</TH><TH>admittance</TH></TR>
<xsl:for-each select="residential/residential_enduse_list/residential_enduse"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="shape"/></TD><TD><xsl:value-of select="load"/></TD><TD><xsl:value-of select="energy"/></TD><TD><xsl:value-of select="power"/></TD><TD><xsl:value-of select="demand"/></TD><TD><xsl:value-of select="heatgain"/></TD><TD><xsl:value-of select="heatgain_fraction"/></TD><TD><xsl:value-of select="current_fraction"/></TD><TD><xsl:value-of select="impedance_fraction"/></TD><TD><xsl:value-of select="power_fraction"/></TD><TD><xsl:value-of select="power_factor"/></TD><TD><xsl:value-of select="constant_power"/></TD><TD><xsl:value-of select="constant_current"/></TD><TD><xsl:value-of select="constant_admittance"/></TD><TD><xsl:value-of select="voltage_factor"/></TD><TD><xsl:value-of select="configuration"/></TD><TD><xsl:value-of select="total"/></TD><TD><xsl:value-of select="total_power"/></TD><TD><xsl:value-of select="current"/></TD><TD><xsl:value-of select="admittance"/></TD></TR>
</xsl:for-each></TABLE>
<H4>waterheater objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>tank_volume</TH><TH>tank_UA</TH><TH>tank_diameter</TH><TH>water_demand</TH><TH>heating_element_capacity</TH><TH>inlet_water_temperature</TH><TH>heat_mode</TH><TH>location</TH><TH>tank_setpoint</TH><TH>thermostat_deadband</TH><TH>temperature</TH><TH>height</TH><TH>shape</TH><TH>load</TH><TH>energy</TH><TH>power</TH><TH>demand</TH><TH>heatgain</TH><TH>heatgain_fraction</TH><TH>current_fraction</TH><TH>impedance_fraction</TH><TH>power_fraction</TH><TH>power_factor</TH><TH>constant_power</TH><TH>constant_current</TH><TH>constant_admittance</TH><TH>voltage_factor</TH><TH>configuration</TH><TH>total</TH><TH>total_power</TH><TH>current</TH><TH>admittance</TH></TR>
<xsl:for-each select="residential/waterheater_list/waterheater"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="tank_volume"/></TD><TD><xsl:value-of select="tank_UA"/></TD><TD><xsl:value-of select="tank_diameter"/></TD><TD><xsl:value-of select="water_demand"/></TD><TD><xsl:value-of select="heating_element_capacity"/></TD><TD><xsl:value-of select="inlet_water_temperature"/></TD><TD><xsl:value-of select="heat_mode"/></TD><TD><xsl:value-of select="location"/></TD><TD><xsl:value-of select="tank_setpoint"/></TD><TD><xsl:value-of select="thermostat_deadband"/></TD><TD><xsl:value-of select="temperature"/></TD><TD><xsl:value-of select="height"/></TD><TD><xsl:value-of select="shape"/></TD><TD><xsl:value-of select="load"/></TD><TD><xsl:value-of select="energy"/></TD><TD><xsl:value-of select="power"/></TD><TD><xsl:value-of select="demand"/></TD><TD><xsl:value-of select="heatgain"/></TD><TD><xsl:value-of select="heatgain_fraction"/></TD><TD><xsl:value-of select="current_fraction"/></TD><TD><xsl:value-of select="impedance_fraction"/></TD><TD><xsl:value-of select="power_fraction"/></TD><TD><xsl:value-of select="power_factor"/></TD><TD><xsl:value-of select="constant_power"/></TD><TD><xsl:value-of select="constant_current"/></TD><TD><xsl:value-of select="constant_admittance"/></TD><TD><xsl:value-of select="voltage_factor"/></TD><TD><xsl:value-of select="configuration"/></TD><TD><xsl:value-of select="total"/></TD><TD><xsl:value-of select="total_power"/></TD><TD><xsl:value-of select="current"/></TD><TD><xsl:value-of select="admittance"/></TD></TR>
</xsl:for-each></TABLE>
<H4>lights objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>type</TH><TH>placement</TH><TH>installed_power</TH><TH>power_density</TH><TH>curtailment</TH><TH>circuit_split</TH><TH>demand_factor</TH><TH>enduse_load</TH><TH>internal_gains</TH><TH>energy_meter</TH><TH>shape</TH><TH>load</TH><TH>energy</TH><TH>power</TH><TH>demand</TH><TH>heatgain</TH><TH>heatgain_fraction</TH><TH>current_fraction</TH><TH>impedance_fraction</TH><TH>power_fraction</TH><TH>power_factor</TH><TH>constant_power</TH><TH>constant_current</TH><TH>constant_admittance</TH><TH>voltage_factor</TH><TH>configuration</TH><TH>total</TH><TH>total_power</TH><TH>current</TH><TH>admittance</TH></TR>
<xsl:for-each select="residential/lights_list/lights"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="type"/></TD><TD><xsl:value-of select="placement"/></TD><TD><xsl:value-of select="installed_power"/></TD><TD><xsl:value-of select="power_density"/></TD><TD><xsl:value-of select="curtailment"/></TD><TD><xsl:value-of select="circuit_split"/></TD><TD><xsl:value-of select="demand_factor"/></TD><TD><xsl:value-of select="enduse_load"/></TD><TD><xsl:value-of select="internal_gains"/></TD><TD><xsl:value-of select="energy_meter"/></TD><TD><xsl:value-of select="shape"/></TD><TD><xsl:value-of select="load"/></TD><TD><xsl:value-of select="energy"/></TD><TD><xsl:value-of select="power"/></TD><TD><xsl:value-of select="demand"/></TD><TD><xsl:value-of select="heatgain"/></TD><TD><xsl:value-of select="heatgain_fraction"/></TD><TD><xsl:value-of select="current_fraction"/></TD><TD><xsl:value-of select="impedance_fraction"/></TD><TD><xsl:value-of select="power_fraction"/></TD><TD><xsl:value-of select="power_factor"/></TD><TD><xsl:value-of select="constant_power"/></TD><TD><xsl:value-of select="constant_current"/></TD><TD><xsl:value-of select="constant_admittance"/></TD><TD><xsl:value-of select="voltage_factor"/></TD><TD><xsl:value-of select="configuration"/></TD><TD><xsl:value-of select="total"/></TD><TD><xsl:value-of select="total_power"/></TD><TD><xsl:value-of select="current"/></TD><TD><xsl:value-of select="admittance"/></TD></TR>
</xsl:for-each></TABLE>
<H4>refrigerator objects</H4><TABLE BORDER="1">
<TR><TH>Name</TH><TH>size</TH><TH>rated_capacity</TH><TH>temperature</TH><TH>setpoint</TH><TH>deadband</TH><TH>next_time</TH><TH>output</TH><TH>event_temp</TH><TH>UA</TH><TH>state</TH><TH>enduse_load</TH><TH>shape</TH><TH>load</TH><TH>energy</TH><TH>power</TH><TH>demand</TH><TH>heatgain</TH><TH>heatgain_fraction</TH><TH>current_fraction</TH><TH>impedance_fraction</TH><TH>power_fraction</TH><TH>power_factor</TH><TH>constant_power</TH><TH>constant_current</TH><TH>constant_admittance</TH><TH>voltage_factor</TH><TH>configuration</TH><TH>total</TH><TH>total_power</TH><TH>current</TH><TH>admittance</TH></TR>
<xsl:for-each select="residential/refrigerator_list/refrigerator"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="size"/></TD><TD><xsl:value-of select="rated_capacity"/></TD><TD><xsl:value-of select="temperature"/></TD><TD><xsl:value-of select="setpoint"/></TD><TD><xsl:value-of select="deadband"/></TD><TD><xsl:value-of select="next_time"/></TD><TD><xsl:value-of select="output"/></TD><TD><xsl:value-of select="event_temp"/></TD><TD><xsl:value-of select="UA"/></TD><TD><xsl:value-of select="state"/></TD><TD><xsl:value-of select="enduse_load"/></TD><TD><xsl:value-of select="shape"/></TD><TD><xsl:value-of select="load"/></TD><TD><xsl:value-of select="energy"/></TD><TD><xsl:value-of select="power"/></TD><TD><xsl:value-of select="demand"/></TD><TD><xsl:value-of select="heatgain"/></TD><TD><xsl:value-of select="heatgain_fraction"/></TD><TD><xsl:value-of select="current_fraction"/></TD><TD><xsl:value-of select="impedance_fraction"/></TD><TD><xsl:value-of select="power_fraction"/></TD><TD><xsl:value-of select="power_factor"/></TD><TD><xsl:value-of select="constant_power"/></TD><TD><xsl:value-of select="constant_current"/></TD><TD><xsl:value-of select="constant_admittance"/></TD><TD><xsl:value-of select="voltage_factor"/></TD><TD><xsl:value-of select="configuration"/></TD><TD><xsl:value-of select="total"/></TD><TD><xsl:value-of select="total_power"/></TD><TD><xsl:value-of select="current"/></TD><TD><xsl:value-of select="admittance"/></TD></TR>
</xsl:for-each></TABLE>
...
</xsl:if><xsl:if test="total.energy">	total.energy <xsl:value-of select="total.energy"/>;
</xsl:if><xsl:if test="total.power">	total.power <xsl:value-of select="total.power"/>;
</xsl:if><xsl:if test="total.demand">	total.demand <xsl:value-of select="total.demand"/>;
</xsl:if><xsl:if test="total.heatgain">	total.heatgain <xsl:value-of select="total.heatgain"/>;
</xsl:if><xsl:if test="total.heatgain_fraction">	total.heatgain_fraction <xsl:value-of select="total.heatgain_fraction"/>;
</xsl:if><xsl:if test="total.current_fraction">	total.current_fraction <xsl:value-of select="total.current_fraction"/>;
</xsl:if><xsl:if test="total.impedance_fraction">	total.impedance_fraction <xsl:value-of select="total.impedance_fraction"/>;
</xsl:if><xsl:if test="total.power_fraction">	total.power_fraction <xsl:value-of select="total.power_fraction"/>;
</xsl:if><xsl:if test="total.power_factor">	total.power_factor <xsl:value-of select="total.power_factor"/>;
</xsl:if><xsl:if test="total.constant_power">	total.constant_power <xsl:value-of select="total.constant_power"/>;
</xsl:if><xsl:if test="total.constant_current">	total.constant_current <xsl:value-of select="total.constant_current"/>;
</xsl:if><xsl:if test="total.constant_admittance">	total.constant_admittance <xsl:value-of select="total.constant_admittance"/>;
</xsl:if><xsl:if test="total.voltage_factor">	total.voltage_factor <xsl:value-of select="total.voltage_factor"/>;
</xsl:if><xsl:if test="total.configuration">	total.configuration <xsl:value-of select="total.configuration"/>;
</xsl:if><xsl:if test="total.total">	total.total <xsl:value-of select="total.total"/>;
</xsl:if><xsl:if test="total.total_power">	total.total_power <xsl:value-of select="total.total_power"/>;
</xsl:if><xsl:if test="total.current">	total.current <xsl:value-of select="total.current"/>;
</xsl:if><xsl:if test="total.admittance">	total.admittance <xsl:value-of select="total.admittance"/>;
</xsl:if><xsl:if test="system">	system <xsl:value-of select="system"/>;
</xsl:if><xsl:if test="system.energy">	system.energy <xsl:value-of select="system.energy"/>;
</xsl:if><xsl:if test="system.power">	system.power <xsl:value-of select="system.power"/>;
</xsl:if><xsl:if test="system.demand">	system.demand <xsl:value-of select="system.demand"/>;
</xsl:if><xsl:if test="system.heatgain">	system.heatgain <xsl:value-of select="system.heatgain"/>;
</xsl:if><xsl:if test="system.heatgain_fraction">	system.heatgain_fraction <xsl:value-of select="system.heatgain_fraction"/>;
</xsl:if><xsl:if test="system.current_fraction">	system.current_fraction <xsl:value-of select="system.current_fraction"/>;
</xsl:if><xsl:if test="system.impedance_fraction">	system.impedance_fraction <xsl:value-of select="system.impedance_fraction"/>;
</xsl:if><xsl:if test="system.power_fraction">	system.power_fraction <xsl:value-of select="system.power_fraction"/>;
</xsl:if><xsl:if test="system.power_factor">	system.power_factor <xsl:value-of select="system.power_factor"/>;
</xsl:if><xsl:if test="system.constant_power">	system.constant_power <xsl:value-of select="system.constant_power"/>;
</xsl:if><xsl:if test="system.constant_current">	system.constant_current <xsl:value-of select="system.constant_current"/>;
</xsl:if><xsl:if test="system.constant_admittance">	system.constant_admittance <xsl:value-of select="system.constant_admittance"/>;
</xsl:if><xsl:if test="system.voltage_factor">	system.voltage_factor <xsl:value-of select="system.voltage_factor"/>;
</xsl:if><xsl:if test="system.configuration">	system.configuration <xsl:value-of select="system.configuration"/>;
</xsl:if><xsl:if test="system.total">	system.total <xsl:value-of select="system.total"/>;
</xsl:if><xsl:if test="system.total_power">	system.total_power <xsl:value-of select="system.total_power"/>;
</xsl:if><xsl:if test="system.current">	system.current <xsl:value-of select="system.current"/>;
</xsl:if><xsl:if test="system.admittance">	system.admittance <xsl:value-of select="system.admittance"/>;
</xsl:if>}
</xsl:for-each>
...
</xsl:if><xsl:if test="door_wall_ratio">	door_wall_ratio <xsl:value-of select="door_wall_ratio"/>;
</xsl:if><xsl:if test="glazing_shgc">	glazing_shgc <xsl:value-of select="glazing_shgc"/>;
...
</xsl:if><xsl:if test="demand_factor">	demand_factor <xsl:value-of select="demand_factor"/>;
</xsl:if><xsl:if test="enduse_load">	enduse_load <xsl:value-of select="enduse_load"/>;

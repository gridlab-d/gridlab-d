...
<TR><TH>Name</TH><TH>charger_type</TH><TH>vehicle_type</TH><TH>state</TH><TH>p_go_home</TH><TH>p_go_work</TH><TH>p_go_shorttrip</TH><TH>p_go_longtrip</TH><TH>work_dist</TH><TH>shorttrip_dist</TH><TH>longtrip_dist</TH><TH>capacity</TH><TH>charge</TH><TH>charge_at_work</TH><TH>power_factor</TH><TH>charge_throttle</TH><TH>demand_profile</TH><TH>enduse_load</TH><TH>constant_power</TH><TH>constant_current</TH><TH>constant_admittance</TH><TH>internal_gains</TH><TH>energy_meter</TH><TH>heat_fraction</TH></TR>
<xsl:for-each select="residential/evcharger_list/evcharger"><TR><TD><a name="#{name}"/><xsl:value-of select="name"/> (#<xsl:value-of select="id"/>)</TD><TD><xsl:value-of select="charger_type"/></TD><TD><xsl:value-of select="vehicle_type"/></TD><TD><xsl:value-of select="state"/></TD><TD><xsl:value-of select="p_go_home"/></TD><TD><xsl:value-of select="p_go_work"/></TD><TD><xsl:value-of select="p_go_shorttrip"/></TD><TD><xsl:value-of select="p_go_longtrip"/></TD><TD><xsl:value-of select="work_dist"/></TD><TD><xsl:value-of select="shorttrip_dist"/></TD><TD><xsl:value-of select="longtrip_dist"/></TD><TD><xsl:value-of select="capacity"/></TD><TD><xsl:value-of select="charge"/></TD><TD><xsl:value-of select="charge_at_work"/></TD><TD><xsl:value-of select="power_factor"/></TD><TD><xsl:value-of select="charge_throttle"/></TD><TD><xsl:value-of select="demand_profile"/></TD><TD><xsl:value-of select="enduse_load"/></TD><TD><xsl:value-of select="constant_power"/></TD><TD><xsl:value-of select="constant_current"/></TD><TD><xsl:value-of select="constant_admittance"/></TD><TD><xsl:value-of select="internal_gains"/></TD><TD><xsl:value-of select="energy_meter"/></TD><TD><xsl:value-of select="heat_fraction"/></TD></TR>
</xsl:for-each></TABLE>

...
static TIMESTAMP sync_generator_impl(OBJECT *obj, TIMESTAMP t0, PASSCONFIG pass)
{
	TIMESTAMP t1 = TS_NEVER;
	if (pass == PC_BOTTOMUP)
...
#ifndef __APPLE__
extern "C" MODULE_API TIMESTAMP sync_generator(OBJECT *obj, TIMESTAMP t0, PASSCONFIG pass)
{

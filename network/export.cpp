...
//system_name, mvabase, model_year, model_case, model_name);
//
//	// process nodes
//	FINDLIST *found = gl_find_objects(FL_NEW,FT_CLASS,SAME,"node",FT_END);
//	count += fprintf(fp,"%-38.38s %d ITEMS\n","BUS DATA
//FOLLOWS",found->hit_count); 	OBJECT *obj=nullptr; 	while
//((obj=gl_find_next(found,obj))!=nullptr)
//	{
//		node *my = (node*)(obj+1);
//		char name[32];
...
//my->V.Mag(), 			my->V.Arg()*180/PI, 			my->S.Re()<0?-my->S.Re()*mvabase:0,
//my->S.Re()<0?-my->S.Im()*mvabase:0, 			my->S.Re()>0?my->S.Re()*mvabase:0,
//my->S.Re()>0?my->S.Im()*mvabase:0, 			my->base_kV, my->desired_kV, my->Qmax_MVAR,
//my->Qmin_MVAR, my->G, my->B, my->remote_bus_id?my->remote_bus_id->id+1:0);
//	}
...
//	count += fprintf(fp,"%-38.38s %d ITEMS\n","BRANCH DATA
//FOLLOWS",found->hit_count); 	obj=nullptr; 	while
//((obj=gl_find_next(found,obj))!=nullptr)
//	{
//		link *my = (link*)(obj+1);
...
//*/ 			continue; 		double R = (complex(1)/my->Y).Re(); 		double X =
//(complex(1)/my->Y).Im(); 		count += fprintf(fp,"%4d %4d %2d %2d 1 0 %9.5f %11.5f
//%9.4f %4d %4d %4d %4d %1d  %6.3f %7.2f %5f %5f %5f %5f %5f\n", 			my->from->id+1,
//my->to->id+1, from->flow_area_num, from->loss_zone_num, R,X,0.0, 			0,0,0,0,
...
//%s\n-99\n",model_name); 	count += fprintf(fp,"INTERCHANGE DATA FOLLOWS 0
//ITEMS\n-9\n"); 	count += fprintf(fp,"TIE LINES FOLLOWS                     0
//ITEMS\n-999\n");
//
...
//obj->oclass->name, obj->id); 		fprintf(fp,"      <description>\n"); 		fprintf(fp,"
//<![CDATA[\n"); 		fprintf(fp,"          <TABLE><TR>\n"); 		switch (pNode->type) {
//		case SWING:
//			fprintf(fp,"            <TR><TH ALIGN=LEFT>Type</TH><TD
//ALIGN=RIGHT
//STYLE=\"font-family:courier;\">SWING&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD></TR>\n");
//			break;
//		case PV:
//			fprintf(fp,"            <TR><TH ALIGN=LEFT>Type</TH><TD
//ALIGN=RIGHT
//STYLE=\"font-family:courier;\">PV&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD></TR>\n");
//			break;
//		case PQ:
//			fprintf(fp,"            <TR><TH ALIGN=LEFT>Type</TH><TD
//ALIGN=RIGHT
//STYLE=\"font-family:courier;\">PQ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD></TR>\n");
//			break;
//		}
//		fprintf(fp,"            <TR><TH ALIGN=LEFT>Voltage</TH><TD
//ALIGN=RIGHT
//STYLE=\"font-family:courier;\">%.3f&nbsp;kV&nbsp;&nbsp;<BR>%.3f&nbsp;&ang;&nbsp;&nbsp;&nbsp;</TD></TR>\n",
//			pNode->V.Mag()*pNode->base_kV,pNode->V.Arg()*180/3.1416);
//		if (pNode->S.Mag()>0)
//			fprintf(fp,"            <TR><TH ALIGN=LEFT>%s</TH><TD
//ALIGN=RIGHT
//STYLE=\"font-family:courier;\">%.3f&nbsp;MW&nbsp;&nbsp;<BR>%.3f&nbsp;MVAR</TD></TR>\n",
...
//		OBJECT *to = pLink->to;
//		if (isnan(from->latitude) || isnan(to->latitude) ||
//isnan(from->longitude) || isnan(to->longitude)) 			return 0; 		fprintf(fp,"
//<Placemark>\n"); 		if (obj->name) 			fprintf(fp,"      <name>%s</name>\n",
//obj->name); 		else 			fprintf(fp,"      <name>%s ==> %s</name>\n",
//from->name?from->name:"unnamed", to->name?to->name:"unnamed"); 			fprintf(fp,"
//<description>\n"); 			fprintf(fp,"        <![CDATA[\n"); 			fprintf(fp,"
//<TABLE><TR>\n"); 			complex flow; 			node *pFrom = OBJECTDATA(from,node); 			node *pTo
//= OBJECTDATA(to,node); 			if (pLink->I.Re()<0) 				flow = pFrom->V * pLink->I; 			else
//				flow = pTo->V * pLink->I;
//			complex loss = pLink->I*pLink->I / pLink->Y;
//			complex imp = complex(1,0)/pLink->Y;
//			double current_base = mvabase/pFrom->base_kV*1000;
//			fprintf(fp,"            <TR><TH ALIGN=LEFT>Flow</TH><TD
//ALIGN=RIGHT
//STYLE=\"font-family:courier;\">%.3f&nbsp;&nbsp;MW&nbsp;&nbsp;<BR>%.3f&nbsp;&nbsp;MVAR</TD></TR>\n",
//				flow.Re()*mvabase, flow.Im()*mvabase);
//			fprintf(fp,"            <TR><TH
//ALIGN=LEFT>Current</TH><TD ALIGN=RIGHT
//STYLE=\"font-family:courier;\">%.3f&nbsp;&nbsp;Amps</TD></TR>\n",
//				pLink->I.Mag()*current_base);
//			fprintf(fp,"            <TR><TH
//ALIGN=LEFT>Impedance</TH><TD ALIGN=RIGHT
//STYLE=\"font-family:courier;\">%.4f&nbsp;R&nbsp;&nbsp;&nbsp;<BR>%.4f&nbsp;X&nbsp;&nbsp;&nbsp;</TD></TR>\n",
//				imp.Re(),imp.Im());
//			fprintf(fp,"            <TR><TH
//ALIGN=LEFT>Losses</TH><TD ALIGN=RIGHT
//STYLE=\"font-family:courier;\">%.2f&nbsp;&nbsp;&nbsp;%%P&nbsp;&nbsp;<BR>%.2f&nbsp;&nbsp;&nbsp;%%Q&nbsp;&nbsp;</TD></TR>\n",

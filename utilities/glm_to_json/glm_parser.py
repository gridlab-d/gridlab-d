...
class GLMModel:
    ...
    def _process_object_parameter(self, param, val, name_prefix, insideIfDefs, params, comments, inside_comments, line=None):
        ...
        Returns:
            tuple: (processed_name, updated_line) where processed_name is the name if param is 'name', otherwise None
        """
        if param == 'name':
    ...
    def _extract_directive_content(line, directive):
        """Extract the content part of a directive line, removing the directive prefix

...
code = subprocess.call(["iscc.exe","/F"+installer_name ,installer_script],shell=True) 
code = subprocess.call(["iscc.exe","/F"+installer_prefix+"-nightly" ,installer_script],shell=True) 

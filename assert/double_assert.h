...
public:
    ...
    inline enumeration get_within_mode(void) {
        return within_mode;
    }
    ...
    inline void set_within_mode(enumeration p) {
        within_mode = p;
    }

    // Inline method to get the string representation of the `within_mode` property.
...
public:
    ...
    inline void set_value(double p) {
        value = p;
    }
...
public:
    ...
    inline double get_once_value(void) {
    ...
    inline void set_once_value(double p)
    {
        auto& mtx = SharedMutexManager::get_mutex(my());

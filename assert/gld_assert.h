...
public:
  ...
  static inline g_assert *get_defaults() { return defaults; }
...
public:
  ...
  static inline size_t get_relation_offset(void) {
    g_assert *current_defaults = get_defaults();
    return reinterpret_cast<const char *>(&(current_defaults->relation)) -
           reinterpret_cast<const char *>(current_defaults);
  }

  // Inline function to get the value of `relation`.
  inline enumeration get_relation(void) { return relation; }
  ...
  inline void set_relation(enumeration p) { relation = p; }
...
public:
  ...
  inline std::string get_value(void) { return std::string(value); }
...
public:
  ...
  static inline size_t get_part_offset(void) {
    g_assert *current_defaults = get_defaults();
    return reinterpret_cast<const char *>(&(current_defaults->part)) -
           reinterpret_cast<const char *>(current_defaults);
  }
...
public:
  ...
  static inline size_t get_value2_offset(void) {
    g_assert *current_defaults = get_defaults();
    return reinterpret_cast<const char *>(&(current_defaults->value2)) -
           reinterpret_cast<const char *>(current_defaults);
  }

  // Getter method to safely retrieve the string value of `value2` as
  // std::string

	...
	if (oclass==NULL)
	{
		...
		if (gl_publish_variable(oclass,
			...
			PT_set,"event",get_event_offset(),PT_DESCRIPTION,"debug event (init, sync, etc.)",
				PT_KEYWORD,"NONE",(gld::set)DBE_NONE,
				PT_KEYWORD,"INIT",(gld::set)DBE_INIT,
				PT_KEYWORD,"PRECOMMIT",(gld::set)DBE_PRECOMMIT,
				PT_KEYWORD,"PRESYNC",(gld::set)DBE_PRESYNC,
				PT_KEYWORD,"SYNC",(gld::set)DBE_SYNC,
				PT_KEYWORD,"POSTSYNC",(gld::set)DBE_POSTSYNC,
				PT_KEYWORD,"COMMIT",(gld::set)DBE_COMMIT,
				PT_KEYWORD,"FINALIZE",(gld::set)DBE_FINALIZE,
				PT_KEYWORD,"ALL",(gld::set)DBE_ALL,

...
Table: Single-family residential model { #tbl:single-family-residential-model }
...
Internal heat gains | Btu/h | $\sum_{x=end use}{r_x Q_x}$ | $r_x$ is the fraction of heat from all fuel sources that goes to indoor air   
...
!!! note
    ...
    $\dot V_{thermal} \approx 1.877 FloorArea \sqrt{BuildingHeight|T_{in}-T_{out}|/T_{in}}/AirVolume$ [in puV/h] 

    $\dot V_{wind} \approx FloorArea \times WindSpeed \times 10^{-5}$ [in puV/h]

    $Q_{PeakSolar} = PeakSolar \times WindowArea \times Shading \times  1/8 (ExposureFraction)$ [in Btu/h]

    with $ExposureFraction = \begin{cases} SolarElevation > 0 & : \sqrt{2} \cos(SolarElevation) \sin(SolarElevation) \\\ SolarElevation \le 0 & : 0 \end{cases}$

    $H_{vent} = 0.182 VentilationRate \times AirVolume$

    $UA_{wall} = WallArea(1-WindowWallRatio)/WallRValue$

    $UA_{roof} = FlooArea/RoofRValue$

    $UA_{window} = WallArea \times WindowWallRatio \times WindowRValue$

    $SolarExposure = WindowArea (1-ExternalShading) \times 1/8 (ExposureFraction)$ 
...
Table: Single-family residential end use electrification { #tbl:single-family-residential-end-use-electrification }
...
Table: Single-family residential end use efficiency { #tbl:single-family-residential-end-use-efficiency }
...
Table: Single-family residential end use installed capacity (W/sf) { #tbl:single-family-residential-end-use-installed-capacity-w-sf }
...
![ELCAP winter/weekday end use load shapes](../../../images/300px-ELCAP_end-use_loadshape_1.PNG){ #fig:elcap-winter-weekday-end-use-load-shapes }


![ELCAP winter/weekend end use load shapes](../../../images/300px-ELCAP_end-use_loadshape_2.PNG){ #fig:elcap-winter-weekend-end-use-load-shapes }


![ELCAP summer/weekday end use load shapes](../../../images/300px-ELCAP_end-use_loadshape_3.PNG){ #fig:elcap-summer-weekday-end-use-load-shapes }


![ELCAP summer/weekend end use load shapes](../../../images/300px-ELCAP_end-use_loadshape_4.PNG){ #fig:elcap-summer-weekend-end-use-load-shapes }
...
Table: Single-family residential daily end use energy demand (kWh/day) { #tbl:single-family-residential-daily-end-use-energy-demand-kwh-day }
...
Table: Single-family residential load composition matrix { #tbl:single-family-residential-load-composition-matrix }
...
Table: Multi-family residential load composition matrix { #tbl:multi-family-residential-load-composition-matrix }
...
Table: Small office end use composition map { #tbl:small-office-end-use-composition-map }
...
Table: Large office end use composition map { #tbl:large-office-end-use-composition-map }
...
Table: Retail end use composition map { #tbl:retail-end-use-composition-map }
...
Table: Lodging end use composition map { #tbl:lodging-end-use-composition-map }
...
Table: Grocery store end use composition map { #tbl:grocery-store-end-use-composition-map }
...
Table: Restaurant end use composition map { #tbl:restaurant-end-use-composition-map }
...
Table: School end use composition map { #tbl:school-end-use-composition-map }
...
Table: Health end use composition map { #tbl:health-end-use-composition-map }
...
Industrial and agricultural loads are considered idiosynchratic and must be entered directly as an end use load composition on their respective worksheets. See [Industrial and Agricultural Loads](./3.0%20-%20Industrial_and_agricultural_loads.md) for more information.
...
Table: Winter peak 6:00 residential feeder load composition { #tbl:winter-peak-6-00-residential-feeder-load-composition }
...
Table: Winter peak 6:00 residential feeder load composition { #tbl:winter-peak-6-00-residential-feeder-load-composition-2 }
...
Table: Winter peak 6:00 commercial feeder load composition { #tbl:winter-peak-6-00-commercial-feeder-load-composition }
...
Table: Summer peak 15:00 residential feeder load composition { #tbl:summer-peak-15-00-residential-feeder-load-composition }
...
Table: Summer peak 15:00 mixed residential/commercial feeder load composition { #tbl:summer-peak-15-00-mixed-residential-commercial-feeder-load-composition }
...
Table: Summer peak 15:00 commercial feeder load composition { #tbl:summer-peak-15-00-commercial-feeder-load-composition }
...
![Daily clustomer type shape (Portland OR, weekday, summer peak)](../../../images/Loadshape1.gif){ #fig:daily-clustomer-type-shape-portland-or-weekday-summer-peak }


![Daily customer type composition (Portland OR, weekday, summer peak)](../../../images/Loadshape2.gif){ #fig:daily-customer-type-composition-portland-or-weekday-summer-peak }

![Daily load component shape (Portland OR, weekday, summer peak)](../../../images/Loadshape3.gif){ #fig:daily-load-component-shape-portland-or-weekday-summer-peak }

![Daily Customer component composition (Portland OR, weekday, summer peak)](../../../images/Loadshape4.gif){ #fig:daily-customer-component-composition-portland-or-weekday-summer-peak }
...
Table: Single-family residential temperature sensitivities { #tbl:single-family-residential-temperature-sensitivities }
...
Table: Multi-family residential temperature sensitivities { #tbl:multi-family-residential-temperature-sensitivities }
...
Table: Small-office commercial temperature sensitivities { #tbl:small-office-commercial-temperature-sensitivities }
...
Table: Large-office commercial temperature sensitivities { #tbl:large-office-commercial-temperature-sensitivities }

...
##### Figure 1. Object hierarchy of DER that may be attached to a house. Note that EV chargers belong to the Residential Module but solar and energy storage objects are a part of the Generators Module.
...
##### Table 1. Residential Module Default Variables

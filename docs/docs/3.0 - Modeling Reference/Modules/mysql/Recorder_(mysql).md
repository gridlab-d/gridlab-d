...
**group** | The group identifier to activate group mode for the recorder. See [Finding Objects](TODO - Link - Find redirect for "Finding Objects") for object searching. <br/> Note: using this mode disables custom `header_fieldnames`, and will always enable the "name" field.
...
**trigger** | Specifies the triggering condition for starting the recording. See [recorder trigger](TODO - Link - Find redirect for "recorder trigger") for details.

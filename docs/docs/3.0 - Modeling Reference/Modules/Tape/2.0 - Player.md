...
**TODO - Status -  The behavior of DST is not specified in transient mode, i.e., are timestamp in the localtime or standard time? (see ticket:563).** 

## Properties

Table: Player Properties { #tbl:table-player }

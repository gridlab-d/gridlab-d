...
For technical details on regulator modeling, see [Controls and Devices Theory](../Theory/Controls_and_Devices_Theory.md). 
...
Table: regulator table 1 { #tbl:22-regulator-1 }
...
Table: regulator table 2 { #tbl:22-regulator-2 }

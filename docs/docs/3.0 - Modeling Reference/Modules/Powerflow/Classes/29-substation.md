...
| --- | --- | --- | --- | --- |
| zero_sequence_voltage | complex | V | IO | ⚠️ The zero sequence representation of the voltage for the substation object. |
...
| negative_sequence_voltage | complex | V | IO | ⚠️ The negative sequence representation of the voltage for the substation object. |
| base_power | double | VA | I | ⚠️ The 3 phase VA power rating of the substation. |
| power_convergence_value | double | VA | I | ⚠️ Default convergence criterion before power is posted to pw_load objects if connected, otherwise ignored |
...
| distribution_load | complex | VA | O | ⚠️ The total load of all three phases at the substation object. |

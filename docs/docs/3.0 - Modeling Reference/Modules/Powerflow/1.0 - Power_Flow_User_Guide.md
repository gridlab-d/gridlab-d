...
imp**edance_pf_C  | double  | pu  | in similar format as ZIPload this is the power factor of the phase C constant impedance portion of load   
...
See the [impedance_dump](TODO) page for information on the assumed equations, which are from "Distribution System Modeling and Analysis" by William Kersting. 
...
**runcount**  | int32  | Indicates the number of times the impedance dump has executed.

...
![One-Line Diagram of a Series Compensator](../../../../../images/Series_Compensator.png){ #fig:one-line-diagram-of-a-series-compensator }
...
![Input voltage and output voltage of LVR](../../../../../images/300px-Vin_and_Vout.png.png){ #fig:input-voltage-and-output-voltage-of-lvr }
...
![Control range of the series compensator](../../../../../images/300px-Regulation_Range.png){ #fig:control-range-of-the-series-compensator }
...
![Frequency controller for the series compensator](../../../../../images/300px-Frequency_Controller.png){ #fig:frequency-controller-for-the-series-compensator }
...
![A modified islanded IEEE 123-Node test feeder](../../../../../images/300px-123_node.png){ #fig:a-modified-islanded-ieee-123-node-test-feeder }
...
![System frequency and the output power from the diesel generators and PV inverters (frequency control disabled)](../../../../../images/300px-Frequency_CaseA.png){ #fig:system-frequency-and-the-output-power-from-the-diesel-generators-and-pv-inverters-frequency-control-disabled }


![The three-phase voltages of the input and output of the series compensator installed load 76 (frequency control disabled)](../../../../../images/300px-Voltage_CaseA.png){ #fig:the-three-phase-voltages-of-the-input-and-output-of-the-series-compensator-installed-load-76-frequency-control-disabled }
...
![System frequency and the output power from the diesel generators and PV inverters (frequency control enabled)](../../../../../images/300px-Frequency_CaseB.png){ #fig:system-frequency-and-the-output-power-from-the-diesel-generators-and-pv-inverters-frequency-control-enabled }


![System frequency and the output power from the diesel generators and PV inverters (frequency control enabled)](../../../../../images/300px-Voltage_CaseB.png){ #fig:system-frequency-and-the-output-power-from-the-diesel-generators-and-pv-inverters-frequency-control-enabled-2 }

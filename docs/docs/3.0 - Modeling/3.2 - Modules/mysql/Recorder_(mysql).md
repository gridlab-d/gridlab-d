...
**group** | The group identifier to activate group mode for the recorder. See [Finding Objects] for object searching. <br/> Note: using this mode disables custom header_fieldnames, and will always enable the "name" field.
...
**trigger** | Specifies the triggering condition for starting the recording. See [recorder trigger] for details.

...
Table: Input Parameters { #tbl:table-inputs }
...
Table: Bid Offset { #tbl:table-bid }
...
Table: Output Parameters { #tbl:table-out }
...
Table: Auction Output Parameters { #tbl:table-aucout }
...
![Marginal seller clearing scenario](../../../../images/300px-SimpleMarket-Marginal_Sell.png){ #fig:marginal-seller-clearing-scenario }


![Marginal buyer clearing scenario](../../../../images/300px-SimpleMarket-Marginal_Buy.png){ #fig:marginal-buyer-clearing-scenario }


![Buyer and seller clearing quantities equal](../../../../images/300px-SimpleMarket-Both_Marg.png){ #fig:buyer-and-seller-clearing-quantities-equal }


![Buyer and seller clearing quantities equal, close next seller bid](../../../../images/300px-SimpleMarket-Both_Marg_NextSell.png){ #fig:buyer-and-seller-clearing-quantities-equal-close-next-seller-bid }


![Buyer and seller clearing quantities equal, close next buyer bid](../../../../images/300px-SimpleMarket-Both_Marg_NextBuy.png){ #fig:buyer-and-seller-clearing-quantities-equal-close-next-buyer-bid }


![Buyer and seller clearing quantities and clearing prices equal](../../../../images/300px-SimpleMarket-Both.png){ #fig:buyer-and-seller-clearing-quantities-and-clearing-prices-equal }


![Failure for market to clear](../../../../images/300px-SimpleMarket-Failure.png){ #fig:failure-for-market-to-clear }


![Null market clearing scenario](../../../../images/300px-SimpleMarket-Null.png){ #fig:null-market-clearing-scenario }


![Equal clearing price, but marginal seller clearing scenario](../../../../images/300px-SimpleMarket-PriceMargSeller.png){ #fig:equal-clearing-price-but-marginal-seller-clearing-scenario }


![Equal clearing price, but marginal buyer clearing scenario](../../../../images/300px-SimpleMarket-PriceMargBuyer.png){ #fig:equal-clearing-price-but-marginal-buyer-clearing-scenario }

![Unresponsive buyers in marginal seller clearing scenario](../../../../images/300px-SimpleMarket-Marginal_Base.png){ #fig:unresponsive-buyers-in-marginal-seller-clearing-scenario }



![Unresponsive buyers in equal quantity clearing scenario](../../../../images/300px-SimpleMarket-MarginalUnresponse.png){ #fig:unresponsive-buyers-in-equal-quantity-clearing-scenario }

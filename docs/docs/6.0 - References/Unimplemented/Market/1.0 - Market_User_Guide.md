...
Table: Class Parameters { #tbl:table-class }
...
Table: Auction Parameters { #tbl:table-auc }
...
Table: Stochastic Market Parameters { #tbl:table-stoch }
...
Table: Market Timing Parameters { #tbl:table-timing }
...
Table: Market Log Variables { #tbl:table-logs }
...
Table: Controller Input Parameters { #tbl:table-controller }
...
Generator Controller Object In development. 

### Generator Controller Parameters

Generator Controller Parameters In development. 
...
Generator Controller State of Development In development. 
...
Table: Passive Controller Parameters { #tbl:table-passive }
...
Table: PROBABILITY_OFF Parameters { #tbl:table-proboff }
...
Table: RAMP Parameters { #tbl:table-ramp }
...
Table: Duty cycle and elasticity model parameters { #tbl:table-duty }
...
![Two-tier TOU and CPP](../../../../images/300px-TOU1.png){ #fig:TwoTier }
...
Table: Stubauction Parameters { #tbl:table-stub }
...
Table: Stub Bidder Parameters { #tbl:table-Bidder }

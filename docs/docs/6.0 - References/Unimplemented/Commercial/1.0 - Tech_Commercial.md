...
![The Equivalent Thermal Parameters (ETP) model](../../../../images/300px-Commercial_Module_Guide_Figure_1.png){ #fig:the-equivalent-thermal-parameters-etp-model }
...
![6-Node Thermal Network](../../../../images/300px-Tech-Multizone_ETP_Linearization_Figure_1.png){ #fig:6-node-thermal-network }
...
![Reduced equivalent of 6-node thermal network](../../../../images/300px-Tech-Multizone_ETP_Linearization_Figure_2.png){ #fig:reduced-equivalent-of-6-node-thermal-network }
...
![Series massless node reduction](../../../../images/Tech-Multizone_ETP_Linearization_Figure_3a.png){ #fig:series-massless-node-reduction }
...
![Parallel thermal path reduction](../../../../images/Tech-Multizone_ETP_Linearization_Figure_3b.png){ #fig:parallel-thermal-path-reduction }
...
![The general ETP equation](../../../../images/300px-Commercial_Module_Guide_Figure_2.png){ #fig:the-general-etp-equation }

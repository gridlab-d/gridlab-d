...
**group** | The group identifier to activate group mode for the recorder. See [Finding Objects](../../../3.0%20-%20Modeling%20Reference/Modules/1.0%20-%20Introduction.md#finding-objects) for object searching. <br/> Note: using this mode disables custom `header_fieldnames`, and will always enable the "name" field.

...
For a comprehensive list of command line options, please refer to [Command Line Options](../../3.0%20-%20Modeling%20Reference/Other%20Features/Global%20Variables.md) in the reference section.

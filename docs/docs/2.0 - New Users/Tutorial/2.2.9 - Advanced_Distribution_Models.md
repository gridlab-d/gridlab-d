...
![Voltage Effects on the Distribution System from Switching Capacitors](../../../images/Dist_syst_switching_capacitors.png){ #fig:voltage-effects-on-the-distribution-system-from-switching-capacitors }
...
Table: volt_var_controller Properties { #tbl:volt-var-controller-properties }

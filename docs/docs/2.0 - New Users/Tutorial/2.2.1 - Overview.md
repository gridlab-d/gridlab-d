...
This guide contains and references many example GridLAB-D™ models and files.  Readers are recommended to download a local copy of the [Tutorial](https://github.com/gridlab-d/course/tree/master/Tutorial) folder so example files are readily available while working through the exercises.
...
For example, 
  ...
  * The **residential** module contains the definitions of things such as **house** and appliances such as **water heater**, and **zip load**. 

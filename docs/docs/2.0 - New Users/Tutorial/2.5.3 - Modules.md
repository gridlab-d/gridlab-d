...
*More advanced examples of these highly complex models can be created (or mimicked) using this Matlab(R) script*  **TODO** - Example - Reference either feeder generator or API functionality to show how taxonomy feeders can be used as the backbone of more complex models. 

...
* use the `-o myfile.xml` command line option to generate an instance of the model at the end of simulation. For more information on `.xml` output, see the [XML Data Files] page. TODO Test Ebony
...
The recorder class is one of two classes in the [tape](../../3.0%20-%20Modeling%20Reference/Modules/Tape/1.0%20-%20Tape.md) module that can gather information about objects as they change over time. Recorders can output data in a variety of formats, and the properties of a recorder object what is gathered, how it is gathered, and where it is delivered to. To read more about the recorder object, refer to its reference page: [recorder](../../3.0%20-%20Modeling%20Reference/Modules/Tape/3.0%20-%20Recorder.md).

...
This page explains how to manage simulation time in GridLAB-D in more detail. We start with a reminder of the information presented in the [Using date and time](./2.5.2%20-%20GLM%20Models.md##Using-date-and-time) section of **GLM Models**. A user can use the clock object to indicate the start and stop time of a simulation, as well as provide timezone information.
...
The timezone is usually set as follows: 
...
The TZ environment variable is used to specify the timezone in which the simulation is to be run. The timezone determines when daylight savings starts and stop according the daylight savings time rules specified in the file [tzinfo.txt](https://github.com/gridlab-d/course/blob/master/ThreeDayCourse_v22/Release_x64/tzinfo.txt).

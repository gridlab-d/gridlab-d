...
GridLAB-D™ provides a number of methods for inputting data into the system. **TODO | Provide narrative here, instead of a list, possibly**
...
* **Collections** - Several objects use collections as a property to help find objects that satisfy certain criteria. Collections are typically built at initialization, although they can be run at any time during a simulation if needed

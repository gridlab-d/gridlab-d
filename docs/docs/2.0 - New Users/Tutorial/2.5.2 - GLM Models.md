...
The parent relationship has an impact on how behaviors like initialization and time synchronization are performed. Some objects reference other objects without using the parent relationship for that reason. This is done using an explicitly declared property of object of the object:
...
**TODO - Discuss API - Talk about GLMModifier or API here instead**:

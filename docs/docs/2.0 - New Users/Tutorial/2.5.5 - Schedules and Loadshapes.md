...
##### Table 2 - Random pulse load shape parameters  
Parameter | Unit | Default | Source | Description   
---|---|---|---|---  
**raw_value** | kWh/h | 0.0 | load shape | The value of the load shape for the end use at the given time   
**value** | pu.kWh/h | 0.0 | load shape | The raw load shape value / the total area of the load shape   
...
##### Table 3 - Random pulse load shape parameters  
...
#### Figure 3 - Example of an amplitude modulated loadshape
...
#### Figure 3b - Example of a pulse-width modulated loadshapes
...
#### Figure 4 - Example of a queued loadshape

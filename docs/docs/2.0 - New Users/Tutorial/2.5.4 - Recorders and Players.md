...
The format for player files is straight-forward: two columns with the first being a timestamp and the second being a value. There are three acceptable formats for the timestamp:
...
We'll walk through some examples though to give you a better sense of what is possible.

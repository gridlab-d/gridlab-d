...
![Install](../../images/install.png){ #fig:Install }
...
!!! important
    ...
    If the folder path contains spaces (such as Gridlab-d 5.3.0), you must include quotation marks (" "), or the above command will fail.
...
### GRIDLABD
This should contain the path where GridLAB-D™ is installed. This environment variable is setup automatically during installation.
### GLPATH

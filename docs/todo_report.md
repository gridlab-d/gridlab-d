...
## Build out
- `2.0 - New Users\2.3 - Running_Simulations.md` - l.2 - Turn this into a new-user example of how to run a simple simulation. Move more in-depth content to later sections where appropriate.
...
## Check Status
- `3.0 - Modeling Reference\Metrics & Recorders\plotting-output.md` - l.60 - Future
...
## Reference
- `2.0 - New Users\2.2 - Getting Started\2.2.1 - Overview.md` - l.28 - Previous linke does not seem to work [jk-updated should work]** However, we suggest that all beginners and most intermediate users continue through this guide.
...
## Terminology
- `2.0 - New Users\2.2 - Getting Started\2.2.1 - Overview.md` - l.5 - I added "of the software." Is this correct? [jk 12/1, yes]** of the software. The guide will address practical issues such as how certain models function, and will also cover more general topics within the architecture of GridLAB-D™.
...
- `2.0 - New Users\2.5 - Simulation Time.md` - l.356 - add necessary properties so this actually loads ok
...
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.1 - Basic Distribution System Modeling.md` - l.75 - Is this true?)
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.153 - [Runtime compiler support]().
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.589 - add necessary properties so this actually loads ok
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.642 - [Expansion variables]() for details.
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.654 - [Functional values]() for details.
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.667 - [Property calculations]() for details.
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.698 - *
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.754 - \
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.757 - \
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.760 - \
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.763 - *
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.2 - GLM Models.md` - l.818 - Why is this a mystery?
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.3 - Modules.md` - l.103 - THIS IS A SPEC FILE) [waterheater](../../7.0%20References/Specs/Spec_Residential.md) model:
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.3 - Modules.md` - l.315 - `.
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.3 - Modules.md` - l.317 - ` add objects going all the way up to the feeder, including line, configuration, transformers, voltage regulators, fuses, switches, etc.
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.3 - Modules.md` - l.321 - ` implement a simple dynamic-price demand response dispatch
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.3 - Modules.md` - l.336 - ` implement a histogram
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.6 - Distributed_Generation.md` - l.128 - Keep this mention of energy_storage? or update page?** The battery object is in a state of flux, containing some legacy models and some new models. In early versions of GridLAB-D™ (pre-v3.0), it was assumed that the model included both the battery and the inverter; the battery was connected directly to a meter (or triplex_meter) object. Post-v3.0, the inverter model has been separated from the battery object. In this case, the battery is connected as a child of an inverter object and the inverter is then connected to the meter object. This may cause some confusion - development of new models will focus on a full separation of the inverter and battery models, but legacy code still exists for those that are still using it.
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.6 - Distributed_Generation.md` - l.136 - Can charging and discharging be controlled? It doesn't look like it based on the code**.)
- `2.0 - New Users\2.5 - Intro to Modeling\2.5.8 - Built-In Distribution Models.md` - l.5 - BROKEN LINK** [the report that was generated](http://www.gridlabd.org/models/feeders/taxonomy_of_prototypical_feeders.pdf).
- `3.0 - Modeling Reference\Modules\Assert.md` - l.152 - - Empty - Double Assert section is
- `3.0 - Modeling Reference\Modules\Assert.md` - l.189 - - Empty - Add content for Enumeration Assert
- `3.0 - Modeling Reference\Modules\delta_mode.md` - l.8 - re-iterate rationale**, while a user interested in observing the behavior of the system over a day of operations should remain in the main quasi-static mode of operation.
- `3.0 - Modeling Reference\Modules\delta_mode.md` - l.10 - Describe whether this transition is automatic or user-enabled in some way**
...
- `3.0 - Modeling Reference\Modules\Powerflow\1.0 - Power_Flow_User_Guide.md` - l.1606 - ) page for information on the assumed equations, which are from "Distribution System Modeling and Analysis" by William Kersting.
...
- `4.0 Developing Reference\4.8 - Release_Process.md` - l.2 - Update outline for release process section
- `4.0 Developing Reference\4.8 - Release_Process.md` - l.4 - Write content for process section
...
- `4.0 Developing Reference\4.3 - Software Architecture and Design\4.3.1 - gldcore.md` - l.125 - \--[Dchassin] 00:07, 7 March 2009 (UTC)]
- `4.0 Developing Reference\4.3 - Software Architecture and Design\4.3.1 - gldcore.md` - l.129 - \--[Dchassin] 00:07, 7 March 2009 (UTC)]
...
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.43 - add public typedefs
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.44 - declare published variables using GL_* macros
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.46 - add private typedefs
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.47 - add unpublished variables
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.52 - add optional class functions
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.54 - add published class functions
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.56 - add desired internal functions
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.75 - add optional functions declarations
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.78 - add declaration of class globals
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.90 - set defaults
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.95 - set defaults
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.100 - initialize object
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.103 - add implementations of optional class functions
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.115 - add new classes before this line
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.129 - add other VS project options
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.133 - :
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.137 - :
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.141 - :
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.145 - :
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.149 - :
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.153 - :
- `4.0 Developing Reference\4.4 - Development Fundamentals\4.4.3 - Creating_a_class.md` - l.157 - :
...
- `4.0 Developing Reference\4.5 - Deltamode Development\4.5.1 - Dev_Subsecond.md` - l.71 - Add your deltamode_desired code */
- `4.0 Developing Reference\4.5 - Deltamode Development\4.5.1 - Dev_Subsecond.md` - l.80 - Add preupdate code */
- `4.0 Developing Reference\4.5 - Deltamode Development\4.5.1 - Dev_Subsecond.md` - l.92 - Add your interupdate code here */
- `4.0 Developing Reference\4.5 - Deltamode Development\4.5.1 - Dev_Subsecond.md` - l.108 - Add your postupdate code here */
- `4.0 Developing Reference\4.5 - Deltamode Development\4.5.1 - Dev_Subsecond.md` - l.135 - add your object update code here */
- `4.0 Developing Reference\4.5 - Deltamode Development\Delta_mode.md` - l.54 - node
- `4.0 Developing Reference\4.5 - Deltamode Development\Delta_mode.md` - l.55 - link
- `4.0 Developing Reference\4.5 - Deltamode Development\Delta_mode.md` - l.56 - :
- `4.0 Developing Reference\4.5 - Deltamode Development\Realtime_server.md` - l.5 - Update for Hassayampa (Version 3.0)
...
- `2.0 - New Users\2.2 - Getting Started\2.2.2 - Models.md` - l.321 - Talk about GLMModifier here instead**:

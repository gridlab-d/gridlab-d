...
- `3.0 - Modeling Reference\Modules\Generators\Energy_storage.md` - l.164 - - Example - add example demonstrating energy storage model use case
- `3.0 - Modeling Reference\Modules\Generators\Inverters\02_QSTS_Inverter.md` - l.3 - Check the latest ```inverter.cpp``` in branch ```feature/1776``` for the "de-deltamoded" version.</mark>
- `3.0 - Modeling Reference\Modules\Generators\Inverters\02_QSTS_Inverter.md` - l.5 - Add examples, maybe from shoutwiki as a simple one, or from the autotests.</mark>
...
- `3.0 - Modeling Reference\Python API\Functionality\3.1 - Running Multiple Models.md` - l.6 - - API docs - link to example once final location decided. To achieve parallel operation, though, our example uses Python's "multiprocessing" library which executes each model in its own thread, allowing them to be run in parallel.
- `3.0 - Modeling Reference\Python API\Functionality\3.1 - Running Multiple Models.md` - l.17 - - API docs - Example task is [Github issue #1706](https://github.com/gridlab-d/gridlab-d/issues/1706)
- `3.0 - Modeling Reference\Python API\Functionality\3.2 - Controlling Simulation Start and Stop Times.md` - l.3 - - API docs - Update example file name once finalized
...
- `4.0 - Developing Reference\Software Architecture and Design\4.4.2 - Modules.md` - l.100 - add gl_global_create() calls here (see module globals for details)
- `4.0 - Developing Reference\Software Architecture and Design\4.4.2 - Modules.md` - l.101 - call new for each class here (see create class for details)
- `4.0 - Developing Reference\Software Architecture and Design\4.4.2 - Modules.md` - l.102 - return oclass member of first new class
- `4.0 - Developing Reference\Software Architecture and Design\4.4.2 - Modules.md` - l.117 - perform cleanup actions if needed
- `4.0 - Developing Reference\Software Architecture and Design\4.4.2 - Modules.md` - l.135 - perform simulation end operations
...
- `4.0 - Developing Reference\Software Architecture and Design\4.4.2 - Modules.md` - l.195 - The `test` function is relatively unused and was intended to support module tests.
- `4.0 - Developing Reference\Software Architecture and Design\4.4.2 - Modules.md` - l.199 - The `stream` function will soon be required to support checkpoints.

...
`get_object_properties()` are numeric and do not include units.

https://github.com/gridlab-d/gridlab-d/issues/1728
...
house_properties = gld.get_object_properties(house0["name"])
if isinstance(house_properties["floor_area"], (int, float)):

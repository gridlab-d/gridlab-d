...
1582 - Need API for getting all properties of a specified object
https://github.com/gridlab-d/gridlab-d/issues/1582

1583 - Need API for getting list of all objects (and their properties) by object type
https://github.com/gridlab-d/gridlab-d/issues/1583

1584 - Need API for getting entire model 
https://github.com/gridlab-d/gridlab-d/issues/1584
...
This repository was cloned into a Linux Ubuntu 25.10 and built. The Python
library was then installed by going into the built "python_binding" folder
and `pip install -e .` This installed a library with the changes called
`gridlabd-test-riley`.

...
static TIMESTAMP classtemplate_sync_impl(OBJECT *obj, TIMESTAMP t0, PASSCONFIG pass)
{
	classtemplate *my = OBJECTDATA(obj, classtemplate);
...
#ifndef __APPLE__
extern "C" MODULE_API TIMESTAMP classtemplate_sync(OBJECT *obj, TIMESTAMP t0, PASSCONFIG pass)
{

...
public:
  ...
  complex
      CVoltageA; // complex voltage: Cvoltage.Mag() = VM, Cvoltage.Arg() = VA;
  complex
      CVoltageB; // complex voltage: Cvoltage.Mag() = VM, Cvoltage.Arg() = VA;
  complex
      CVoltageC; // complex voltage: Cvoltage.Mag() = VM, Cvoltage.Arg() = VA;

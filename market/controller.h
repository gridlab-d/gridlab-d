...
private:
  ...
  double calcTemp1_double_price(double Tair, double Deadband,
                                enumeration State);
  double calcTemp2_double_price(gld_property *pUa, gld_property *pHm,
                                gld_property *pCa, gld_property *pCm,
                                gld_property *pMGF, gld_property *pMSFG,
                                gld_property *pQi, gld_property *pQs,
                                gld_property *pQh, gld_property *pTout,
                                double Tair, gld_property *pTmass,
                                double Deadband, enumeration State);

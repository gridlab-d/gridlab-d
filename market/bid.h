...
typedef enum e_bid_type { BID_BUY, BID_SELL, BID_UNKNOWN } BIDTYPE;
...
EXPORT void submit_bid_state(char *from, char *to, const char *function_name,
                             const char *function_class, void *bidding_buffer,
                             size_t bid_len);

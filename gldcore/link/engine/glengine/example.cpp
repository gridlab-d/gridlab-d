...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    // engine.connect("gridlabd","--pause","test_engine.glm",nullptr);
    try {
      engine.connect("C:\\ciraci_gld\\VS2005\\Win32\\Debug",
                     "C:\\ciraci_gld\\VS2005\\Win32\\Debug\\test_engine.glm",
                     nullptr);
    ...
    // since gld is not doing anything sync at TS_NEVER will cause gld to go to

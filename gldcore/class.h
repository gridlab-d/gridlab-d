...
PROPERTYTYPE class_get_propertytype_from_typename(const char *name);
...
DELEGATEDTYPE *class_register_type(CLASS *oclass, const char *type,int (*from_string)(void*,char*),int (*to_string)(void*,char*,int));

...
PROPERTYSPEC property_type[_PT_LAST] = {
	...
	{"float", "decimal", sizeof(float), 24, convert_from_float, convert_to_float},
	{
		...
		reinterpret_cast<int (*)(
			const char *,
			void *,
			PROPERTY *)>(convert_to_loadshape),
		reinterpret_cast<int (*)(
			void *)>(loadshape_create),
		nullptr,
		{TCOPS(double)},
	},
	{"enduse", "string", sizeof(enduse), 0, convert_from_enduse, reinterpret_cast<int (*)(const char *, void *, PROPERTY *)>(convert_to_enduse), reinterpret_cast<int (*)(void *)>(enduse_create), nullptr, {TCOPS(double)}, enduse_get_part},
	{"randomvar", "string", sizeof(randomvar_struct), 24, convert_from_randomvar, reinterpret_cast<int (*)(const char *, void *, PROPERTY *)>(convert_to_randomvar), reinterpret_cast<int (*)(void *)>(randomvar_create), nullptr, {TCOPS(double)}, random_get_part},
...
PROPERTY *property_malloc(PROPERTYTYPE proptype, CLASS *oclass, std::string_view name, void *addr, DELEGATEDTYPE *delegation)
{
	...
	if (oclass != nullptr)
	{
		for (PROPERTY *existing = oclass->pmap; existing && existing->oclass == oclass; existing = existing->next)
		{

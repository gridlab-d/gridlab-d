...
extern "C" void xrejoin(void) { xoutput("Simulation done."); }
...
extern "C" int xstart(void) {
  ...
  win = XCreateSimpleWindow(dsp, DefaultRootWindow(dsp), 50, 50, // origin
                            200, 200,                            // size
                            0, black,                            // border
                            white);                              // backgd
  ...
  XSetStandardProperties(dsp, win, "GridLAB-D", "GridLAB-D", None, nullptr, 0,
                         nullptr);

...
public:
  ...
  /* void unparsedEntityDecl(const XMLCh* const name, const XMLCh* const
   * publicId, const XMLCh* const systemId, const XMLCh* const notationName); */
...
private:
  ...
  char *start_element_empty(char *buffer, size_t len,
                            const Attributes &attributes);
  char *start_element_load(char *buffer, size_t len,
                           const Attributes &attributes);
  char *start_element_module(char *buffer, size_t len,
                             const Attributes &attributes);
  char *start_element_module_prop(char *buffer, size_t len,
                                  const Attributes &attributes);
  char *start_element_module_build_object(const Attributes &attributes);
  char *start_element_object(char *buffer, size_t len,
                             const Attributes &attributes);
  char *start_element_object_prop(char *buffer, size_t len,
                                  const Attributes &attributes);
  char *start_element_global(char *buffer, size_t len,
                             const Attributes &attributes);
  char *start_element_global_prop(char *buffer, size_t len,
                                  const Attributes &attributes);
  char *start_element_clock(char *buffer, size_t len,
                            const Attributes &attributes);
  char *start_element_clock_prop(char *buffer, size_t len,
                                 const Attributes &attributes);

...
public:
  ...
  inline TIMESTAMP do_sync(TIMESTAMP t) {
    return sync == NULL ? TS_NEVER : (*sync)(this, t);
  };
...
public: // accessors
  ...
  inline GLOBALVAR *get_globalvar(LINKLIST *item) {
    return (GLOBALVAR *)item->data;
  };
  inline void set_globalvar(LINKLIST *item, GLOBALVAR *var) {
    item->data = (void *)var;
  };

  inline LINKLIST *get_objects(void) { return objects; };
  inline OBJECT *get_object(LINKLIST *item) { return (OBJECT *)item->data; };
  inline void set_object(LINKLIST *item, OBJECT *var) {
    item->data = (void *)var;
  };

  inline LINKLIST *get_imports(void) { return imports; };
  inline OBJECTPROPERTY *get_import(LINKLIST *item) {
    return (OBJECTPROPERTY *)item->data;
  };
  ...
  inline OBJECTPROPERTY *get_export(LINKLIST *item) {
    return (OBJECTPROPERTY *)item->data;
  };

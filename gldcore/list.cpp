 ...
 **/
static LISTITEM *
create_item(void *data,     /* a pointer to the data */
...
static void destroy_item(
    LISTITEM *item) /**< a pointer to the LISTITEM structure of the item */
{
 ...
 **/
void list_destroy(
    GLLIST *list) /**< a pointer to the LIST structure to destroy */
{
...
/** Append an item to a list
        ...
        - \p ENOMEM memory allocation failed
 **/
LISTITEM *list_append(GLLIST *list, /**< a pointer to the LIST structure to
                                       which the item it to be appended */
                      void *data)   /**< a pointer to the data which the new
                                       LISTITEM will contain */
{

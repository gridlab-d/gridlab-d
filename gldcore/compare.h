...
#define TCNONE                                                                 \
  {TCOP_NOP, "", NULL}, {TCOP_NOP, "", NULL}, {TCOP_NOP, "", NULL},            \
      {TCOP_NOP, "", NULL}, {TCOP_NOP, "", NULL}, {TCOP_NOP, "", NULL},        \
      {TCOP_NOP, "", NULL}, {                                                  \
    TCOP_NOP, "", NULL                                                         \
  }
#define TCOPB(X)                                                               \
  {TCOP_EQ, "==", compare_tc_##X##_eq}, {TCOP_NOP, "", NULL},                  \
      {TCOP_NOP, "", NULL}, {TCOP_NE, "!=", compare_tc_##X##_ne},              \
      {TCOP_NOP, "", NULL}, {TCOP_NOP, "", NULL}, {TCOP_NOP, "", NULL}, {      \
    TCOP_NOP, "", NULL                                                         \
  }
#define TCOPS(X)                                                               \
  {TCOP_EQ, "==", compare_tc_##X##_eq}, {TCOP_LE, "<=", compare_tc_##X##_le},  \

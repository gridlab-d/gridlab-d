...
#define COMPARE_INI(T) int compare_tc_##T##_in(void* x,void* a,void* b) { return (signed)*(T*)a<=(signed)*(T*)x && b!=nullptr && (signed)*(T*)x<=(signed)*(T*)b; }
#define COMPARE_NII(T) int compare_tc_##T##_ni(void* x,void* a,void* b) { return !((signed)*(T*)a<=(signed)*(T*)x && b!=nullptr && (signed)*(T*)x<=(signed)*(T*)b); }
...
#define COMPARE_EQF(T) int compare_tc_##T##_eq(void* x,void* a,void* b) { if (b==nullptr) return *(T*)x==*(T*)a; else return fabs((*(T*)x)-(*(T*)a))<=(*(T*)b); }
...
#define COMPARE_NEF(T) int compare_tc_##T##_ne(void* x,void* a,void* b) { if (b==nullptr) return *(T*)x!=*(T*)a; else return fabs((*(T*)x)-(*(T*)a))>(*(T*)b); }
...
#define COMPARE_INF(T) int compare_tc_##T##_in(void* x,void* a,void* b) { return *(T*)a<=*(T*)x && b!=nullptr && *(T*)x<=*(T*)b; }
#define COMPARE_NIF(T) int compare_tc_##T##_ni(void* x,void* a,void* b) { return !(*(T*)a<=*(T*)x && b!=nullptr && *(T*)x<=*(T*)b); }
...
#define COMPARE_SIN(T) int compare_tc_##T##_in(void* x,void* a,void* b) { return strcmp((char*)x,(char*)a)>=0 && b!=nullptr && strcmp((char*)x,(char*)b)<=0; }
#define COMPARE_SNI(T) int compare_tc_##T##_ni(void* x,void* a,void* b) { return !(strcmp((char*)x,(char*)a)>=0 && b!=nullptr && strcmp((char*)x,(char*)b)<=0); }

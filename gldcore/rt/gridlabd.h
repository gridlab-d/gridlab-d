...
/// @return nothing
template <class T>
inline void gl_get_value(OBJECT *obj,	 ///< the object whose property value is being obtained
...
/// @return nothing
template <class T>
inline void gl_set_value(OBJECT *obj,	 ///< the object whose property value is being obtained
						 char *propname, ///< the name of the property being obtained
						 T &value)		 ///< a reference to the local value where the property's value is being copied
{
	T *ptr = (T *)gl_get_addr(obj, propname);

...
pcgstrf_relax_snode(
		    ...
		    //pcgstrf_options_t *pcgstrf_options,
			superlumt_options_t *pcgstrf_options, //sj
 ...
 * Purpose
 * =======
 *   pcgstrf_relax_snode() identifes the initial relaxed supernodes, 
 ...
 */ 
    ...
    int *etree = pcgstrf_options->etree; /* column elimination tree */
    int relax = pcgstrf_options->relax; /* maximum no of columns allowed 
					   in a relaxed s-node */
